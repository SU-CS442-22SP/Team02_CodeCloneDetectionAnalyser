    ...
    public void testHttpPostsWithExpectationVerification() throws Exception {
            ...
            public void verify(final HttpRequest request, final HttpResponse response, final HttpContext context) throws HttpException {
                ...
                if (someheader != null) {
                    ...
                    try {
                        ...
                        response.setStatusCode(HttpStatus.SC_underscoreBAD_underscoreREQUEST);
                        return;
                    }
                    if (secretNumber < 2) {
                        response.setStatusCode(HttpStatus.SC_underscoreEXPECTATION_underscoreFAILED);
        ...
        this.server.start();
        this.client.getParams().setBooleanParameter(CoreProtocolPNames.USE_underscoreEXPECT_underscoreCONTINUE, true);
        ...
        try {
            for (int r = 0; r < reqNo; r++) {
                ...
                if (r < 2) {
                    assertEquals(HttpStatus.SC_underscoreEXPECTATION_underscoreFAILED, response.getStatusLine().getStatusCode());
                } else {
