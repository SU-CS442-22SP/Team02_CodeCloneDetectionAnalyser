    public GetMyDocuments() {
        String urlString = dms_underscoreurl + "/servlet/com.ufnasoft.dms.server.ServerGetMyDocuments";
        String rvalue = "";
        String filename = dms_underscorehome + FS + "temp" + FS + username + "mydocuments.xml";
        try {
