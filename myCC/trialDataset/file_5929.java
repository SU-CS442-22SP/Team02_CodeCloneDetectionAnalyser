    private Integer getInt(String sequence) throws NoSuchSequenceException {
        ...
        try {
            ...
            conn.setTransactionIsolation(conn.TRANSACTION_underscoreREPEATABLE_underscoreREAD);
            conn.setAutoCommit(false);
            read = conn.prepareStatement(SELECT_underscoreSQL);
            ...
            write = conn.prepareStatement(UPDATE_underscoreSQL);
