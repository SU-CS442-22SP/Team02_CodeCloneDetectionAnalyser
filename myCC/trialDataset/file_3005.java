        public void runInternal() {
            ...
            do {
                try {
                    ...
                    delayedProgress = coolReader.getEngine().showProgressDelayed(0, progressMessage, PROGRESS_underscoreDELAY_underscoreMILLIS);
                    ...
                    connection.setConnectTimeout(CONNECT_underscoreTIMEOUT);
                    connection.setReadTimeout(READ_underscoreTIMEOUT);
                    ...
                    final int MAX_underscoreCONTENT_underscoreLEN_underscoreTO_underscoreBUFFER = 256 * 1024;
                    boolean isZip = contentType != null && contentType.equals("application/zip");
                    if (expectedType != null) contentType = expectedType; else if (contentLen > 0 && contentLen < MAX_underscoreCONTENT_underscoreLEN_underscoreTO_underscoreBUFFER) {
                    ...
                    if (contentType.startsWith("application/atom+xml")) {
                        ...
                        if (handler.docInfo.nextLink != null && handler.docInfo.nextLink.type.startsWith("application/atom+xml;profile=opds-catalog")) {
                            if (handler.entries.size() < MAX_underscoreOPDS_underscoreITEMS) {
