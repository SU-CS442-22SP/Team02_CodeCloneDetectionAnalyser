    public void doUpdate(String version) {
        try {
            final String hyperlink_underscoreurl = "http://xnavigator.sourceforge.net/dist/";
            ...
            try {
                ...
                int BORDER_underscoreTOP = 10;
                int PANEL_underscoreWIDTH = 400;
                int TEXT_underscoreWIDTH = 360;
                int TEXT_underscoreHEIGHT = 50;
                int TEXT_underscoreLEFT = 20;
                int y = BORDER_underscoreTOP;
                ...
                informText.setBounds(TEXT_underscoreLEFT, y += 235, TEXT_underscoreWIDTH, TEXT_underscoreHEIGHT);
                ...
                progressText.setBounds(TEXT_underscoreLEFT, y += TEXT_underscoreHEIGHT, TEXT_underscoreWIDTH, TEXT_underscoreHEIGHT);
                ...
                panel.repaint();
                informText.setText(i18n.getString("UPDATE_underscoreCHECK_underscoreINSTANCES"));
                String message0 = i18n.getString("UPDATE_underscoreINSTANCES");
                ...
                int option = JOptionPane.showOptionDialog(null, objects0, "Update", JOptionPane.DEFAULT_underscoreOPTION, JOptionPane.INFORMATION_underscoreMESSAGE, null, options0, options0[0]);
                if (option == 0) {
                } else {
                    updateInfoFrame.dispose();
                    return;
                }
                informText.setText(i18n.getString("UPDATE_underscoreCHECK_underscoreENVIRONMENT"));
                if ((new File(".project")).exists()) {
                    ...
                    JOptionPane.showMessageDialog(null, objects, "Update Error", JOptionPane.ERROR_underscoreMESSAGE);
                    updateInfoFrame.dispose();
                    return;
                }
                Object[] objects1 = { i18n.getString("UPDATE_underscoreWARNING") };
                Object[] options1 = { i18n.getString("CONTINUE"), i18n.getString("CANCEL") };
                int opt = JOptionPane.showOptionDialog(null, objects1, i18n.getString("WARNING"), JOptionPane.DEFAULT_underscoreOPTION, JOptionPane.INFORMATION_underscoreMESSAGE, null, options1, options1[0]);
                if (opt == 1) {
                    updateInfoFrame.dispose();
                    return;
                }
                ...
                informText.setText(i18n.getString("UPDATE_underscoreDOWNLOADING"));
                String updateFile = "XNavigator-" + version + ".zip";
                URL url = new URL(hyperlink_underscoreurl + updateFile);
                ...
                int BUFFER_underscoreSIZE = 1024;
                byte data[] = new byte[BUFFER_underscoreSIZE];
                int count = 0;
                int size = 0;
                int prev_underscoreperc = 0;
                while ((count = in.read(data, 0, BUFFER_underscoreSIZE)) > 0) {
                    bout.write(data, 0, count);
                    size += count;
                    int perc = (100 * size) / fileSize;
                    if (perc > prev_underscoreperc) {
                        progressText.setText("Download " + urlString + " ... " + perc + "%");
                        prev_underscoreperc = perc;
                    }
                }
                bout.close();
                fos.close();
                ...
                informText.setText(i18n.getString("UPDATE_underscoreEXTRACTING"));
                ...
                progressText.setText(i18n.getString("UPDATE_underscoreCOMPLETE"));
                Object[] objects = { i18n.getString("UPDATE_underscoreCOMPLETE") };
                Object[] options = { i18n.getString("OK") };
                JOptionPane.showOptionDialog(null, objects, "Success", JOptionPane.DEFAULT_underscoreOPTION, JOptionPane.INFORMATION_underscoreMESSAGE, null, options, options[0]);
                System.exit(0);
            } catch (Exception e) {
                e.printStackTrace();
                String message = "";
                String hyperlink = "";
                message = i18n.getString("UPDATE_underscoreFAILED");
                hyperlink = "<a href='" + hyperlink_underscoreurl + "'>" + hyperlink_underscoreurl + "</a>";
                ...
                label3.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_underscoreCURSOR));
                    ...
                    public void mouseClicked(MouseEvent e) {
                        if (e.getClickCount() > 0) {
                            try {
                                ...
                                basicService.showDocument(new URL(hyperlink_underscoreurl));
                            } catch (Exception e1) {
                                e1.printStackTrace();
                                try {
                                    Runtime.getRuntime().exec("cmd.exe /c start " + hyperlink_underscoreurl);
                ...
                Object[] options = { i18n.getString("OK") };
                updateInfoFrame.dispose();
                JOptionPane.showOptionDialog(null, objects, "Error", JOptionPane.DEFAULT_underscoreOPTION, JOptionPane.ERROR_underscoreMESSAGE, null, options, options[0]);
            }
