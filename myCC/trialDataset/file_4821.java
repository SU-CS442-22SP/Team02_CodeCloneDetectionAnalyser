    public void loadXML(URL flux, int status, File file) {
        try {
            ...
            try {
                ...
                Log.e(Constants.PROJECT_underscoreTAG, "Exeption retrieving XML", e);
            }
            try {
                document = sbx.build(new FileInputStream(file));
            } catch (Exception e) {
                Log.e(Constants.PROJECT_underscoreTAG, "xml error ", e);
            }
        } catch (Exception e) {
            Log.e(Constants.PROJECT_underscoreTAG, "TsukiQueryError", e);
        }
        if (document != null) {
