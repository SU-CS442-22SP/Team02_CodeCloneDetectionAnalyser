    public void sorter() {
        ...
        try {
            ...
            String eplist_underscorefile = pluginDir + System.getProperty("file.separator") + "EpisodeList.txt";
            File episodeList = new File(eplist_underscorefile);
            ...
            File episodeList2 = new File(eplist_underscorefile);
