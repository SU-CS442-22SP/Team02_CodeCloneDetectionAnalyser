    public void doFilter(final ServletRequest arg0, final ServletResponse arg1, final FilterChain arg2) throws IOException, ServletException {
        if (!this.init) {
            final HttpServletResponse response = Dynamic._underscore.Cast(arg1);
            response.sendError(HttpServletResponse.SC_underscoreSERVICE_underscoreUNAVAILABLE, "Mainfilter not initialized.");
            return;
        }
        if (this.mainFilter != null) {
            ...
            final HttpServletResponse response = Dynamic._underscore.Cast(arg1);
            response.sendError(HttpServletResponse.SC_underscoreSERVICE_underscoreUNAVAILABLE, "Mainfilter bad setup.");
        }
    }
