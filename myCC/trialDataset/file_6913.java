    public void service(Request req, Response resp) {
        ...
        try {
            ...
            String fiServerDetails = req.getParameter("fi_underscoreserver_underscoredetails");
            String serverDetails = req.getParameter("server_underscoredetails");
            String hostDetails = req.getParameter("host_underscoredetails");
            ...
            if (path.startsWith("/fs")) {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    if (file != null && file.isFile()) {
                        ...
                        String fileName = file.getFileName().replaceAll("\\\\", "_underscore").replaceAll(":", "_underscore");
                ...
                if (authentication == null) {
                    ...
                    out.println("</head>");
                    out.println("<body onload=\"sh_underscorehighlightDocument('lang/', '.js')\">");
                    if (info != null) {
                        out.println("<table border='1'>");
                    ...
                    for (int i = 0; i < lines.size(); i++) {
                        ...
                        if (project != null) {
                            ...
                            Collections.sort(sortedProcs, LONGEST_underscoreFIRST);
                ...
                Collections.sort(tokens, LONGEST_underscoreFIRST);
                ...
                for (Searchable value : list) {
                    ...
                    out.println("    <tr><td><pre class='sh_underscorexml'>");
