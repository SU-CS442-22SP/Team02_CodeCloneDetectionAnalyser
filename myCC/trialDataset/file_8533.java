    public ProductListByCatHandler(int cathegory, int langId) {
        try {
            URL url = new URL("http://eiffel.itba.edu.ar/hci/service/Catalog.groovy?method=GetProductListByCategory&category_underscoreid=" + cathegory + "&language_underscoreid=" + langId);
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                NodeList rank2 = nodes.getElementsByTagName("sales_underscorerank");
                NodeList price = nodes.getElementsByTagName("price");
                NodeList url2 = nodes.getElementsByTagName("image_underscoreurl");
