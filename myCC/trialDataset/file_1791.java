    public static org.osid.repository.AssetIterator search(Repository repository, SearchCriteria lSearchCriteria) throws org.osid.repository.RepositoryException {
        try {
            ...
            if (lSearchCriteria.getSearchOperation() == SearchCriteria.FIND_underscoreOBJECTS) {
                URL url = new URL("http", repository.getAddress(), repository.getPort(), SEARCH_underscoreSTRING + URLEncoder.encode(lSearchCriteria.getKeywords() + WILDCARD, "ISO-8859-1"));
