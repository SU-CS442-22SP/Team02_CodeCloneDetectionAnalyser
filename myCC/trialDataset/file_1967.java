    private boolean saveDocumentXml(String repository, String tempRepo) {
        ...
        try {
            ...
            InputSource insource = new InputSource(new FileInputStream(tempRepo + File.separator + AppConstants.DMS_underscoreXML));
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                for (int j = 0; j < childs.getLength(); j++) {
                    ...
                    if (child.getNodeType() == Node.ELEMENT_underscoreNODE) {
                        if (child.getNodeName() != null && child.getFirstChild() != null && child.getFirstChild().getNodeValue() != null) {
                            System.out.println(child.getNodeName() + "::" + child.getFirstChild().getNodeValue());
                        }
                        if (Document.FLD_underscoreID.equals(child.getNodeName())) {
                        ...
                        } else if (document.FLD_underscoreNAME.equals(child.getNodeName())) {
                        ...
                        } else if (document.FLD_underscoreLOCATION.equals(child.getNodeName())) {
                            document.setLocation(child.getFirstChild().getNodeValue());
                        } else if (document.FLD_underscoreOWNER.equals(child.getNodeName())) {
                ...
                if (isSave) {
                    ...
                    sbFolder.append(File.separator).append(calendar.get(Calendar.HOUR_underscoreOF_underscoreDAY));
