    public void setPilot(PilotData pilotData) throws UsernameNotValidException {
        try {
            ...
            if (pilotData.id == 0) {
                psta = jdbc.prepareStatement("INSERT INTO pilot " + "(name, address1, address2, zip, city, state, country, birthdate, " + "pft_underscoretheory, pft, medical, passenger, instructor, loc_underscorelanguage, " + "loc_underscorecountry, loc_underscorevariant, username, password, id) " + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,pilot_underscoreid_underscoreseq.nextval)");
            } else {
