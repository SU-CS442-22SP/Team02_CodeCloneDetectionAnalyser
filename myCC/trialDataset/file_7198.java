    ...
    public Response callService(RemoteCallUrl urlModel) throws RemoteCallFailedException {
        ...
        try {
            URL url = new URL(HTTP_underscorePROTOCOL, urlModel.getHost(), urlModel.getPort(), path);
            ...
            remoteData.setStatus(urlConnection.getHeaderField(Response.RPC_underscoreSTATUS_underscoreNAME));
            in.close();
            return remoteData;
