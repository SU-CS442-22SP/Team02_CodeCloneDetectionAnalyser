    ...
    protected String doInBackground(String... params) {
        ...
        try {
            md5 = md5(urlStr);
            File f = context.getFileStreamPath(md5 + FILE_underscoreEXT);
            if (f.exists()) {
        ...
        if (bm != null) {
            ...
            try {
                fos = context.openFileOutput(md5 + FILE_underscoreEXT, Context.MODE_underscoreWORLD_underscoreREADABLE);
