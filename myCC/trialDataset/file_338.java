    public String getRec(String attribute, String url) {
        ...
        if (mdfCount == 1 && idenCount == 1 && (mdPrefixValue.equals("marc21") || mdPrefixValue.equals("oai_underscoredc") || mdPrefixValue.equals("mods"))) {
            try {
            ...
            if (v1.size() == 0) {
                ...
                for (int v = 0; v < v1.size(); v = v + 13) {
                    ...
                    if (mdPrefixValue.equals("oai_underscoredc")) {
                        try {
                            ...
                            Namespace oainsdc = Namespace.getNamespace("http://www.openarchives.org/OAI/2.0/oai_underscoredc/");
                            Element dcroot = new Element("dc", "oai_underscoredc", "http://www.openarchives.org/OAI/2.0/oai_underscoredc/");
                            ...
                            Attribute schemaLocationdc = new Attribute("schemaLocation", "http://www.openarchives.org/OAI/2.0/oai_underscoredc/ http://www.openarchives.org/OAI/2.0/oai_underscoredc.xsd", xsi1);
                    ...
                    } else if (mdPrefixValue.equals("oai_underscoredc")) {
                    }
                }
