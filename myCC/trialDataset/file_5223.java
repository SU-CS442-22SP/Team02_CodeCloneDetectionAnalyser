    ...
    private int syncCustomers() throws RemoteException, BasicException {
        ...
        for (CustomerSync localCustomer : localList) {
            ...
            userAdd.setState_underscoreregion(localCustomer.getRegion() + "");
            ...
            userAdd.setBank_underscoreaccount_underscorenr("");
            userAdd.setBank_underscoreaccount_underscoreholder("");
            userAdd.setBank_underscoreaccount_underscoretype("");
            userAdd.setBank_underscoreiban("");
            userAdd.setBank_underscorename("");
            userAdd.setBank_underscoresort_underscorecode("");
            userAdd.setMdate(df.format(now));
            userAdd.setShopper_underscoregroup_underscoreid("1");
