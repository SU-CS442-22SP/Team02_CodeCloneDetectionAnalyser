        ...
        if (sequence < seqLimit) {
            ...
            try {
                ...
                if (maxValue != 0L) {
                    ...
                    if (maxValue > Long.MAX_underscoreVALUE - step) {
                        String msg = "The sequence attribute '" + tableName + ".maxValue' is too hight," + " the recommended maximal value is: " + (Long.MAX_underscoreVALUE - step) + " (Long.MAX_underscoreVALUE-step)";
