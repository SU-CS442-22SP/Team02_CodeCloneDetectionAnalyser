    private String AddAction(ResultSet node, String modo) throws SQLException {
        ...
        try {
            cn = this.getRepositoryConnection(p_underscorectx.getApplication(), p_underscorectx.getBoSession().getRepository().getName(), 1);
            cndef = this.getRepositoryConnection(p_underscorectx.getApplication(), p_underscorectx.getBoSession().getRepository().getName(), 2);
            String dml = null;
            String objecttype = node.getString("OBJECTTYPE");
            if (objecttype.equalsIgnoreCase("T")) {
                boolean exists = existsTable(p_underscorectx, schema, node.getString("OBJECTNAME").toLowerCase());
                String[] sysflds = { "SYS_underscoreUSER", "SYS_underscoreICN", "SYS_underscoreDTCREATE", "SYS_underscoreDTSAVE", "SYS_underscoreORIGIN" };
                ...
                if (!exists && !modo.equals("3")) {
                    ...
                    if (node.getString("SCHEMA").equals("DEF")) {
                        vt = "NGD_underscore" + vt;
                    } else if (node.getString("SCHEMA").equals("SYS")) {
                        vt = "SYS_underscore" + vt;
                    }
            ...
            if (objecttype.equalsIgnoreCase("F")) {
                ...
                PreparedStatement pstm = cn.prepareStatement("select column_underscorename,udt_underscorename,character_underscoremaximum_underscorelength,numeric_underscoreprecision,numeric_underscorescale from information_underscoreschema.columns" + "  where table_underscorename=? and column_underscorename=? and table_underscoreschema=?");
                ...
                if (("20".indexOf(modo) != -1) && !fldexi) {
                    ...
                    String sql = "SELECT tc.constraint_underscorename,tc.constraint_underscoretype" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE tc.table_underscorename = ?" + " AND kcu.column_underscorename = ?" + " and tc.table_underscoreschema=?";
            ...
            if (objecttype.equalsIgnoreCase("V")) {
                ...
                PreparedStatement pstmrelc = cn.prepareStatement("SELECT view_underscoredefinition FROM information_underscoreschema.views WHERE table_underscorename=? " + "and table_underscoreschema=?");
            ...
            if (objecttype.startsWith("PCK")) {
                ...
                String bstr = "/*begin_underscorepackage*/";
                String estr = "/*end_underscorepackage*/";
                if ("02".indexOf(modo) != -1) {
                    if (templatestr.indexOf(bstr) != -1) {
                        ...
                        executeDDL(dml, node.getString("SCHEMA"));
                        bstr = "/*begin_underscorepackage_underscorebody*/";
                        estr = "/*end_underscorepackage_underscorebody*/";
            ...
            if (objecttype.startsWith("PK") || objecttype.startsWith("UN")) {
                String sql = "SELECT kcu.column_underscorename" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE tc.table_underscorename = ?" + " AND tc.constraint_underscorename = ?" + " and tc.table_underscoreschema=? order by ordinal_underscoreposition";
                ...
                if ((modo.equals("3") || diff) && exists) {
                    sql = "SELECT tc.constraint_underscorename,tc.table_underscorename" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE ccu.constraint_underscorename = ?" + " and tc.table_underscoreschema=?";
                    ...
                    sql = "SELECT tc.constraint_underscorename" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE tc.table_underscorename=? and " + "kcu.column_underscorename in (" + insql + ")" + " and tc.table_underscoreschema=?";
                    ...
                    if (exists && diff) {
                        ...
                        try {
                            ...
                            logger.warn(LoggerMessageLocalizer.getMessage("ERROR_underscoreEXCUTING_underscoreDDL") + " (" + dml + ") " + e.getMessage());
                        }
                    }
                }
            ...
            if (objecttype.startsWith("FK")) {
                String sql = "SELECT kcu.column_underscorename" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE tc.constraint_underscorename=?" + " and tc.table_underscorename=?" + " and tc.table_underscoreschema=? order by ordinal_underscoreposition";
                PreparedStatement pstm = cn.prepareStatement(sql);
            ...
            if (objecttype.startsWith("IDX")) {
                ...
                String sql = "SELECT n.nspname" + " FROM pg_underscorecatalog.pg_underscoreclass c" + " JOIN pg_underscorecatalog.pg_underscoreindex i ON i.indexrelid = c.oid" + " JOIN pg_underscorecatalog.pg_underscoreclass c2 ON i.indrelid = c2.oid" + " LEFT JOIN pg_underscorecatalog.pg_underscoreuser u ON u.usesysid = c.relowner" + " LEFT JOIN pg_underscorecatalog.pg_underscorenamespace n ON n.oid = c.relnamespace" + " where c.relname=? and c.relkind='i' and n.nspname=?";
                PreparedStatement pstm = cn.prepareStatement(sql);
                pstm.setString(1, node.getString("OBJECTNAME").toLowerCase());
                ...
                if (rslt.next()) {
                    ...
                    rslt.close();
                    pstm.close();
                    sql = "SELECT kcu.column_underscorename" + " FROM information_underscoreschema.table_underscoreconstraints tc" + " LEFT JOIN information_underscoreschema.key_underscorecolumn_underscoreusage kcu" + " ON tc.constraint_underscorecatalog = kcu.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = kcu.constraint_underscoreschema" + " AND tc.constraint_underscorename = kcu.constraint_underscorename" + " LEFT JOIN information_underscoreschema.referential_underscoreconstraints rc" + " ON tc.constraint_underscorecatalog = rc.constraint_underscorecatalog" + " AND tc.constraint_underscoreschema = rc.constraint_underscoreschema" + " AND tc.constraint_underscorename = rc.constraint_underscorename" + " LEFT JOIN information_underscoreschema.constraint_underscorecolumn_underscoreusage ccu" + " ON rc.unique_underscoreconstraint_underscorecatalog = ccu.constraint_underscorecatalog" + " AND rc.unique_underscoreconstraint_underscoreschema = ccu.constraint_underscoreschema" + " AND rc.unique_underscoreconstraint_underscorename = ccu.constraint_underscorename" + " WHERE tc.constraint_underscorename=?" + " and tc.table_underscorename=?" + " and tc.table_underscoreschema=? and tc.constraint_underscoretype='UNIQUE'";
