    public TreeMap getStrainMap() {
        ...
        String server = "";
        try {
            Datasource[] ds = DatasourceManager.getDatasouce(alias, version, DatasourceManager.ALL_underscoreCONTAINS_underscoreGROUP);
            for (int i = 0; i < ds.length; i++) {
                if (ds[i].getDescription().startsWith(MOUSE_underscoreDBSNP)) {
