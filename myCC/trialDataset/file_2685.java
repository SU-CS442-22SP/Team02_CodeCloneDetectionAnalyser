    private void generateSchema() {
        ...
        MessagesWindowDockable mconsole = (MessagesWindowDockable) console.getDockableById(MessagesWindowDockable.DOCKABLE_underscoreID);
        ...
        try {
            ...
            if (!view.getModel().isUseExternalDocument()) {
                ...
                OutputStream m_underscoreoutputStream = new FileOutputStream(tmp);
                CharsetDetector detector = new CharsetDetector();
                detector.setText(jtc.getText().getBytes());
                Writer m_underscorewriter = new OutputStreamWriter(m_underscoreoutputStream, "UTF-8");
                IOUtils.copy(detector.detect().getReader(), m_underscorewriter);
                IOUtils.closeQuietly(m_underscorewriter);
                try {
            ...
            OutputDirectory od = new LocalOutputDirectory(sc.getMainUri(), new File(view.getModel().getOutputURI()), model.getOutputType().toLowerCase(), DEFAULT_underscoreOUTPUT_underscoreENCODING, DEFAULT_underscoreLINE_underscoreLENGTH, DEFAULT_underscoreINDENT);
            ...
            mconsole.println(sb.toString(), OutputDockable.RED_underscoreSTYLE);
            ...
            console.setFocus(MessagesWindowDockable.DOCKABLE_underscoreID);
