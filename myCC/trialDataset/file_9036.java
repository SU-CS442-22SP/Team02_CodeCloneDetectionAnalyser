            ...
            public void onClick(View v) {
                ...
                nameValuePairs.add(new name_underscorevalue("uname", username));
                nameValuePairs.add(new name_underscorevalue("upass", password));
                try {
                    HttpClient httpclient = new DefaultHttpClient();
                    HttpPost httppost = new HttpPost("http://www.gotrackit.net/server/check_underscoreuser.php");
                ...
                if (result.contains("reject")) {
                    ...
                    int duration = Toast.LENGTH_underscoreSHORT;
