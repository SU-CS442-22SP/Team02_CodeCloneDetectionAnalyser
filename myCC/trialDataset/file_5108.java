    public String sendRequest(java.lang.String servletName, java.lang.String request) {
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(null, newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("ConnectExceptionMessage"), "Critical error", javax.swing.JOptionPane.ERROR_underscoreMESSAGE);
        } catch (Exception exp) {
