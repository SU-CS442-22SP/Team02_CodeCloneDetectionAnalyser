    private void loginImageShack() throws Exception {
        ...
        formparams.add(new BasicNameValuePair("stay_underscorelogged_underscorein", ""));
        ...
        if (loginsuccessful) {
            ...
            username = "";
            password = "";
            JOptionPane.showMessageDialog(NeembuuUploader.getInstance(), "<html><b>" + HOSTNAME + "</b> " + TranslationProvider.get("neembuuuploader.accounts.loginerror") + "</html>", HOSTNAME, JOptionPane.WARNING_underscoreMESSAGE);
