    public static void doGet(HttpServletRequest request, HttpServletResponse response, CollOPort colloport, PrintStream out) throws ServletException, IOException {
        ...
        String url_underscoreindex = request.getParameter("url_underscoreindex");
        int url_underscorei;
        try {
            url_underscorei = Integer.parseInt(url_underscoreindex);
        ...
        String includeURL = includeURLs[url_underscorei];
