    private long generateNativeInstallExe(File nativeInstallFile, String instTemplate, File instClassFile) throws IOException {
        ...
        for (int n = 0; n < 3; n++) {
            ...
            if (new String(buf).equals("clname_underscorehere_underscore")) {
                VAGlobals.printDebug("  clname_underscorehere_underscore found at " + (position - 1));
                ...
                VAGlobals.printDebug("  clstart_underscorehere found at " + (position - 1));
                ...
                VAGlobals.printDebug("  clstop_underscorehere_underscore found at " + (position - 1));
