    private void uploadLogin() {
        try {
            ...
            if (file.length() > 419430400) {
                JOptionPane.showMessageDialog(neembuuuploader.NeembuuUploader.getInstance(), "<html><b>" + getClass().getSimpleName() + "</b> " + TranslationProvider.get("neembuuuploader.uploaders.maxfilesize") + ": <b>400MB</b></html>", getClass().getSimpleName(), JOptionPane.ERROR_underscoreMESSAGE);
                uploadFailed();
                return;
            }
            ...
            MultipartEntity requestEntity = new MultipartEntity(HttpMultipartMode.BROWSER_underscoreCOMPATIBLE);
