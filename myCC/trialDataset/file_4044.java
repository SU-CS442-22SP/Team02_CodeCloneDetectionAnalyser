    private void harvest() throws IOException, XMLStreamException {
        String api_underscoreurl = "http://search.twitter.com/search.atom?q=+%23" + hashtag + "+to%3A" + account;
        System.err.println(api_underscoreurl);
        URL url = new URL(api_underscoreurl);
        ...
        factory.setProperty(XMLInputFactory.IS_underscoreNAMESPACE_underscoreAWARE, true);
        factory.setProperty(XMLInputFactory.IS_underscoreVALIDATING, false);
        factory.setProperty(XMLInputFactory.IS_underscoreSUPPORTING_underscoreEXTERNAL_underscoreENTITIES, false);
