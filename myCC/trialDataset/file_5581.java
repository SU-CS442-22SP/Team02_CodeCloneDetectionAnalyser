    public void updateProfile() throws ClassNotFoundException, SQLException {
        ...
        try {
            ...
            String query3 = "UPDATE customers_underscoreprofile " + "SET first_underscorename=?,middle_underscorename=?,last_underscorename=?,address1=?" + ",address2=?,city=?,post_underscorebox=?,email=?,country=? WHERE name=?";
