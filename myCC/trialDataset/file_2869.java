    public DProblem loadProblem(String urlString) throws DataStoreException {
        try {
            ...
            IWPLog.info(this, "[DProblemManager_underscoreHTTP] URL :" + urlString);
            ...
            IWPLog.info(this, "[DProblemManager_underscoreHTTP.loadProblem] unable to load: " + urlString + ": " + e.getMessage());
            e.printStackTrace();
            throw new DataStoreException(e);
