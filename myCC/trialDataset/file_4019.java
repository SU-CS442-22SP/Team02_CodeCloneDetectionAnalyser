    public void anular() throws SQLException, ClassNotFoundException, Exception {
        ...
        try {
            ...
            String sentencia_underscoredelete = "DELETE FROM BZOFRENT " + " WHERE REN_underscoreOFANY=? AND REN_underscoreOFOFI=? AND REN_underscoreOFNUM=?";
            ms = conn.prepareStatement(sentencia_underscoredelete);
