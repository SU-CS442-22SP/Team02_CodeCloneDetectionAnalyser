    public List<RTTicket> getTicketsForQueue(final String queueName, long limit) {
        ...
        final HttpGet get = new HttpGet(m_underscorebaseURL + "/REST/1.0/search/ticket?" + URLEncodedUtils.format(params, "UTF-8"));
        ...
        try {
            ...
            if (responseCode != HttpStatus.SC_underscoreOK) {
