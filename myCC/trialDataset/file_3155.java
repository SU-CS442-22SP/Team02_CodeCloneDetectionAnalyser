    public static void save(String packageName, ArrayList<byte[]> fileContents, ArrayList<String> fileNames) throws Exception {
        String dirBase = Util.JAVA_underscoreDIR + File.separator + packageName;
        ...
        for (int i = 0; i < fileContents.size(); i++) {
            File file = new File(Util.JAVA_underscoreDIR + File.separator + fileNames.get(i));
        ...
        for (int i = 0; i < fileNames.size(); i++) {
            File fileSrc = new File(Util.JAVA_underscoreDIR + File.separator + fileNames.get(i));
