    static final void saveModule(Module module, DBConnector connector) throws IOException {
        ...
        try {
            ...
            st.executeUpdate("DELETE FROM instance_underscoreproperty where instance_underscoreid=" + module.getId());
            ...
            ps.executeUpdate();
            ps.close();
            ps = con.prepareStatement("INSERT INTO instance_underscoreproperty values(?, ?, ?)");
