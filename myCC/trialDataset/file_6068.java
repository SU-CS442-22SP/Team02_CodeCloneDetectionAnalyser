    public static String remove_underscoretag(String sessionid, String absolutePathForTheSpesificTag) {
        ...
        try {
            Log.d("current running function name:", "remove_underscoretag");
            ...
            nameValuePairs.add(new BasicNameValuePair("m", "remove_underscoretag"));
            nameValuePairs.add(new BasicNameValuePair("absolute_underscoretags", absolutePathForTheSpesificTag));
