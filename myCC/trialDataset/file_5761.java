    public void populateDefaultIcons() {
        ...
        if (!(iconDir.exists() && iconDir.isDirectory())) {
            int s = JOptionPane.showConfirmDialog(null, "Create icon directory " + this.usrIconDir + "?", "Icon directory does not exist!", JOptionPane.YES_underscoreNO_underscoreCANCEL_underscoreOPTION);
        ...
        int s = JOptionPane.showConfirmDialog(null, "Save default mappings in " + this.usrConfigFile + "?", "Icon directory populated...", JOptionPane.YES_underscoreNO_underscoreCANCEL_underscoreOPTION);
        if (s == JOptionPane.YES_underscoreOPTION) {
