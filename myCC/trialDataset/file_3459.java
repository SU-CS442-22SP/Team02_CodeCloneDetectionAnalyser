    public String uploadVideo(String ticketId, String filePath) {
        ...
        uploadParams.put("api_underscorekey", apiKey);
        uploadParams.put("auth_underscoretoken", this.TEMP_underscoreAUTH_underscoreTOKEN);
        uploadParams.put("ticket_underscoreid", ticketId);
        uploadParams.put("format", "json");
        String signature = this.generateAppSignature(uploadParams);
        uploadParams.put("api_underscoresig", signature);
