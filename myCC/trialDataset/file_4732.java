    public void run() {
        try {
            ...
            if (netLoadAccount.loginsuccessful) {
                mpEntity.addPart("upload_underscorehash", new StringBody(upload_underscorehash));
            }
            ...
            if (response.containsHeader("Location")) {
                ...
                downloadlink = CommonUploaderTasks.parseResponse(uploadresponse, "The download link is: <br/>", "\" target=\"_underscoreblank\">");
                downloadlink = downloadlink.substring(downloadlink.indexOf("href=\""));
                downloadlink = downloadlink.replace("href=\"", "");
                NULogger.getLogger().log(Level.INFO, "download link : {0}", downloadlink);
                deletelink = CommonUploaderTasks.parseResponse(uploadresponse, "The deletion link is: <br/>", "\" target=\"_underscoreblank\">");
