    public static OMElement createOMRequest(String file, int count, String[] documentIds) throws Exception {
        ...
        QName qname = new QName(URIConstants.XDSBRIDGE_underscoreURI, "SubmitDocumentRequest");
        JAXBContext jc = JAXBContext.newInstance(SubmitDocumentRequest.class);
        Marshaller marshaller = jc.createMarshaller();
        marshaller.setProperty(Marshaller.JAXB_underscoreFORMATTED_underscoreOUTPUT, Boolean.TRUE);
        ...
        List<OMElement> list = XPathHelper.selectNodes(result, "./ns:Documents/ns:Document/ns:Content", URIConstants.XDSBRIDGE_underscoreURI);
