        ...
        button.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    LayoutInflater inflater = (LayoutInflater) WebTest.this.getSystemService(Context.LAYOUT_underscoreINFLATER_underscoreSERVICE);
                    final View layout = inflater.inflate(R.layout.window1, null);
                    final PopupWindow popup = new PopupWindowTest(layout, 100, 100);
                    Button b = (Button) layout.findViewById(R.id.test_underscorebutton);
