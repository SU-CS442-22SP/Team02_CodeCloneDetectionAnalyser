    private ShaderProgram loadShaderProgram() {
        ...
        if (vertexProgram != null && fragmentProgram != null) {
            shaders[0] = new SourceCodeShader(Shader.SHADING_underscoreLANGUAGE_underscoreGLSL, Shader.SHADER_underscoreTYPE_underscoreVERTEX, vertexProgram);
            shaders[1] = new SourceCodeShader(Shader.SHADING_underscoreLANGUAGE_underscoreGLSL, Shader.SHADER_underscoreTYPE_underscoreFRAGMENT, fragmentProgram);
