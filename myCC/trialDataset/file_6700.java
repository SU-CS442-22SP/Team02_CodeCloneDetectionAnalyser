    public String sendRequest(HttpRequest request) throws IOException, AuthenticationException, RedmineException, NotFoundException {
        ...
        if (responseCode == HttpStatus.SC_underscoreUNAUTHORIZED) {
