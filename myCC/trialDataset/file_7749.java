    PasswordTableWindow(String login) {
        ...
        sql = "select key from Senhas_underscoreDe_underscoreUnica_underscoreVez where login='" + login + "'";
        try {
            ...
            try {
                ...
                try {
                    for (int i = 0; i < 10; i++) {
                        ...
                        sql = "insert into Senhas_underscoreDe_underscoreUnica_underscoreVez (login,key,password) values " + "('" + login + "'," + i + ",'" + digest + "')";
                        try {
                            theConn = DatabaseConnection.getConnection();
                            stmt = theConn.createStatement();
