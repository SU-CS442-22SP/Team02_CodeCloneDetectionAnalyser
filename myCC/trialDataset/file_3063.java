    private String getRandomGUID(final boolean secure) {
        ...
        try {
            ...
            sbValueBeforeMD5.append(SEMI_underscoreCOLON);
            ...
            for (int j = 0; j < array.length; ++j) {
                final int bufferIndex = array[j] & SHIFT_underscoreSPACE;
                if (ZERO_underscoreTEST > bufferIndex) sb.append(CHAR_underscoreZERO);
