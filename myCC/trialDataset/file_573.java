    private void login() throws LoginException {
        ...
        try {
            ...
            formparams.add(new BasicNameValuePair("HIDEURL", "?WM_underscoreAK=https%3a%2f%2fimode.net%2fag&path=%2fimail%2ftop&query="));
            formparams.add(new BasicNameValuePair("LOGIN", "WM_underscoreLOGIN"));
            formparams.add(new BasicNameValuePair("WM_underscoreKEY", "0"));
            formparams.add(new BasicNameValuePair("MDCM_underscoreUID", this.name));
            formparams.add(new BasicNameValuePair("MDCM_underscorePWD", this.pass));
