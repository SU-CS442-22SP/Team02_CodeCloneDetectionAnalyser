    private static MyCookieData parseCookie(Cookie cookie) throws CookieException {
        ...
        String hsh = parts[3];
        boolean valid_underscorecookie = true;
        String cookie_underscoresecret = System.getProperty("COOKIE_underscoreSECRET");
        if (cookie_underscoresecret == "") throw new CookieException("cookie secret is not set");
        if (email.equals("")) {
            ...
            try {
                ...
                sha.update((email + nickname + admin + cookie_underscoresecret).getBytes());
                ...
                if (!vhsh.equals(hsh)) {
                    ...
                    valid_underscorecookie = false;
                } else System.out.println("cookie match!");
            } catch (NoSuchAlgorithmException ex) {
            }
        }
        return new MyCookieData(email, admin, nickname, valid_underscorecookie);
    }
