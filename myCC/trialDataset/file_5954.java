    public static void copy(String from_underscorename, String to_underscorename, boolean overwriteOk) throws IOException {
        ...
        if (to_underscorefile.exists()) {
            if (!to_underscorefile.canWrite()) abort("FileCopy: destination file is unwriteable: " + to_underscorename);
            if (!overwriteOk) {
                System.out.print("Overwrite existing file " + to_underscorename + "? (Y/N): ");
                System.out.flush();
