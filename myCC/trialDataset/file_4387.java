    public void testCreateNewXMLFile() throws InvalidNodeTypeDefException, ParseException, Exception {
        ...
        InputStream contentIn2 = getClass().getResourceAsStream(CONTENT2_underscoreFILE);
        ...
        InputStream expected = getClass().getResourceAsStream(CONTENT2_underscoreFILE);
        ...
        JCRNodeSource tmpSrc = (JCRNodeSource) resolveSource(BASE_underscoreURL + "users/alexander.saar");
