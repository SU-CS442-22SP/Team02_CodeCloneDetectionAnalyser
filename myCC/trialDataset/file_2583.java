    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (request.getParameter("searchdb") != null) {
                ...
                out.write("<ul>");
                PreparedStatement sqlGetLikeBaseString = conn.prepareStatement("SELECT * FROM ENTRIES WHERE XTM_underscoreSESSION_underscoreID = ? AND XTM_underscoreTEXT LIKE ?");
                ...
                while (res.next()) {
                    out.write("<li>");
                    out.write(res.getString("XTM_underscoreTEXT"));
                    out.write("</li>");
                }
                out.write("</ul>");
                res.close();
