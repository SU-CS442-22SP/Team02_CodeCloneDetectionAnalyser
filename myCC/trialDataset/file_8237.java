    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException {
        ...
        String parameter = requestURI.substring(requestURI.lastIndexOf(ARXIVID_underscoreENTRY) + ARXIVID_underscoreENTRY_underscoreLENGTH);
        int signIndex = parameter.indexOf(StringUtil.ARXIVID_underscoreSEGMENTID_underscoreDELIMITER);
