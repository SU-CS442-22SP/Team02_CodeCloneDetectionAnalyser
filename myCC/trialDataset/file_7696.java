    public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        response.reset();
        response.setHeader("Content-Disposition", getEnvironment().getStringSetting(Environment.PROPERTY_underscoreATTACHMENT_underscoreTYPE) + ";filename=" + attachmentName + ";");
