    public void checkAndDownload(String statsUrl, RDFStatsUpdatableModelExt stats, Date lastDownload, boolean onlyIfNewer) throws DataSourceMonitorException {
        ...
        try {
            ...
            urlConnection.setConnectTimeout(CONNECT_underscoreTIMEOUT);
            urlConnection.setReadTimeout(READ_underscoreTIMEOUT);
        ...
        boolean newer = lastDownload == null || lastModified == 0 || lastModified - TIMING_underscoreGAP > lastDownload.getTime();
