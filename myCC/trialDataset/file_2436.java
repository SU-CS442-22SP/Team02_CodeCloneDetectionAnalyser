    public void startStreaming(final String mediaUrl) throws IOException {
        ...
        try {
            ...
            if (ctype.contains(AUDIO_underscoreMPEG) || ctype.equals("")) {
                String temp = urlConn.getHeaderField(BITERATE_underscoreHEADER);
        ...
        if (regularStream) {
            ...
            INTIAL_underscoreKB_underscoreBUFFER = bitrate * SECONDS / BIT;
            Runnable r = new Runnable() {
