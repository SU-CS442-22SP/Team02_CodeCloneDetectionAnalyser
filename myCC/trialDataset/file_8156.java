    private static boolean genMovieRatingFile(String completePath, String masterFile, String CustLocationsFileName, String MovieRatingFileName) {
        try {
            ...
            ByteBuffer mappedBuffer = inC1.map(FileChannel.MapMode.READ_underscoreONLY, 0, fileSize1);
            ...
            for (int i = 0; i < 1; i++) {
                ByteBuffer locBuffer = inC2.map(FileChannel.MapMode.READ_underscoreONLY, i * fileSize2, fileSize2);
