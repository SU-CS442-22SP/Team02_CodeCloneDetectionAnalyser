    public File createWindow(String pdfUrl) {
        ...
        try {
            ...
            tempURLFile = File.createTempFile(filename.substring(0, filename.lastIndexOf('.')), filename.substring(filename.lastIndexOf('.')), new File(ObjectStore.temp_underscoredir));
            ...
            if (visible) {
                ...
                turnOff.setAlignmentY(JLabel.RIGHT_underscoreALIGNMENT);
