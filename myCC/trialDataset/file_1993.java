        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    int format = args[1].toLowerCase().endsWith("sql") ? SQL_underscoreFORMAT : SHORT_underscoreFORMAT;
                    File file = new File(args[1]);
                    if (format == SHORT_underscoreFORMAT) {
                    ...
                    if (format == SQL_underscoreFORMAT) {
