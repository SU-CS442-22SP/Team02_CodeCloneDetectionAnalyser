    public List<SuspectFileProcessingStatus> retrieve() throws Exception {
        ...
        try {
            ...
            InputStream is = null;
            if (getUseProxy()) {
                is = URLUtils.getResponse(getUrl(), getUserName(), getPassword(), URLUtils.HTTP_underscoreGET_underscoreMETHOD, getProxyHost(), getProxyPort());
            ...
            String loadType = GeneralConstants.LOAD_underscoreTYPE_underscoreFULL;
            String feedType = GeneralConstants.EMPTY_underscoreTOKEN;
