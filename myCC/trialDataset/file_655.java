    private void analyseCorpus(final IStatusDisplayer fStatus) {
        ...
        try {
            ...
            Chunker.train(dsSet.toFilenameSet(DocumentSet.FROM_underscoreWHOLE_underscoreSET));
            ...
            while (iIter.hasNext()) {
                ...
                sgOverallGraph.setDataString(((new StringBuffer().append((char) StreamTokenizer.TT_underscoreEOF))).toString());
            ...
            int iMinSymbolSize = Integer.MAX_underscoreVALUE;
            int iMaxSymbolSize = Integer.MIN_underscoreVALUE;
