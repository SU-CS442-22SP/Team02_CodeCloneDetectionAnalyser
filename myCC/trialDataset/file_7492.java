    void run(String[] args) {
        ...
        if (!(metric instanceof MetricSumSquares) && priorityScheme != NO_underscorePRIORITIES) System.out.println("Warning: using priorities with the non-default metric is normally worthless");
