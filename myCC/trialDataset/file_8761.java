    public static String calcResponse(String ha1, String nonce, String nonceCount, String cnonce, String qop, String method, String uri) throws FatalException, MD5DigestException {
        ...
        if (method == null || uri == null) {
            throw new MD5DigestException(WebdavStatus.SC_underscoreBAD_underscoreREQUEST, "method or uri");
        }
        if (qop != null && qop.equals("auth-int")) {
            throw new MD5DigestException(WebdavStatus.SC_underscoreUNSUPPORTED_underscoreMEDIA_underscoreTYPE);
        }
        if (nonce == null) {
            throw new MD5DigestException(WebdavStatus.SC_underscoreBAD_underscoreREQUEST, "nonce");
        }
        if (qop != null && (qop.equals("auth") || qop.equals("auth-int"))) {
            if (nonceCount == null || cnonce == null) {
                throw new MD5DigestException(WebdavStatus.SC_underscoreBAD_underscoreREQUEST, "nc or cnonce");
            }
        }
