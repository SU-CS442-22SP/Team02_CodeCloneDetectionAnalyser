        ...
        try {
            ...
            while ((protocol = f.readLine()) != null) {
                ...
                if (m.matches()) {
                    ...
                    changelogdir = changelogdir.replace('/', '_underscore');
                    changelogdir = changelogdir.replaceAll("\\.", "_underscore");
                    changelogdir = changelogdir.replaceAll("-", "_underscore");
                    changelogdir = changelogdir.replaceAll(":", "_underscoreCOLON_underscore");
                    adress = adress + "Packages.gz";
                    final String serverFileLocation = adress.replaceAll(":", "_underscoreCOLON_underscore");
