    public static Image load(final InputStream input, String format, Point dimension) throws CoreException {
        ...
        try {
            dotInput = File.createTempFile(TMP_underscoreFILE_underscorePREFIX, DOT_underscoreEXTENSION);
            dotOutput = File.createTempFile(TMP_underscoreFILE_underscorePREFIX, "." + format);
            dotOutput.delete();
