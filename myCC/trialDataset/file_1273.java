    private synchronized boolean createOrganization(String organizationName, HttpServletRequest req) {
        if ((organizationName == null) || (organizationName.equals(""))) {
            message = "invalid new_underscoreorganization_underscorename.";
            return false;
        }
        ...
        schemaDir.mkdir();
        String organization_underscoretemp_underscoredir = ServerConsoleServlet.convertToAbsolutePath(ServerConsoleServlet.getConfigByTagName("OrganizationTemplate"));
        File templ = new File(organization_underscoretemp_underscoredir);
