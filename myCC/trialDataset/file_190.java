    public void writeBack(File destinationFile, boolean makeCopy) throws IOException {
        ...
        if (getExifTime() != null && getOriginalTime() != null && !getExifTime().equals(getOriginalTime())) {
            String adjustArgument = "-ts" + m_underscoredfJhead.format(getExifTime());
            ProcessBuilder pb = new ProcessBuilder(m_underscoretm.getJheadCommand(), adjustArgument, destinationFile.getAbsolutePath());
