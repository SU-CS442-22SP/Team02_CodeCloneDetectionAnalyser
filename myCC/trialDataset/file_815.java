    private void insert() throws SQLException, NamingException {
        ...
        try {
            ...
            try {
                ...
                stmt = conn.prepareStatement(INSERT_underscoreSEQ);
                stmt.setString(INS_underscoreNAME, getName());
                stmt.setLong(INS_underscoreNEXT_underscoreKEY, defaultInterval * 2);
                stmt.setLong(INS_underscoreINTERVAL, defaultInterval);
                stmt.setLong(INS_underscoreUPDATE, System.currentTimeMillis());
                try {
