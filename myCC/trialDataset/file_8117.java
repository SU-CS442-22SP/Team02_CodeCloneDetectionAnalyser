        ...
        if (open != null) {
            ...
            try {
                ...
                if (e.getCause() instanceof CoreException) {
                    ErrorDialog.openError(activeShell, Messages.SaveFileOnDiskHandler_underscoreErrorSaving2, Messages.SaveFileOnDiskHandler_underscoreErrorSaving2, ((CoreException) e.getCause()).getStatus());
                } else {
                    ErrorDialog.openError(activeShell, Messages.SaveFileOnDiskHandler_underscoreErrorSaving2, Messages.SaveFileOnDiskHandler_underscoreErrorSaving2, StatusCreator.newStatus(Messages.SaveFileOnDiskHandler_underscoreErrorSaving3, e));
                }
