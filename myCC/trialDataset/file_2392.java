    public void unlock(String oid, String key) throws PersisterException {
        ...
        try {
            ...
            ps = conn.prepareStatement("update " + _underscoretable_underscorename + " set " + _underscorekey_underscorecol + " = NULL, " + _underscorets_underscorecol + " = ? where " + _underscoreoid_underscorecol + " = ?");
