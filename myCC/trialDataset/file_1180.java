    public static boolean downFile(String url, String username, String password, String remotePath, Date DBLastestDate, String localPath) {
        ...
        try {
            ...
            if (DBLastestDate == null) {
                ...
                String nowDateStr = Constants.DatetoString(nowDate, Constants.Time_underscoretemplate_underscoreLONG);
                String fileName;
                do {
                    ldate += 60 * 1000;
                    Date converterDate = new Date(ldate);
                    fileName = Constants.DatetoString(converterDate, Constants.Time_underscoretemplate_underscoreLONG);
