    public static CMLUnitList createUnitList(URL url) throws IOException, CMLException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CMLException("NULL " + e.getMessage() + S_underscoreSLASH + e.getCause() + " in " + url);
        } catch (ValidityException e) {
            throw new CMLException(S_underscoreEMPTY + e.getMessage() + S_underscoreSLASH + e.getCause() + " in " + url);
