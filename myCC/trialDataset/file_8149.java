            ...
            try {
                ...
                if (cm.GetIfFetchTimedOut()) {
                    ...
                    for (int i = 0; i < cm.NumberOfChannels(); i++) {
                        ...
                        if (chan.endsWith("/_underscoresignature")) {
                            sigIdx = i;
                            continue;
                        }
                    ...
                    if (cm.NumberOfChannels() > 0) {
                        ...
                        if (sigIdx >= 0) {
                            ...
                            System.err.println(pluginName + ": _underscoresignature attached for: " + cm.GetName(0));
                            int idx = picm.Add("_underscoresignature");
                            picm.PutTime(0., 0.);
