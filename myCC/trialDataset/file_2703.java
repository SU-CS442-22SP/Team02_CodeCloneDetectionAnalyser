    public static ArrayList<Quote> fetchAllQuotes(String symbol, Date from, Date to) {
        try {
            ...
            String dayFrom = (new Integer(calendar.get(GregorianCalendar.DAY_underscoreOF_underscoreMONTH))).toString();
            ...
            String dayTo = (new Integer(calendar.get(GregorianCalendar.DAY_underscoreOF_underscoreMONTH))).toString();
