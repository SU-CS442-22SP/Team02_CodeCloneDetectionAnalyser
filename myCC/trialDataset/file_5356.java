    public void processSaveHolding(Holding holdingBean, AuthSession authSession) {
        ...
        try {
            ...
            String sql = "UPDATE WM_underscoreLIST_underscoreHOLDING " + "SET " + "   full_underscorename_underscoreHOLDING=?, " + "   NAME_underscoreHOLDING=? " + "WHERE ID_underscoreHOLDING = ? and ID_underscoreHOLDING in ";
            switch(dbDyn.getFamaly()) {
                case DatabaseManager.MYSQL_underscoreFAMALY:
                    ...
                    break;
                default:
                    sql += "(select z1.ID_underscoreROAD from v$_underscoreread_underscorelist_underscoreroad z1 where z1.user_underscorelogin = ?)";
                    break;
            }
