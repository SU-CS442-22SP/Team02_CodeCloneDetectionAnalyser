    protected long loadFromSource(long afterThisTime) {
        ...
        if (afterThisTime == FIRST_underscoreTIME_underscoreLOAD) {
        ...
        int b = calendar.get(Calendar.DAY_underscoreOF_underscoreMONTH);
        int c = calendar.get(Calendar.YEAR);
        calendar.setTime(toDate);
        int d = calendar.get(Calendar.MONTH);
        int e = calendar.get(Calendar.DAY_underscoreOF_underscoreMONTH);
        ...
        try {
            ...
            while ((s = dis.readLine()) != null) {
                ...
                quote.amount = -1;
                quote.close_underscoreadj = Float.parseFloat(items[iAdjClose].trim());
