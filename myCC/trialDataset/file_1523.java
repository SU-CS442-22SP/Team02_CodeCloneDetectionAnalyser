    public void init() throws GateException {
        ...
        try {
            ...
            reportWriter.setDefaultNamespace(Tools.REPORT_underscoreNAMESPACE);
            reportWriter.writeStartElement(Tools.REPORT_underscoreNAMESPACE, "cloudReport");
            reportWriter.writeDefaultNamespace(Tools.REPORT_underscoreNAMESPACE);
            reportWriter.writeCharacters("\n");
            reportWriter.writeStartElement(Tools.REPORT_underscoreNAMESPACE, "documents");
                ...
                try {
                    ...
                    while (xer.hasNext()) {
                        ...
                        if (event.isStartElement() && event.asStartElement().getName().getLocalPart().equals("processResult")) {
                            currentReturnCode = event.asStartElement().getAttributeByName(new QName(XMLConstants.NULL_underscoreNS_underscoreURI, "returnCode")).getValue();
                            currentDocid = event.asStartElement().getAttributeByName(new QName(XMLConstants.NULL_underscoreNS_underscoreURI, "id")).getValue();
                        }
