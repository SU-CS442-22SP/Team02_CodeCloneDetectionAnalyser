    private JButton getButtonImagen() {
        if (buttonImagen == null) {
            ...
            buttonImagen.setIcon(new ImageIcon(getClass().getResource("/data/icons/view_underscoresidetree.png")));
            buttonImagen.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (returnVal == JFileChooser.APPROVE_underscoreOPTION) {
                        ...
                        buttonImagen.setIcon(new ImageIcon(getClass().getResource("/data/icons/view_underscoresidetreeOK.png")));
