        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == btnOK) {
                ...
                sql = "select password from Senhas_underscoreDe_underscoreUnica_underscoreVez where login='" + login + "'" + " and key=" + key + " ";
                try {
                ...
                if (checkPassword == true) {
                    ...
                    sql = "delete from Senhas_underscoreDe_underscoreUnica_underscoreVez where login='" + login + "'" + " and key=" + key + " ";
                    try {
                        theConn = DatabaseConnection.getConnection();
                        stmt = theConn.createStatement();
                    ...
                    mw.setDefaultCloseOperation(JFrame.EXIT_underscoreON_underscoreCLOSE);
                } else {
