    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == print) {
            ...
            try {
                ...
                URL u = new URL(s);
                a.showDocument(u, "_underscoreblank");
        ...
        if (e.getSource() == webSite) {
            ...
            String s = "http://sis450.berkeley.edu:4200/OSOC/osoc?p_underscoreterm=" + tr + "&p_underscoredeptname=" + URLEncoder.encode(lst.getSelectedItem().toString()) + "&p_underscorecourse=" + num;
            try {
                AppletContext a = getAppletContext();
                URL u = new URL(s);
                a.showDocument(u, "_underscoreblank");
        ...
        if (e.getSource() == loadButton) {
            ...
            fileName = fileName.replace(' ', '_underscore');
        ...
        if (e.getSource() == net) {
            ...
            try {
                ...
                {
                    urlIn = "http://sis450.berkeley.edu:4200/OSOC/osoc?p_underscoreterm=" + tr + "&p_underscoredeptname=" + URLEncoder.encode(dept) + "&p_underscorecourse=" + num;
                    try {
                ...
                if (first >= '1' && first <= '9') {
                    ...
                    while (andST.hasMoreTokens()) {
                        ...
                        try {
                            ...
                            rePrintAnswer = true;
                            textArea2.setText("Error: There should be no a/p sign after FROM_underscoreTIME.");
                            badInput = true;
                            repaint();
                            return;
                        }
