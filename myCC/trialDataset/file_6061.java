    private void googleImageSearch() {
        ...
        custom = "";
        int r = JOptionPane.showConfirmDialog(this, "Customize google search?", "Google Search", JOptionPane.YES_underscoreNO_underscoreOPTION);
        if (r == JOptionPane.YES_underscoreOPTION) {
        ...
        add(jPanel1, BorderLayout.PAGE_underscoreEND);
        pack();
    }
