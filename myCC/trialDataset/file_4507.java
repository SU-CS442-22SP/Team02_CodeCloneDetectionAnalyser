    public String report() {
        ...
        if (getRecord_underscoreID() == 0) return "ID=0";
        if (getRecord_underscoreID() == 1) {
            parameter.append("ISSUE=");
            HashMap htOut = get_underscoreHashMap();
            try {
            ...
            try {
                parameter.append("RECORDID=").append(getRecord_underscoreID());
