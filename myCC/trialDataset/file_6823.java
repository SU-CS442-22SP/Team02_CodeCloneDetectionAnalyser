    public FetchTextFromWebPage(String path) {
        ...
        try {
            ...
            ByteArrayInputStream ba_underscoreread = new ByteArrayInputStream(html);
            r = new InputStreamReader(ba_underscoreread);
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        ByteArrayInputStream ba_underscoreread = new ByteArrayInputStream(newbyte);
                        r = new InputStreamReader(ba_underscoreread);
                    } catch (IOException e1) {
                        e1.printStackTrace();
                    }
