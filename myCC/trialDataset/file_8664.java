    public RawTableData(int selectedId) {
        ...
        String urlString = dms_underscoreurl + "/servlet/com.ufnasoft.dms.server.ServerGetProjectDocuments";
        String rvalue = "";
        String filename = dms_underscorehome + FS + "temp" + FS + username + "documents.xml";
        try {
