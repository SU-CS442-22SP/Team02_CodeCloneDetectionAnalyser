    public AddressType[] getAdressFromCRSCoordinate(Point3d crs_underscoreposition) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "no connection to reverse geocoder", "Connection Error", JOptionPane.ERROR_underscoreMESSAGE);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
