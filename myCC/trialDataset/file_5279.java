    private Map fetchAdData(String url) throws ClientProtocolException, IOException {
        ...
        protocal.put(AuthUtils.AUTH_underscoreAPP, app);
        protocal.put(AuthUtils.AUTH_underscoreOWNER, owner);
        protocal.put(AuthUtils.AUTH_underscoreSESSION, session);
        ...
        request.setHeader(AuthUtils.AUTH_underscoreAPP, app);
        request.setHeader(AuthUtils.AUTH_underscoreOWNER, owner);
        request.setHeader(AuthUtils.AUTH_underscoreSESSION, session);
