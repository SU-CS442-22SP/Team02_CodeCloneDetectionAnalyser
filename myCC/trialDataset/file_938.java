    public void startElement(String uri, String tag, String qName, org.xml.sax.Attributes attributes) throws SAXException {
        ...
        try {
            if (tag.equals("window")) {
                ...
                if ((id != null && id.equals("WINDOW_underscoreMENU") || label.equalsIgnoreCase("window"))) {
                ...
                if (action.equals("WINDOW_underscoreOVERLAPPED")) {
                    item = windowMenuOverlapped = new JMenuItem();
                    item.setActionCommand("10001");
                    item.addActionListener(frame);
                } else if (action.equals("WINDOW_underscoreTILE_underscoreHORIZONTALLY")) {
                    item = windowMenuTile = new JMenuItem();
                    item.setActionCommand("10002");
                    item.addActionListener(frame);
                } else if (action.equals("WINDOW_underscoreTILE_underscoreVERTICALLY")) {
                ...
                if (frame.getToolBar() != null) {
                    if (icon.length() > 0) {
                        try {
                            ...
                            BufferedImage image = new BufferedImage(25, 25, BufferedImage.TYPE_underscore4BYTE_underscoreABGR);
                            Graphics g = image.createGraphics();
                            g.setColor(new Color(0, 0, 0, 0));
                            g.fillRect(0, 0, 25, 25);
                            g.drawImage(img.getImage(), 4, 4, 16, 16, (ImageObserver) null);
                            BufferedImage pressed = new BufferedImage(25, 25, BufferedImage.TYPE_underscore4BYTE_underscoreABGR);
                            ...
                            BufferedImage over = new BufferedImage(25, 25, BufferedImage.TYPE_underscore4BYTE_underscoreABGR);
                ...
                combo_underscoretext = prop.getValue("text", "");
                combo.setBounds(x, y, width, height);
                combo.setName((String) id);
                if (editable) {
                    combo.setEditable(editable);
                    combo.setSelectedItem(combo_underscoretext);
                }
                ...
                if (combo != null) {
                    ...
                    combo.addItem(co);
                    if (combo_underscoretext.equals(text.trim())) combo.setSelectedItem(co);
                }
                ...
                treeview_underscoreroot = new DefaultMutableTreeNode("root");
                treeview = new JTree(treeview_underscoreroot);
                Object constraints = prop.getValue("constraints");
                ...
                treeview_underscoreroot.add(node);
