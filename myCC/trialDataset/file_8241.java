    private URL retrieveFirstURL(URL url, RSLink link) {
        link.setStatus(RSLink.STATUS_underscoreWAITING);
        URL result = null;
        ...
        Pattern urlString = Pattern.compile("http://[a-zA-Z0-9\\.\\-/_underscore]+");
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Can not close some connections:\n" + ex.getMessage(), "ERROR", JOptionPane.ERROR_underscoreMESSAGE);
            }
            if (httpConn != null) httpConn.disconnect();
            link.setStatus(RSLink.STATUS_underscoreNOTHING);
            return result;
        }
    }
