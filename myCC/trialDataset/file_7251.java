        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == btnRegister) {
                ...
                sql = "insert into Usuarios (login,password,tries_underscorepersonal,tries_underscoreone_underscoreuse," + "grupo,description) values " + "('" + loginUser.getText() + "','" + outputDigest + "',0,0,'" + group + "','" + nameUser.getText() + "')";
                try {
                    theConn = DatabaseConnection.getConnection();
                    stmt = theConn.createStatement();
                ...
                try {
                    ...
                    try {
                        for (i = 0; i < Integer.parseInt(numPasswordOneUseUser.getText()); i++) {
                            ...
                            sql = "insert into Senhas_underscoreDe_underscoreUnica_underscoreVez (login,key,password) values " + "('" + loginUser.getText() + "'," + i + ",'" + digest + "')";
                            try {
                                theConn = DatabaseConnection.getConnection();
                                stmt = theConn.createStatement();
                                stmt.executeUpdate(sql);
