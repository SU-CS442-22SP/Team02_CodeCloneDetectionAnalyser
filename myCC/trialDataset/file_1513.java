    public static void main(String[] args) {
        try {
            ...
            if (args.length == 2) {
                ...
                System.out.println("Please provide complete path to training_underscoreset parent folder as an argument. EXITING");
                System.exit(0);
            }
            ...
            ByteBuffer mappedfile = inC.map(FileChannel.MapMode.READ_underscoreONLY, 0, filesize);
            ...
            mappedfile = inC.map(FileChannel.MapMode.READ_underscoreONLY, 0, filesize);
            ...
            inC = new FileInputStream(inputFile).getChannel();
            filesize = (int) inC.size();
            ByteBuffer probemappedfile = inC.map(FileChannel.MapMode.READ_underscoreONLY, 0, filesize);
