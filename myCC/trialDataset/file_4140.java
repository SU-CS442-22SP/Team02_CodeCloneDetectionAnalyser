    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.requestWindowFeature(Window.FEATURE_underscoreNO_underscoreTITLE);
        ...
        try {
            ...
            Bitmap output = Bitmap.createBitmap(frame.getWidth(), frame.getHeight(), Bitmap.Config.ARGB_underscore8888);
