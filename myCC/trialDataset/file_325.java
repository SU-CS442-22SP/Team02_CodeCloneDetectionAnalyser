    public static Document send(String address, Document request) throws MalformedURLException, IOException {
        ...
        os.flush();
        os.close();
        if (connection.getResponseCode() != connection.HTTP_underscoreOK) {
            logger.error("Was expecting HTTP_underscoreOK (200) but received response code: " + connection.getResponseCode());
            logger.error("Message: " + connection.getResponseMessage());
            throw new LibraryException(LibraryException.Code.REQUEST_underscoreFAILURE, connection.getResponseCode() + " - " + connection.getResponseMessage());
        }
        ...
        try {
            ...
            throw new LibraryException(LibraryException.Code.INVALID_underscoreXML, ex);
        }
    }
