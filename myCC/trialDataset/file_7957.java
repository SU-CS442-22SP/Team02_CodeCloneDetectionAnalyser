    protected void innerProcess(CrawlURI curi) throws InterruptedException {
        ...
        long maxsize = DEFAULT_underscoreMAX_underscoreSIZE_underscoreBYTES.longValue();
        try {
            maxsize = ((Long) getAttribute(curi, ATTR_underscoreMAX_underscoreSIZE_underscoreBYTES)).longValue();
        ...
        String regexpr = "";
        try {
            regexpr = (String) getAttribute(curi, ATTR_underscoreSTRIP_underscoreREG_underscoreEXPR);
