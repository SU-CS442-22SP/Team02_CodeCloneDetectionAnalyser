    private static void getFileFtp(String user, String password, String host, int port, String fileName, String location) throws Exception {
        Log.info("\nretrieve " + fileName + NEW_underscoreLINE);
        ...
        try {
            ...
            Log.info("chdir-status:" + status + NEW_underscoreLINE);
            client.setFileTransferMode(FTPClient.BINARY_underscoreFILE_underscoreTYPE);
