    public Sequence eval(Sequence[] args, Sequence contextSequence) throws XPathException {
        GrammarPool grammarpool = (GrammarPool) config.getProperty(XMLReaderObjectFactory.GRAMMER_underscorePOOL);
        if (isCalledAs("clear-grammar-cache")) {
            ...
            if (args[0].isEmpty()) return Sequence.EMPTY_underscoreSEQUENCE;
            XMLGrammarPreparser parser = new XMLGrammarPreparser();
            parser.registerPreparser(TYPE_underscoreXSD, null);
            ...
            for (SequenceIterator i = args[0].iterate(); i.hasNext(); ) {
                ...
                try {
                    if (url.endsWith(".xsd")) {
                        ...
                        Grammar schema = parser.preparseGrammar(TYPE_underscoreXSD, xis);
                        is.close();
            ...
            grammarpool.cacheGrammars(TYPE_underscoreXSD, grammars);
