    ...
    public void testHandleMessageInvalidSignature() throws Exception {
        ...
        EasyMock.expect(mockHttpSession.getAttribute(SignatureDataMessageHandler.DIGEST_underscoreVALUE_underscoreSESSION_underscoreATTRIBUTE)).andStubReturn(digestValue);
        EasyMock.expect(mockHttpSession.getAttribute(SignatureDataMessageHandler.DIGEST_underscoreALGO_underscoreSESSION_underscoreATTRIBUTE)).andStubReturn("SHA-1");
