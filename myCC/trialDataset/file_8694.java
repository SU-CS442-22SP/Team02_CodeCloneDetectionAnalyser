    public void setInternalReferences() {
        ...
        try {
            ...
            for (int i = 0; i < params2.length; i++) {
                ...
                sql = "select r.sourcedoc_underscoreid, " + params2[i][0] + ".id, " + params2[i][0] + "." + params2[i][1] + " from REFERENCE r, " + params2[i][0] + " where r.refdoc_underscorename = " + params2[i][0] + "." + params2[i][1] + " and r.refdoc_underscoreid is null";
                Statement stmt = conn.createStatement();
                ResultSet rset = stmt.executeQuery(sql);
                sql2 = "update REFERENCE set refdoc_underscoreid=? where sourcedoc_underscoreid=? and refdoc_underscorename=?";
            ...
            try {
                conn.rollback();
            } catch (SQLException inner_underscoreex) {
