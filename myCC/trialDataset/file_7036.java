    public static void loadPackage1(String ycCode) {
        ...
        try {
            ...
            uc.setConnectTimeout(CONNECTION_underscoreTIMEOUT);
            uc.setReadTimeout(CONNECTION_underscoreTIMEOUT);
            ...
            String target = System.getProperty("user.home") + System.getProperty("file.separator") + "youthclub_underscore" + new SimpleDateFormat("yyyyMMdd_underscoreHHmm").format(new Date()) + ".xml";
