    public static synchronized String getSequenceNumber(String SequenceName) {
        ...
        ResultSet rs = null;
        try {
            conn = TPCW_underscoreDatabase.getConnection();
            conn.setAutoCommit(false);
            String sql = "select num from sequence where name='" + SequenceName + "'";
            ps = conn.createStatement(ResultSet.TYPE_underscoreSCROLL_underscoreINSENSITIVE, ResultSet.CONCUR_underscoreUPDATABLE);
