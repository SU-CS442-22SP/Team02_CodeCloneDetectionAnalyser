    ...
    public String addUser(UserInfoItem user) throws DatabaseException {
        ...
        try {
            ...
            if (user.getId() != null) {
                ...
                updSt = getConnection().prepareStatement(UPDATE_underscoreUSER_underscoreSTATEMENT);
                updSt.setString(1, user.getName());
                updSt.setString(2, user.getSurname());
                updSt.setLong(3, id);
                modified = updSt.executeUpdate();
            } else {
                insSt = getConnection().prepareStatement(INSERT_underscoreUSER_underscoreSTATEMENT);
                ...
                seqSt = getConnection().prepareStatement(USER_underscoreCURR_underscoreVALUE);
