        ...
        for (Library library : libraryModels) {
            ...
            for (Component component : library.getComponents()) {
                ...
                try {
                    ...
                    if (specificationLocation.getRelativeResource(componentName + "_underscoretapdoc/resource").getResourceURL() != null) {
                        File srcResourcesDirectory = new File(specificationLocation.getRelativeResource(componentName + "_underscoretapdoc/resource").getResourceURL().toURI());
