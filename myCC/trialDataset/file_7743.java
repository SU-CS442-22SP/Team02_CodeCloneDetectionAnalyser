    public void testQueryForBinary() throws InvalidNodeTypeDefException, ParseException, Exception {
        JCRNodeSource source = (JCRNodeSource) resolveSource(BASE_underscoreURL + "images/photo.png");
        ...
        os.flush();
        os.close();
        QueryResultSource qResult = (QueryResultSource) resolveSource(BASE_underscoreURL + "images?/*[contains(local-name(), 'photo.png')]");
