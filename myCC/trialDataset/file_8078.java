    public void removeExifTag(File jpegImageFile, File dst) throws IOException, ImageReadException, ImageWriteException {
        ...
        try {
            ...
            {
                outputSet.removeField(TiffConstants.EXIF_underscoreTAG_underscoreAPERTURE_underscoreVALUE);
                TiffOutputDirectory exifDirectory = outputSet.getExifDirectory();
                if (null != exifDirectory) exifDirectory.removeField(TiffConstants.EXIF_underscoreTAG_underscoreAPERTURE_underscoreVALUE);
            }
