    public static Multimap<String, String> getProteins(final Set<String> queries, final int taxon) throws ParserConfigurationException, XPathExpressionException {
        ...
        final XPathExpression xpe = XPathFactory.newInstance().newXPath().compile(_underscore_underscorexpath);
        ...
        for (final String query : queries) {
            ...
            try {
                ...
                final URL url = new URL(String.format(_underscore_underscoreurlTempl2, encoded, taxon));
                connection = (HttpURLConnection) url.openConnection();
                connection.setConnectTimeout(_underscore_underscoreconnTimeout);
                connection.setReadTimeout(_underscore_underscorereadTimeout);
