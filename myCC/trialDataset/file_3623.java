    public void saveToPackage() {
        ...
        if (!checkPackage()) {
            JOptionPane.showMessageDialog(this, "No package selected. Aborting.", "Package not selected!", JOptionPane.WARNING_underscoreMESSAGE);
            return;
        }
        ...
        try {
            ...
            if (overwriteFile != JOptionPane.CANCEL_underscoreOPTION) {
                ...
                JOptionPane.showMessageDialog(null, "Saved to package: " + getPackageFile().getName(), "Saved", JOptionPane.INFORMATION_underscoreMESSAGE);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
