    public void GetFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
        ...
        String sourceNode = attributes.get("src_underscorename");
        String sourceUser = attributes.get("src_underscoreuser");
        String sourcePassword = attributes.get("src_underscorepassword");
        String sourceFile = attributes.get("src_underscorefile");
        String messageID = attributes.get("messageID");
        String sourceMD5 = attributes.get("src_underscoremd5");
        String sourceFileType = attributes.get("src_underscorefile_underscoretype");
        Integer sourcePort = 21;
        String sourcePortString = attributes.get("src_underscoreport");
        ...
        if (sourceFileType != null) {
            if (sourceFileType.equals("A")) {
                ...
                ftp.setFileType(FTP.EBCDIC_underscoreFILE_underscoreTYPE);
            }
        }
