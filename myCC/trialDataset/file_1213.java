    public void deleteUser(String userID) throws XregistryException {
        try {
            ...
            try {
                PreparedStatement statement1 = connection.prepareStatement(DELETE_underscoreUSER_underscoreSQL_underscoreMAIN);
                statement1.setString(1, userID);
                statement1.executeUpdate();
                PreparedStatement statement2 = connection.prepareStatement(DELETE_underscoreUSER_underscoreSQL_underscoreDEPEND);
