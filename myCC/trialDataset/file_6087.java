    public void create(Session session) {
        ...
        try {
            ...
            if (isSequenceTableRequired()) {
                ...
                if (exception != null) {
                    switch(MetaParams.ORM2DLL_underscorePOLICY.of(ormHandler.getParameters())) {
                        case VALIDATE:
                            throw new IllegalStateException(logMsg, exception);
                        case CREATE_underscoreDDL:
                        case CREATE_underscoreOR_underscoreUPDATE_underscoreDDL:
                            createSequenceTable = true;
                    }
                }
                if (LOGGER.isLoggable(Level.INFO)) {
                    logMsg = "Table '" + SqlDialect.COMMON_underscoreSEQ_underscoreTABLE_underscoreNAME + "' {0} available on the database '{1}'.";
            ...
            switch(MetaParams.ORM2DLL_underscorePOLICY.of(ormHandler.getParameters())) {
                ...
                case VALIDATE:
                    ...
                    break;
                case DO_underscoreNOTHING:
                default:
                    return;
            }
            switch(MetaParams.CHECK_underscoreKEYWORDS.of(getParams())) {
                case WARNING:
                case EXCEPTION:
            ...
            switch(MetaParams.COMMENT_underscorePOLICY.of(ormHandler.getParameters())) {
                case FOR_underscoreNEW_underscoreOBJECT:
                    cTables = tables;
                    break;
                case ALWAYS:
                case ON_underscoreANY_underscoreCHANGE:
            ...
            throw new IllegalArgumentException(Session.SQL_underscoreILLEGAL + sql, e);
        }
    }
