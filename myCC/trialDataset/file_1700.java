    public InstanceMonitor(String awsAccessId, String awsSecretKey, String bucketName, boolean first) throws IOException {
        ...
        while (true) {
            try {
                ...
                S3Object obj = s3.getObject(bucket, EW_underscorePROPERTIES);
        ...
        this.dns = new NetticaAPI(props.getProperty(NETTICA_underscoreUSER), props.getProperty(NETTICA_underscorePASS));
