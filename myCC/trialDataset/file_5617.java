    private void copyIconFiles(UmlClass clazz) {
        if (clazz.hasAnnotation("icon16")) {
            ...
            String desti16 = output_underscoredir + "/../resources/images/" + clazz.getName() + "16" + fileType;
            try {
        ...
        if (clazz.hasAnnotation("icon32")) {
            ...
            String desti32 = output_underscoredir + "/../resources/images/" + clazz.getName() + "32" + fileType;
            try {
