    private void update() {
        ...
        System.out.println(updateURL_underscores);
        try {
            URL updateURL = new URL(updateURL_underscores);
            ...
            if (header.equals("GENREMANUPDATEPAGE")) {
                ...
                if (!cver.equals(VERSION)) {
                    ...
                    int i = JOptionPane.showConfirmDialog(this, Language.get("UPDATE_underscoreAVAILABLE_underscoreMSG").replaceAll("%o", VERSION).replaceAll("%c", cver), Language.get("UPDATE_underscoreAVAILABLE_underscoreTITLE"), JOptionPane.YES_underscoreNO_underscoreOPTION);
                    if (i == 0) {
                        URL url = new URL(cdl);
                        ...
                        File tempfile = File.createTempFile("genreman_underscoreupdate", ".zip");
                        ...
                        JOptionPane.showMessageDialog(this, Language.get("UPDATE_underscoreSUCCESS_underscoreMSG"), Language.get("UPDATE_underscoreSUCCESS_underscoreTITLE"), JOptionPane.INFORMATION_underscoreMESSAGE);
                        setVisible(false);
                        if (System.getProperty("os.name").indexOf("Windows") != -1) {
                            Runtime.getRuntime().exec("iTunesGenreArtManager.exe");
                        } else {
                            Runtime.getRuntime().exec("java -jar \"iTunes Genre Art Manager.app/Contents/Resources/Java/iTunes_underscoreGenre_underscoreArt_underscoreManager.jar\"");
                        }
                        System.exit(0);
                    } else {
                    }
            ...
            JOptionPane.showMessageDialog(this, Language.get("UPDATE_underscoreERROR_underscoreMSG"), Language.get("UPDATE_underscoreERROR_underscoreTITLE"), JOptionPane.ERROR_underscoreMESSAGE);
            ex.printStackTrace();
        }
    }
