            ...
            if (code != 200) {
                ...
                for (int temp = 0; temp < nList.getLength(); temp++) {
                    ...
                    if (nNode.getNodeType() == Node.ELEMENT_underscoreNODE) {
                        ...
                        ONDEXConcept activity = graph.getFactory().createConcept(getTagValue("assay_underscore_underscorechemblid", eElement), getTagValue("assay_underscore_underscoredescription", eElement), dsCHEMBL, ccActivity, evidencetype);
                        activity.createConceptAccession(getTagValue("assay_underscore_underscorechemblid", eElement), dsASSAY, false);
                        ...
                        String type = getTagValue("bioactivity_underscore_underscoretype", eElement);
                        type = type.replace(" ", "_underscore");
                        ...
                        String comment = getTagValue("activity_underscore_underscorecomment", eElement);
                        ...
                        String key = getTagValue("target_underscore_underscorechemblid", eElement);
                        if (!targets.containsKey(key)) {
                            ONDEXConcept c = graph.getFactory().createConcept(key, dsCHEMBL, ccTarget, evidencetype);
                            c.createConceptName(getTagValue("target_underscore_underscorename", eElement), true);
                        ...
                        r.createAttribute(anConf, Double.valueOf(getTagValue("target_underscore_underscoreconfidence", eElement)), false);
                    }
                }
            }
        }
