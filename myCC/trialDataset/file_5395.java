    public void open(final String method, final java.net.URL url, boolean asyncFlag, final String userName, final String password) throws java.io.IOException {
        ...
        URLConnection c = proxy == null || proxy == Proxy.NO_underscorePROXY ? url.openConnection() : url.openConnection(proxy);
        synchronized (this) {
            this.connection = c;
        ...
        this.changeState(HttpRequest.STATE_underscoreLOADING, 0, null, null);
    }
