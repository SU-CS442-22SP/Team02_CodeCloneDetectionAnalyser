    public void addUser(String strUserName, String strPass, boolean isEncrypt) throws Exception {
        ...
        try {
            ...
            pstmt = con.prepareStatement(INSERT_underscoreUSER);
            ...
            pstmt = con.prepareStatement(INSERT_underscoreUSERPROPS);
            pstmt.setString(1, "");
            pstmt.setString(2, "");
            pstmt.setString(3, "");
            pstmt.setInt(4, 0);
            ...
            pstmt.executeUpdate();
            pstmt.clearParameters();
            pstmt = con.prepareStatement(INSTER_underscoreUSERGROUP);
            pstmt.setInt(1, 4);
