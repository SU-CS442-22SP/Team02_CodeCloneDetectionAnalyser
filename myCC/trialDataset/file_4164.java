    private static void stampaFoglioRisposte(HttpSession httpSess, Appelli appello, Elaborati el, StringBuffer retVal, boolean primaVolta, String url, boolean anonimo) {
        InputStream is = null;
        String html = null;
        final int MAX_underscoreRIGHE_underscorePER_underscorePAGINA = 25;
        ...
        while (numPagine < totalePagine) {
            ...
            String jsp = url + "jsp/StampaRisposte.jsp?base=" + (numPagine * MAX_underscoreRIGHE_underscorePER_underscorePAGINA) + "&urlbarcode=" + urlBarcode;
            try {
