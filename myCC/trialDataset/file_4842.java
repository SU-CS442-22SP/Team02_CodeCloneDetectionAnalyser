        ...
        if (autoInitialized) {
            ...
            View.getDisplay().syncExec(new Runnable() {
                ...
                public void run() {
                    ...
                    View.getPluginInterface().getPluginconfig().setPluginParameter("Azcvsupdater_underscorelast_underscorebackup", Time.getCurrentTime(View.getPluginInterface().getPluginconfig().getPluginBooleanParameter("MilitaryTime")));
                    Tab4.lastBackupTime = View.getPluginInterface().getPluginconfig().getPluginStringParameter("Azcvsupdater_underscorelast_underscorebackup");
