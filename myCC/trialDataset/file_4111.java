    public int sftp_underscoreconnect(HttpServletRequest request) {
        ...
        if (ftpssl > 0) {
            try {
                ...
                e.printStackTrace();
                return JC_underscoreFTPClientException;
            }
        } else {
            fc = new FTPClient();
        }
        try {
            ...
            if (fc.login(ftpuser, ftppassword)) {
                ...
                if (fc.changeWorkingDirectory(ftpdir)) {
                    return JC_underscoreFTPClientYES;
                } else {
                    ...
                    return JC_underscoreFTPClientNO;
                }
            } else {
