    ...
    private Map<String, Object> _underscorerequest(String method, String path, Map<String, Object> body, JSONRecognizer... recognizers) throws IOException, TwinException {
        String uri = url + path;
        HttpRequest request;
        if (body == null) {
