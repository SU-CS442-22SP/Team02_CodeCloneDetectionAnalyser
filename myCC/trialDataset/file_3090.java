    static String doHttp(String postURL, String text) {
        ...
        try {
            ...
            PrintWriter pout = new PrintWriter(new OutputStreamWriter(urlcon.getOutputStream(), "8859_underscore1"), true);
            pout.print(formData);
            pout.flush();
            int rc = urlcon.getResponseCode();
            if (rc != HttpURLConnection.HTTP_underscoreOK) System.out.println("Error, HTTP response: " + rc);
