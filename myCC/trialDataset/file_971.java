    private void write(File src, File dst, byte id3v1Tag[], byte id3v2HeadTag[], byte id3v2TailTag[]) throws IOException {
        ...
        long id3v1Length = hasId3v1 ? ID3_underscoreV1_underscoreTAG_underscoreLENGTH : 0;
        ...
        try {
            ...
            long total_underscoreto_underscoreread = src.length();
            total_underscoreto_underscoreread -= id3v1Length;
            total_underscoreto_underscoreread -= id3v2HeadLength;
            total_underscoreto_underscoreread -= id3v2TailLength;
            byte buffer[] = new byte[1024];
            long total_underscoreread = 0;
            while (total_underscoreread < total_underscoreto_underscoreread) {
                int remainder = (int) (total_underscoreto_underscoreread - total_underscoreread);
