    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getSession(true).setAttribute(WINDOW_underscoreCENTER_underscorePARAM, windowCenter == null ? null : windowCenter.trim());
            request.getSession(true).setAttribute(WINDOW_underscoreWIDTH_underscorePARAM, windowWidth == null ? null : windowWidth.trim());
