    public boolean login(String strUrl, String loginName, String loginPwd) throws ApplicationException {
        ...
        try {
            ...
            String cookieVal = conn.getHeaderField(HEADER_underscoreSETCOOKIE);
            if (cookieVal != null) {
            ...
            log.error(e, e);
            throw new ApplicationException(FormErrorConstant.DB_underscoreAPP_underscoreBASE_underscoreURL_underscoreERROR);
        } finally {
            try {
                dos.close();
            } catch (Exception e) {
