    private final long test(final boolean applyFilter, final int executionCount) throws NoSuchAlgorithmException, NoSuchPaddingException, FileNotFoundException, IOException, RuleLoadingException {
        ...
        ruleFileLoaderModificationExcludes.setPath(WebCastellumFilter.MODIFICATION_underscoreEXCLUDES_underscoreDEFAULT);
        ...
        ruleFileLoaderResponseModifications.setPath(WebCastellumFilter.RESPONSE_underscoreMODIFICATIONS_underscoreDEFAULT);
