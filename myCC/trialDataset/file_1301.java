    ...
    public IMedium createMedium(String urlString, IMetadata optionalMetadata) throws MM4UCannotCreateMediumElementsException {
        ...
        try {
            ...
            int length = Constants.UNDEFINED_underscoreINTEGER;
            if (fFormat != null) {
            ...
            optionalMetadata.addIfNotNull(IMedium.MEDIUM_underscoreMETADATA_underscoreMIMETYPE, mimeType);
            if (length != Constants.UNDEFINED_underscoreINTEGER) {
