    ...
    public void testExactCopySize() throws IOException {
        final int size = Byte.SIZE + RANDOMIZER.nextInt(TEST_underscoreDATA.length - Long.SIZE);
        ...
        final byte[] subArray = ArrayUtils.subarray(TEST_underscoreDATA, 0, size), outArray = out.toByteArray();
