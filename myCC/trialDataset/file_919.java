    public HTTPResponse makeRequest(BasicHttpRequest request) throws IOException {
        try {
            ...
            context.setAttribute(ExecutionContext.HTTP_underscoreCONNECTION, conn);
            context.setAttribute(ExecutionContext.HTTP_underscoreTARGET_underscoreHOST, host);
            context.setAttribute(ExecutionContext.HTTP_underscoreREQUEST, request);
