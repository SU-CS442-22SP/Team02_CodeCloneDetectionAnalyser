    protected Control createContents(Composite parent) {
        ...
        keyHandler.put(KeyStroke.getPressed('+', SWT.KEYPAD_underscoreADD, 0), new ZoomAction(this, 1, null));
        keyHandler.put(KeyStroke.getPressed('-', SWT.KEYPAD_underscoreSUBTRACT, 0), new ZoomAction(this, -1, null));
        keyHandler.put(KeyStroke.getPressed(SWT.F2, 0), a.getAction(GEFActionConstants.DIRECT_underscoreEDIT));
