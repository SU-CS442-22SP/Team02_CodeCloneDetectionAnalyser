    public void testSimpleQuery() throws Exception {
        JCRNodeSource dummySource = (JCRNodeSource) resolveSource(BASE_underscoreURL + "users/alexander.klimetschek");
        ...
        os.flush();
        os.close();
        JCRNodeSource source = (JCRNodeSource) resolveSource(BASE_underscoreURL + "users/bastian");
        ...
        os.flush();
        os.close();
        QueryResultSource qResult = (QueryResultSource) resolveSource(BASE_underscoreURL + "users?/*[.//user/teamspace='mindquarry']");
