        private void compileJarFile() {
            ...
            try {
                File pluginWorkDirectory = new File(CastadivaModel.PLUGIN_underscoreWORKFOLDER);
                ...
                bout.write("        try {\n");
                bout.write("            JarFile jar = new JarFile(\"" + CastadivaModel.PLUGIN_underscoreJAR_underscoreFOLDER + "/" + jarFileName + ".jar\");\n");
                ...
                bout.close();
                BufferedWriter confFileWriter = new BufferedWriter(new FileWriter(CastadivaModel.PLUGIN_underscoreWORKFOLDER + "/" + configurationFilename[configurationFilename.length - 1]));
