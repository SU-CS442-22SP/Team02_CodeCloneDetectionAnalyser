    ...
    public void testMemberIterator() throws IOException {
        ...
        assertEquals("wrong member0 end", noise1k_underscoregz.length, gzin.getCurrentMemberEnd());
        assertTrue(iter.hasNext());
        ...
        assertEquals("wrong member1 start", noise1k_underscoregz.length, gzin.getCurrentMemberStart());
        assertEquals("wrong member1 end", noise1k_underscoregz.length + noise32k_underscoregz.length, gzin.getCurrentMemberEnd());
        assertTrue(iter.hasNext());
