    public static void entering(String[] args) throws IOException, CodeCheckException {
        ...
        int printlnRefIndex = writer.getReferenceIndex(ClassWriter.CONSTANT_underscoreMethodref, "java/io/PrintStream", "println", "(Ljava/lang/String;)V");
        int printRefIndex = writer.getReferenceIndex(ClassWriter.CONSTANT_underscoreMethodref, "java/io/PrintStream", "print", "(Ljava/lang/String;)V");
