    private void processHTTPRequest(Status status) {
        ...
        try {
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscoreRESPONSE_underscoreFROM_underscoreSMS_underscoreGATEWAY.ordinal());
        } finally {
            if (is != null) try {
                is.close();
        ...
        if (responseRes == 0) {
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreOK.ordinal());
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscoreSYSTEM_underscoreERROR_underscoreIN_underscoreSMS_underscoreGATEWAY.ordinal());
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscoreSENDING_underscoreERROR_underscoreIN_underscoreSMS_underscoreGATEWAY.ordinal());
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscorePARAMETER_underscoreERROR_underscoreIN_underscoreSMS_underscoreGATEWAY.ordinal());
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscoreLIMIT_underscoreREACHED_underscoreIN_underscoreSMS_underscoreGATEWAY.ordinal());
        } else {
            ...
            status.setResult(ErrorCodes.EXTERNALNOTIFICATION_underscoreERROR_underscoreUNDEFINED_underscoreERROR_underscoreIN_underscoreSMS_underscoreGATEWAY.ordinal());
        }
    }
