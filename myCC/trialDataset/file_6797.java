    private String save(UploadedFile imageFile) {
        try {
            ...
            Image thumbnailIm = image.getScaledInstance(310, 210, Image.SCALE_underscoreSMOOTH);
            BufferedImage thumbnailBi = new BufferedImage(thumbnailIm.getWidth(null), thumbnailIm.getHeight(null), BufferedImage.TYPE_underscoreINT_underscoreRGB);
