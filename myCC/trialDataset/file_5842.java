    protected synchronized AbstractBaseObject insert(AbstractBaseObject obj) throws ApplicationException {
        ...
        synchronized (dbConn) {
            try {
                ...
                sqlStat.append("INTO   DMS_underscoreRELATIONAL_underscoreWORD(ID, RECORD_underscoreSTATUS, UPDATE_underscoreCOUNT, CREATOR_underscoreID, CREATE_underscoreDATE, UPDATER_underscoreID, UPDATE_underscoreDATE, WORD, PARENT_underscoreID, TYPE) ");
                ...
                log.error(e, e);
                throw new ApplicationException(ErrorConstant.DB_underscoreINSERT_underscoreERROR, e);
            } finally {
                try {
                    preStat.close();
