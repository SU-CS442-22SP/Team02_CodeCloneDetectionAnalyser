            ...
            if (ae.getActionCommand().equals(LOAD)) {
                ...
                uc.setResourceFilter(new ResourceFilter() {
                    ...
                    public boolean accept(ResourceDescriptor rd) {
                        return rd.getType().equals(ResourceDescriptor.NPSNETV_underscorePROTOTYPE);
                    }
                });
                ...
                if (uc.showDialog(null)) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(invokerInfo.getComponent(), e, "Error Loading Prototype", JOptionPane.ERROR_underscoreMESSAGE);
                    }
                }
                ...
                if (uc.showDialog(null)) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(invokerInfo.getComponent(), e, "Error Saving Prototype", JOptionPane.ERROR_underscoreMESSAGE);
                    }
                }
                ...
                ppd.show();
            } else if (ae.getActionCommand().equals(VIEW_underscoreEDIT)) {
