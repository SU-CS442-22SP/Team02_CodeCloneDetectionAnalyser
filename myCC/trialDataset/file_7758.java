    private boolean enregistreToi() {
        ...
        String laDest = "./img_underscoretypes/" + sonImage;
        if (!new File("./img_underscoretypes").exists()) {
            new File("./img_underscoretypes").mkdirs();
        }
        try {
