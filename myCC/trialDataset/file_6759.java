        ...
        SwingWorker<Double, RaphPhotoGalleryPhoto> downloadFilesWorker = new SwingWorker<Double, RaphPhotoGalleryPhoto>() {
            ...
            protected void process(List<RaphPhotoGalleryPhoto> list) {
                ...
                if (diffTime > 1000) {
                    ...
                    speedLabel.setText(String.format("%.0f", speed / 1024) + " " + getParameter("i18n_underscorespeedUnit") + " :  " + String.format("%.0f", remainingTime) + " s");
                    lastDate = new Date();
            ...
            protected void done() {
                try {
                    speedLabel.setText(String.format("%.0f", get().doubleValue() / 1024) + " " + getParameter("i18n_underscorespeedUnit"));
                    downloadButton.setText(getParameter("i18n_underscorefinished"));
                    downloadState = 2;
                } catch (Exception ignore) {
                }
            }
