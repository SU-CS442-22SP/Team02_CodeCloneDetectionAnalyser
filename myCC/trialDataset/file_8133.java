    private CharBuffer decodeToFile(ReplayInputStream inStream, String backingFilename, String encoding) throws IOException {
        ...
        this.decodedFile = File.createTempFile(backingFile.getName(), WRITE_underscoreENCODING, backingFile.getParentFile());
        FileOutputStream fos;
        fos = new FileOutputStream(this.decodedFile);
        IOUtils.copy(reader, fos, WRITE_underscoreENCODING);
        fos.close();
