        ...
        if (filterSetsAvailable) {
            ...
            try {
                ...
                if (filterChainsAvailable) {
                    ...
                    crh.setBufferSize(FileUtils.BUF_underscoreSIZE);
            ...
            try {
                ...
                char[] buffer = new char[FileUtils.BUF_underscoreSIZE];
                while (true) {
            ...
            try {
                ...
                while (position < count) {
                    position += srcChannel.transferTo(position, FileUtils.BUF_underscoreSIZE, destChannel);
                }
            } finally {
            ...
            try {
                ...
                byte[] buffer = new byte[FileUtils.BUF_underscoreSIZE];
                int count = 0;
                do {
