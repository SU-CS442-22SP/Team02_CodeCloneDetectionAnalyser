    private ZipOutputStream copyOOXMLContent(String signatureZipEntryName, OutputStream signedOOXMLOutputStream) throws IOException, ParserConfigurationException, SAXException, TransformerConfigurationException, TransformerFactoryConfigurationError, TransformerException {
        ...
        while (null != (zipEntry = zipInputStream.getNextEntry())) {
            ...
            if ("[Content_underscoreTypes].xml".equals(zipEntry.getName())) {
            ...
            } else if ("_underscorerels/.rels".equals(zipEntry.getName())) {
                ...
                NodeList nodeList = XPathAPI.selectNodeList(relsDocument, "/tns:Relationships/tns:Relationship[@Target='_underscorexmlsignatures/origin.sigs']", nsElement);
                if (0 == nodeList.getLength()) {
                    ...
                    relationshipElement.setAttribute("Target", "_underscorexmlsignatures/origin.sigs");
                    relsDocument.getDocumentElement().appendChild(relationshipElement);
                }
                writeDocumentNoClosing(relsDocument, zipOutputStream, false);
            } else if ("_underscorexmlsignatures/_underscorerels/origin.sigs.rels".equals(zipEntry.getName())) {
