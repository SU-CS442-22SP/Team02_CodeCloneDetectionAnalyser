    public static synchronized int registerVote(String IDVotazione, byte[] T1, byte[] sbT2, byte[] envelope, Config config) {
        if (IDVotazione == null) {
            ...
            return C_underscoreaddVote_underscoreBOH;
        }
        if (T1 == null) {
        ...
        int ANSWER = C_underscoreaddVote_underscoreBOH;
        try {
            ...
            while (questionIterator.hasNext()) {
                ...
                if (rispostaText.equals(Votazione.C_underscoreTAG_underscoreWHITE_underscoreXML)) {
                    risposta = C_underscoreTAG_underscoreWHITE;
                } else if (rispostaText.equals(Votazione.C_underscoreTAG_underscoreNULL_underscoreXML)) {
                    risposta = C_underscoreTAG_underscoreNULL;
                } else {
                    if (!rispostaText.equals("") && LOGGER.isDebugEnabled()) LOGGER.warn("Risposta text should be empty!: " + rispostaText);
                    risposta = C_underscoreTAG_underscoreBUG;
            ...
            stmt.close();
            conn.commit();
            ANSWER = C_underscoreaddVote_underscoreOK;
            ...
            if (e.getErrorCode() == 1062) {
                ANSWER = C_underscoreaddVote_underscoreDUPLICATE;
                LOGGER.error("error while registering vote (duplication)");
            } else {
                ANSWER = C_underscoreaddVote_underscoreBOH;
