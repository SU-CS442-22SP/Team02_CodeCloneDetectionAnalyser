    public static boolean insert(final CelulaFinanceira objCelulaFinanceira) {
        ...
        try {
            ...
            final String sql = "insert into celula_underscorefinanceira " + "(descricao, id_underscoreorgao, id_underscoregestao, " + "id_underscorenatureza_underscoredespesa, id_underscoreprograma_underscoretrabalho, " + "id_underscoreunidade_underscoreorcamentaria, id_underscorefonte_underscorerecursos, " + "valor_underscoreprovisionado, gasto_underscoreprevisto, gasto_underscorereal, " + "saldo_underscoreprevisto, saldo_underscorereal)" + " values (?, ?, ?, ?, ?, ?, ?, TRUNCATE(?,2), TRUNCATE(?,2), TRUNCATE(?,2), TRUNCATE(?,2), TRUNCATE(?,2))";
