    private void listAndInstantiateServiceProviders() {
        final Enumeration<URL> resources = ClassLoaderHelper.getResources(SERVICES_underscoreFILE, ServiceManager.class);
        String name;
        try {
            ...
            throw new SearchException("Unable to read " + SERVICES_underscoreFILE, e);
        }
    }
