    public void run() throws Exception {
        ...
        try {
            PreparedStatement psCount = connection.prepareStatement(COUNT_underscoreACTIVE_underscoreORDERS);
            ...
            psNextId = connection.prepareStatement(NEXT_underscoreORDER);
            ...
            ps = connection.prepareStatement(INSERT_underscoreORDER);
            ps.setInt(1, orderId);
