    public static void checkAndUpdateGameData() {
        new ErrThread() {
            ...
            public void handledRun() throws Throwable {
                try {
                    URL url = new URL(ONLINE_underscoreCLIENT_underscoreDATA + "gamedata.xml");
                    ...
                    JOptionPane.showMessageDialog(FrameOrganizer.getClientFrame(), "The gamedata is outdated, but Coopnet couldn't update it!", "Gamedata outdated", JOptionPane.INFORMATION_underscoreMESSAGE);
                    throw e;
                } finally {
                    GameDatabase.loadVersion();
