    ...
    protected String doInBackground(MarketData... market) {
        ...
        try {
            ...
            while (response.getStatusLine().getStatusCode() == HttpStatus.SC_underscoreMOVED_underscoreTEMPORARILY || response.getStatusLine().getStatusCode() == HttpStatus.SC_underscoreMOVED_underscorePERMANENTLY) {
