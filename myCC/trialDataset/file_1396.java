        public void actionPerformed(ActionEvent e) {
            ...
            if (saveForWebChooser.showSaveDialog(Main.this) == JFileChooser.APPROVE_underscoreOPTION) {
                ...
                if (appletJarFile == null) {
                    ...
                    if (appletChooser.showOpenDialog(Main.this) == JFileChooser.APPROVE_underscoreOPTION) {
                ...
                if (deviceInput != null && deviceInput.getDescriptorLocation().equals(DeviceImpl.DEFAULT_underscoreLOCATION)) {
                    deviceInput = null;
                }
