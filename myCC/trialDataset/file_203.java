    private Document getResponse(HttpGet request) throws ClientProtocolException, IOException, ParserConfigurationException, IllegalStateException, SAXException, NoRoutesException {
        ...
        if (response.getStatusLine().getStatusCode() != HTTP_underscoreSTATUS_underscoreOK) throw new ClientProtocolException("The HTTP request is wrong.");
        ...
        switch(modeOption) {
            ...
            case WALKING:
                ...
                break;
            case PUBLIC_underscoreTRANSIT:
                String responseWithErrors = "";
                try {
                    responseWithErrors = allResponse.substring(allResponse.indexOf("<div id=\"tsp\">"), allResponse.indexOf("<div class=\"ddwpt\" id=\"panel_underscoreddw1\" oi=\"wi1\">"));
                } catch (Exception e) {
                    throw new NoRoutesException();
                }
