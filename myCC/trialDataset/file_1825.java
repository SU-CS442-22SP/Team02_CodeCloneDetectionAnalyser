    private static void loadQueryProcessorFactories() {
        ...
        try {
            resources = QueryUtils.class.getClassLoader().getResources(RESOURCE_underscoreSTRING);
        } catch (IOException e) {
        ...
        if (!qpFactoryMap.containsKey(DEFAULT_underscoreLANGUAGE)) {
            qpFactoryMap.put(DEFAULT_underscoreLANGUAGE, new TologQueryProcessorFactory());
        }
    }
