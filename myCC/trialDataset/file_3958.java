    public static String post(String strUrl, String data) throws Exception {
        ...
        if (tools.valid(Config.JSON_underscoreRPC_underscoreWEBSERVER_underscoreUSERNAME) && tools.valid(Config.JSON_underscoreRPC_underscoreWEBSERVER_underscorePASSWORD)) {
            String authString = Config.JSON_underscoreRPC_underscoreWEBSERVER_underscoreUSERNAME + ":" + Config.JSON_underscoreRPC_underscoreWEBSERVER_underscorePASSWORD;
            String authStringEnc = new sun.misc.BASE64Encoder().encode(authString.getBytes());
            conn.setRequestProperty("Authorization", "Basic " + authStringEnc);
        }
        conn.setReadTimeout((int) (Config.JSON_underscoreRPC_underscoreTIMEOUT_underscoreSECONDS * 1000));
