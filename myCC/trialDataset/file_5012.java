    public void doQuery(String keyword, final int page) {
        ...
        try {
            ...
            URL connectURL = new URL("http://www.ensembl.org/Homo_underscoresapiens/textview?idx=External&q=" + keyword + "&page=" + page);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.indexOf("Homo_underscoresapiens/geneview?gene") != -1) {
                    if (line.indexOf("www.ensembl.org") != -1) {
                        line = line.substring(line.indexOf("www.ensembl.org"));
                        line = line.substring(line.indexOf("</A>") + 4);
                    }
                    int linkStart = line.indexOf("Homo_underscoresapiens/geneview?gene");
