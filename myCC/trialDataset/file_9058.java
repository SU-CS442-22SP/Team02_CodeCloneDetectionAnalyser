    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        try {
            ...
            if (monitor.isCanceled()) throw new InterruptedException();
            String args = "username=" + URLEncoder.encode(username) + "&" + "passwd=" + URLEncoder.encode(passwd) + "&" + "readDisclaimer=agree&" + "cvt_underscoreto_underscorens=true&" + "trace_underscoredevice=" + URLEncoder.encode(device) + "&" + "trace_underscoredescr=" + URLEncoder.encode(description) + "&" + "mailBack=on&" + "simple_underscoreoutput=true&" + "trace_underscoredate=" + URLEncoder.encode(dateStr) + "&" + "trace_underscoredata=";
            if (header != null) {
