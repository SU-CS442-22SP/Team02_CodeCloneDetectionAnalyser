    public ObservationResult[] call(String url, String servicename, String srsname, String version, String offering, String observed_underscoreproperty, String responseFormat) {
        ...
        try {
            ...
            getob.setObservedPropertyArray(new String[] { observed_underscoreproperty });
        ...
        try {
            URL observation_underscoreurl = new URL("file:///E:/Temp/Observation.xml");
            URLConnection urlc = observation_underscoreurl.openConnection();
            urlc.connect();
            InputStream observation_underscoreurl_underscoreis = urlc.getInputStream();
            ObservationCollectionDocument obsCollDoc = ObservationCollectionDocument.Factory.parse(observation_underscoreurl_underscoreis);
            ...
            for (ObservationPropertyType observationPropertyType : aObsPropType) {
                ...
                if (observation != null) {
                    ...
                    if (observation instanceof GeometryObservationTypeImpl) {
                        ...
                        StringTokenizer date_underscorest;
                        String day = new StringTokenizer(time, "T").nextToken();
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                        Date d = sdf.parse(day);
                        String timetemp = null;
                        date_underscorest = new StringTokenizer(time, "T");
                        while (date_underscorest.hasMoreElements()) timetemp = date_underscorest.nextToken();
            ...
            observation_underscoreurl_underscoreis.close();
        } catch (IOException e) {
            e.printStackTrace();
