    private void saveMimeParts(MimeMessage oMsg, String sMsgCharSeq, String sBoundary, String sMsgGuid, String sMsgId, int iPgMessage, int iOffset) throws MessagingException, OutOfMemoryError {
        ...
        try {
            ...
            if (iParts > 0) {
                if (sMsgCharSeq != null && sBoundary != null && ((iOpenMode & MODE_underscoreMBOX) != 0)) {
                ...
                String sSQL = "INSERT INTO " + DB.k_underscoremime_underscoreparts + "(gu_underscoremimemsg,id_underscoremessage,pg_underscoremessage,nu_underscoreoffset,id_underscorepart,id_underscorecontent,id_underscoretype,id_underscoredisposition,len_underscorepart,de_underscorepart,tx_underscoremd5,file_underscorename,by_underscorecontent) VALUES ('" + sMsgGuid + "',?,?,?,?,?,?,?,?,?,NULL,?,?)";
                ...
                for (int p = 0; p < iParts; p++) {
                    ...
                    if (!bForwardedAttachment) {
                        ...
                        if ((iPartStart > 0) && ((iOpenMode & MODE_underscoreMBOX) != 0)) oStmt.setBigDecimal(3, new BigDecimal(iPartStart)); else oStmt.setNull(3, oConn.getDataBaseProduct() == JDCConnection.DBMS_underscoreORACLE ? Types.NUMERIC : Types.DECIMAL);
                        ...
                        if ((iOpenMode & MODE_underscoreMBOX) != 0) oStmt.setInt(8, iNextPart - iPartStart); else oStmt.setInt(8, oPart.getSize() > 0 ? oPart.getSize() : byOutPart.size());
                        ...
                        if ((iOpenMode & MODE_underscoreBLOB) != 0) oStmt.setBinaryStream(11, new ByteArrayInputStream(byOutPart.toByteArray()), byOutPart.size()); else oStmt.setNull(11, Types.LONGVARBINARY);
                    ...
                    byOutPart = null;
                    oContentTxt = null;
                    if ((iOpenMode & MODE_underscoreMBOX) != 0) iPrevPart = iNextPart;
                }
