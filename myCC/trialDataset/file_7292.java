    protected void updateJava2ScriptProject(String prjFolder, String binRelative) {
        try {
            ...
            if (classpath != null) {
                ...
                if (classpath.indexOf("ECLIPSE_underscoreSWT") == -1 && classpath.indexOf("SWT_underscoreLIBRARY") == -1 && classpath.indexOf("eclipse.swt") == -1) {
                    int idx = classpath.lastIndexOf("<");
                    classpath = classpath.substring(0, idx) + "\t<classpathentry kind=\"var\" path=\"ECLIPSE_underscoreSWT\"/>\r\n" + classpath.substring(idx);
                    needUpdate = true;
                }
                if (classpath.indexOf("AJAX_underscoreSWT") == -1 && classpath.indexOf("ajaxswt.jar") == -1) {
                    int idx = classpath.lastIndexOf("<");
                    classpath = classpath.substring(0, idx) + "\t<classpathentry sourcepath=\"AJAX_underscoreSWT_underscoreSRC\" kind=\"var\" path=\"AJAX_underscoreSWT\"/>\r\n" + classpath.substring(idx);
                    needUpdate = true;
                }
                if (classpath.indexOf("AJAX_underscoreRPC") == -1 && classpath.indexOf("ajaxrpc.jar") == -1) {
                    int idx = classpath.lastIndexOf("<");
                    classpath = classpath.substring(0, idx) + "\t<classpathentry sourcepath=\"AJAX_underscoreRPC_underscoreSRC\" kind=\"var\" path=\"AJAX_underscoreRPC\"/>\r\n" + classpath.substring(idx);
                    needUpdate = true;
                }
                if (classpath.indexOf("AJAX_underscorePIPE") == -1 && classpath.indexOf("ajaxpipe.jar") == -1) {
                    int idx = classpath.lastIndexOf("<");
                    classpath = classpath.substring(0, idx) + "\t<classpathentry sourcepath=\"AJAX_underscorePIPE_underscoreSRC\" kind=\"var\" path=\"AJAX_underscorePIPE\"/>\r\n" + classpath.substring(idx);
                    needUpdate = true;
                }
                if (needUpdate) {
                    try {
            ...
            webxml.append("    \"http://java.sun.com/dtd/web-app_underscore2_underscore3.dtd\">\r\n");
