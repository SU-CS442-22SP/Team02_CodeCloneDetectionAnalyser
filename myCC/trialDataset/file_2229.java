    public void run() {
        ...
        String requestUrl = "http://www.youtube.com/get_underscorevideo_underscoreinfo?&video_underscoreid=" + videoId;
        try {
            ...
            int to = line.indexOf("&thumbnail_underscoreurl=");
            String id = line.substring(from, to);
            String tmp = "http://www.youtube.com/get_underscorevideo?video_underscoreid=" + videoId + "&t=" + id;
            url = new URL(tmp);
