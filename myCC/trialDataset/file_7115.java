            public void run() {
                try {
                    URL url = new URL(URL_underscoreSTR + "?req=list");
                        ...
                        if (line.length() > 2) {
                            try {
                                ...
                                if (subparts.length != 3) {
                                    Util.debug(28, "Not enough subentry in online toplist file: ." + KeyboardHero.APP_underscoreNAME + ".tls!");
                                    continue;
                                }
                                ...
                                if (ssubparts.length != 2) {
                                    Util.debug(26, "Not enough subsubentry in online toplist file: ." + KeyboardHero.APP_underscoreNAME + ".tls!");
                                    continue;
                                }
