    public void testReleaseConnectionOnAbort() throws Exception {
        ...
        HttpRequest request = new BasicHttpRequest("GET", uri, HttpVersion.HTTP_underscore1_underscore1);
        ...
        assertEquals("wrong status in first response", HttpStatus.SC_underscoreOK, response.getStatusLine().getStatusCode());
        try {
