    public void transferOutputFiles() throws IOException {
        ...
        while (ic.hasNext()) {
            ...
            String gridPath = attributes.get("GRIDGAIN_underscoreHOME");
            ...
            ftp.setFileType(FTPClient.COMPRESSED_underscoreTRANSFER_underscoreMODE);
            ftp.setRemoteVerificationEnabled(false);
            ftp.setFileType(FTPClient.ASCII_underscoreFILE_underscoreTYPE);
