    private CathUtils() throws Exception {
        ...
        try {
            final String CATH_underscoreREGEXP = OntologyFactory.getOntology(Ontology.CATH).getRegularExpression();
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (RegularExpressionUtils.getMatches(tokens[0], CATH_underscoreREGEXP).size() > 0) {
