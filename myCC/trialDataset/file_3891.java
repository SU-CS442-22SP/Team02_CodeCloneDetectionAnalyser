    private void load() throws SQLException {
        ...
        try {
            ...
            stmt.executeUpdate("insert into Instructions (Type, ExecuteString, FrameSlot, Operator, LinkName, ObjectId, AttributeName) " + "values (3, 'set_underscorereturn_underscorestatus true', null, 0, null, null, null)");
            stmt.executeUpdate("insert into Instructions (Type, ExecuteString, FrameSlot, Operator, LinkName, ObjectId, AttributeName) " + "values (3, 'set_underscorereturn_underscorestatus false', null, 0, null, null, null)");
