    ...
    public int updateStatus(UserInfo userInfo, String status) throws Exception {
        ...
        try {
            URL url = new URL(SnsConstant.SOHU_underscoreUPDATE_underscoreSTATUS_underscoreURL);
            ...
            return SnsConstant.SOHU_underscoreUPDATE_underscoreSTATUS_underscoreSUCC_underscoreWHAT;
        } catch (Exception e) {
            SnsConstant.SOHU_underscoreOPERATOR_underscoreFAIL_underscoreREASON = processException(e.getMessage());
            return SnsConstant.SOHU_underscoreUPDATE_underscoreSTATUS_underscoreFAIL_underscoreWHAT;
        }
    }
