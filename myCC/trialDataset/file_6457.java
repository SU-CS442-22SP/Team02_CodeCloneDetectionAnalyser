    public int down(String downLoadUrl, String saveUrl) {
        ...
        try {
            ...
            if (httpConn.getHeaderField("Content-Length") == null) {
                ...
                httpConn.disconnect();
                httpConn = (HttpURLConnection) url.openConnection();
                fileSize = loadFileSize(saveUrl + BACK_underscoreSUFFIX);
                ...
                raFile = new RandomAccessFile(saveUrl + BACK_underscoreSUFFIX, "rw");
        ...
        if (loadFileSize(saveUrl + BACK_underscoreSUFFIX) == totalSize) {
            fileRename(saveUrl + BACK_underscoreSUFFIX, saveUrl);
        }
        return status;
    }
