        ...
        try {
            ...
            if (o instanceof String) {
                ...
                if (login != null) {
                    ...
                    desCipher.init(Cipher.ENCRYPT_underscoreMODE, secretKey);
                    ...
                    if (o instanceof String) {
                        ...
                        if (response.equals("OK")) {
                            SealedObject ok_underscoresealed = new SealedObject("OK", outCipher);
                            objectOut.writeObject(ok_underscoresealed);
                            return login;
                        } else {
