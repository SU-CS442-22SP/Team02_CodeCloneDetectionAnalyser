        ...
        try {
            if (location.indexOf(".jar!") == -1) inputStream = new FileInputStream(location.substring(0, location.indexOf("Translator.class")) + dictionaryName); else {
                ...
                if (location.indexOf("rachota.sourceforge.net") != -1) {
                    ...
                    url = new URL("jar:http://rachota.sourceforge.net/rachota_underscore22.jar!/");
                ...
                if (entry == null) {
                    entry = jarFile.getEntry("org/cesilko/rachota/core/Dictionary_underscoreen_underscoreUS.properties");
                    Settings.getDefault().setSetting("dictionary", "Dictionary_underscoreen_underscoreUS.properties");
                }
