        ...
        try {
            ...
            try {
                ...
                if ((fromFolder != null) && (fromFolder.length() > folder.length())) {
                    ...
                    folders.append("<B><A HREF=\'/tools/?mode=" + fromMode + "&hl=templates_underscoreview_underscoretemplates_underscoreimages&fromFolder=" + tempParentFolderName + "\'>" + tempParentFolderName + "</A></B><BR>\n");
                ...
                for (int ii = 0; ii < files.length; ii++) {
                    ...
                    if ((thisFile.isDirectory()) && (!name.startsWith(".")) && (!name.endsWith("."))) {
                        ...
                        folders.append("<LI><A HREF=\'/tools/?mode=" + fromMode + "&hl=templates_underscoreview_underscoretemplates_underscoreimages&fromFolder=" + folder + "/" + name + "\'>" + tempFolderName + "/" + name + "</A><BR>");
                    }
                }
                ftp.logout();
                ftp.disconnect();
