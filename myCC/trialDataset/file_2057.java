    public static void copy(String fromFileName, String toFileName) throws IOException {
        ...
        if (toFile.exists()) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Overwrite File ?", "Overwrite File", JOptionPane.YES_underscoreNO_underscoreOPTION) == JOptionPane.NO_underscoreOPTION) return;
        } else {
