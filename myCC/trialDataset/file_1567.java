    public byte[] evaluateResponse(byte[] responseBytes) throws SaslException {
        if (firstEvaluation) {
            ...
            if (!directives.containsKey("qop")) {
                directives.put("qop", QOP_underscoreAUTH);
            }
            ...
            nonceListInMap = null;
            if (directives.get("qop").equals(QOP_underscoreAUTH_underscoreINT)) integrity = true; else if (directives.get("qop").equals(QOP_underscoreAUTH_underscoreCONF)) privacy = true;
            if (privacy) {
            ...
            if (!directives.get("qop").equals(QOP_underscoreAUTH)) {
                md.update(":".getBytes());
