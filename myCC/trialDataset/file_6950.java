    private void loadMap() {
        ...
        try {
            ...
            map = null;
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, myResources.getString("Cannot_underscorefind_underscore\"") + wordList + myResources.getString("\"_underscorein\n") + supportDir.toString(), VietPad.APP_underscoreNAME, JOptionPane.ERROR_underscoreMESSAGE);
        }
    }
