    public static void test() {
        ...
        try {
            ...
            jfr.add(jep);
            String urlstr = "http://apps.sourceforge.net/piwik/lyricscatcher/piwik.php?url=http%3a%2f%2flyricscatcher.sourceforge.net%2fpiwik.php&action_underscorename=&idsite=1&res=1440x900&h=";
            Calendar cal = Calendar.getInstance();
            urlstr += cal.get(Calendar.HOUR_underscoreOF_underscoreDAY);
            urlstr += "&m=";
