            ...
            try {
                ...
                switch(key) {
                    ...
                    case '2':
                        ...
                        System.out.println("(3) Miutan elvegeztuk az osszehasonlitasokat a program mindegyiket kimenti a compare_underscorexxx.txt fajlba, azonban ha kilepunk a programbol, " + "majd utana ismet elinditjuk es elkezdunk osszehasonlitasokat vegezni, akkor felulirhatja " + "az elozo futtatasbol kapott fajlainkat, erre kulonosen figyelni kell!");
                        System.out.println("(4) A kimeneti compare_underscorexxx.txt fajlon kivul minden egyes osszehasonlitott fajlrol csinal egy <fajl neve>.<fajl kiterjesztese>.numbered " + "nevu fajlt, ami annyiban ter el az eredeti fajloktol, hogy soronkent sorszamozva vannak!");
                    ...
                    case '1':
                        {
                            ...
                            try {
                                ...
                                f2 = inFileName;
                                String aLine_underscorek;
                                while ((aLine_underscorek = bin.readLine()) != null) bout.write("Line " + df.format(lnNo++) + ": " + aLine_underscorek + "\n");
                                bin.close();
                                bout.close();
                            } catch (IOException e) {
                                System.out.println("Hibas fajlnev");
                            ...
                            try {
                                int lnNo_underscorec = 1;
                                int mstk = 0;
                                BufferedReader bin_underscoree = new BufferedReader(new FileReader(fe));
                                BufferedReader bin_underscorek = new BufferedReader(new FileReader(fk));
                                BufferedWriter bout = new BufferedWriter(new FileWriter("compare_underscore" + i++ + ".txt"));
                                ...
                                String aLine_underscorec1 = null, aLine_underscorec2 = null;
                                File fa = new File(fe);
                                File fb = new File(fk);
                                if (fa.length() != fb.length()) {
                                    ...
                                    while (((aLine_underscorec1 = bin_underscoree.readLine()) != null) && ((aLine_underscorec2 = bin_underscorek.readLine()) != null)) if (aLine_underscorec1.equals(aLine_underscorec2)) {
                                    } else {
                                        mstk++;
                                        bout.write("#" + df.format(lnNo_underscorec) + ": HIBA  --> \t" + f1 + " : " + aLine_underscorec1 + " \n\t\t\t\t\t" + f2 + " : " + aLine_underscorec2 + "\n");
                                        System.out.println("#" + df.format(lnNo_underscorec) + ": HIBA  -->\t " + f1 + " : " + aLine_underscorec1 + " \n\t\t\t" + f2 + " : " + aLine_underscorec2 + "\n");
                                        lnNo_underscorec++;
                                    }
                                    if (mstk != 0) {
                                        bout.write("\nOsszehasonlitas eredmenye: HIBA, nincs egyezes!");
                                ...
                                bin_underscoree.close();
                                bin_underscorek.close();
                                fa.delete();
                                fb.delete();
                                bout.close();
                            } catch (IOException e) {
