    @Override
    protected String doWget(final URL url, final boolean post, final boolean ignore, final String... post_underscoredata) throws Exception {
        String msg = "";
        InputStream in = null;
        ...
        try {
            ...
            if (post) {
                boolean key = false;
                for (final String s : post_underscoredata) {
