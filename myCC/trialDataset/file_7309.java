    public void generateListOfSubscriptions() {
        try {
            java.net.URL url = new java.net.URL(NewGenLibDesktopRoot.getInstance().getURLRoot() + "/NEWGEN_underscoreJR/ListOfSubscriptions.xml");
            System.out.println(NewGenLibDesktopRoot.getRoot() + "/NEWGEN_underscoreJR/ListOfSubscriptions.xml");
