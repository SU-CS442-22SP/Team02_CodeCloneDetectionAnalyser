    private boolean authenticateWithServer(String user, String password) {
        ...
        try {
            ...
            if (o instanceof String) {
                ...
                desCipher.init(Cipher.DECRYPT_underscoreMODE, secretKey);
                ...
                if (o instanceof byte[]) {
                    ...
                    inCipher.init(Cipher.DECRYPT_underscoreMODE, secretKey);
                    outCipher.init(Cipher.ENCRYPT_underscoreMODE, secretKey);
                    SealedObject sealed_underscoreok = new SealedObject("OK", outCipher);
                    objectOut.writeObject(sealed_underscoreok);
                    SealedObject sealed_underscoreresponse = (SealedObject) objectIn.readObject();
                    o = sealed_underscoreresponse.getObject(inCipher);
                    if (o instanceof String) {
                        if (o.equals("OK")) {
                            return true;
                        } else {
