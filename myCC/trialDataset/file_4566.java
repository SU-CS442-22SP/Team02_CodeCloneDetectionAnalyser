                ...
                try {
                    ...
                    if (lastVersion.equals(getVersion())) LOGGER.debug("Not necessary to update"); else {
                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                if (JOptionPane.showConfirmDialog(null, "New version of G15Lastfm is available to download!", "New Update for G15Lastfm", JOptionPane.YES_underscoreNO_underscoreOPTION) == JOptionPane.YES_underscoreOPTION) {
