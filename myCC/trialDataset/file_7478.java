            ...
            List<JESRealmUser> list = (List<JESRealmUser>) new ProcessEnvelope().executeObject(new ExecuteProcessAbstractImpl(connection, false, false, true, true) {
                ...
                public Object executeProcessReturnObject() throws SQLException {
                    ...
                    while (iter.hasNext()) {
                        ...
                        while (rsImpl.next()) {
                            list.add(new JESRealmUser(user.username, user.userId, rsImpl.getInt("realm_underscoreid"), rsImpl.getInt("domain_underscoreid"), user.password, rsImpl.getString("realm_underscorename_underscorelower_underscorecase")));
                        }
                    }
                    return list;
                }
