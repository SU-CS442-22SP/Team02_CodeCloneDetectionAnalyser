    public void run() {
        try {
            ...
            for (; ; ) {
                ...
                outHeader.setHeaderType(FileTransferHeader.HEADERTYPE_underscoreACK);
                ...
                doneHeader.setHeaderType(FileTransferHeader.HEADERTYPE_underscoreRECEIVED);
                doneHeader.setFlags(doneHeader.getFlags() | FileTransferHeader.FLAG_underscoreDONE);
