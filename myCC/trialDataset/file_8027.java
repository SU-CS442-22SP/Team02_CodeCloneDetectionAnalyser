    public void run() {
        ...
        Pattern pattern = Pattern.compile("popWin\\('/cgi-bin/(.+?)'", Pattern.CASE_underscoreINSENSITIVE | Pattern.DOTALL);
        ...
        if ((!stopped) && (matcher.find())) {
            ...
            Pattern pattern2 = Pattern.compile("<A HREF=\"http://(.+?)\">Click here to listen with your default audio player", Pattern.CASE_underscoreINSENSITIVE | Pattern.DOTALL);
