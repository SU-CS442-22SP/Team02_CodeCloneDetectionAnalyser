    public String storeImage(InputStream inStream, String fileName, boolean resize) throws Exception {
        ...
        _underscorelogger.info("uploadedFile.getAbsolutePath() = {}", uploadedFile.getAbsolutePath());
        ...
        outStream.close();
        if (resize) {
            writeResizedImage(outPathAndName, extension, "imgSize_underscorexs");
            writeResizedImage(outPathAndName, extension, "imgSize_underscores");
            writeResizedImage(outPathAndName, extension, "imgSize_underscorem");
            writeResizedImage(outPathAndName, extension, "imgSize_underscorel");
            writeResizedImage(outPathAndName, extension, "imgSize_underscorexl");
        }
