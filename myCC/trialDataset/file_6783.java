    public void PutFile(ClientConnector cc, Map<String, String> attributes) throws Exception {
        String destinationNode = attributes.get("dest_underscorename");
        String destinationUser = attributes.get("dest_underscoreuser");
        String destinationPassword = attributes.get("dest_underscorepassword");
        String destinationFile = attributes.get("dest_underscorefile");
        String messageID = attributes.get("messageID");
        String destinationFileType = attributes.get("dest_underscorefile_underscoretype");
        Integer destinationPort = 21;
        String destinationPortString = attributes.get("dest_underscoreport");
