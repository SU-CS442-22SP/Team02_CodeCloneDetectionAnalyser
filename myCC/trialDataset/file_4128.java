    public void insertQuotation(final String sText, final Source aSource) throws ConfigHandlerError, com.sun.star.uno.Exception {
        ...
        if (aSource.getSourceType() == SourceType.QUOTE || aSource.getSourceType() == SourceType.WEBQUOTE || aSource.getSourceType() == SourceType.WEBQUOTE) {
            ...
            if (this.docController.getTemplateController().isIndentation()) {
                xText.insertControlCharacter(xTextViewCursor, ControlCharacter.PARAGRAPH_underscoreBREAK, false);
            ...
            this.sourceUtils.setNameToObject(aBookmark, this.docController.getLanguageController()._underscore_underscore("Quote: ") + aSource.getShortinfo());
            ...
            if (this.docController.getTemplateController().isIndentation()) {
                xText.insertControlCharacter(xTextViewCursor, ControlCharacter.PARAGRAPH_underscoreBREAK, false);
                xQuoteProps.setPropertyValue("ParaStyleName", new String(this.docController.getLanguageController()._underscore_underscore("Default")));
            }
            xQuoteProps.setPropertyValue("CharStyleName", new String(this.docController.getLanguageController()._underscore_underscore("Default")));
        } else if (aSource.getSourceType() == SourceType.IMAGE || aSource.getSourceType() == SourceType.TABLE) {
            xText.insertControlCharacter(xTextRange, ControlCharacter.PARAGRAPH_underscoreBREAK, false);
            ...
            if (aSource.getSourceType() == SourceType.IMAGE) {
                try {
                    this.sourceUtils.setNameToObject(xFrame, this.docController.getLanguageController()._underscore_underscore("Caption illustration: ") + aSource.getShortinfo());
                    ...
                    this.sourceUtils.setNameToObject(xImage, this.docController.getLanguageController()._underscore_underscore("Illustration: ") + aSource.getShortinfo());
                    ...
                    xBaseFrameProps.setPropertyValue("AnchorType", com.sun.star.text.TextContentAnchorType.AT_underscorePARAGRAPH);
                ...
                this.sourceUtils.insertCaption(xFrame, aSource, this.docController.getLanguageController()._underscore_underscore("Illustration"), xMultiServiceFactory);
            } else if (aSource.getSourceType() == SourceType.TABLE) {
                this.sourceUtils.setNameToObject(xFrame, this.docController.getLanguageController()._underscore_underscore("Caption table: ") + aSource.getShortinfo());
                xBaseFrameProps = this.sourceUtils.createTextEmbeddedObjectCalc(xMultiServiceFactory);
                this.sourceUtils.setNameToObject(xBaseFrameProps, this.docController.getLanguageController()._underscore_underscore("Table: ") + aSource.getShortinfo());
                ...
                this.sourceUtils.insertCaption(xFrame, aSource, this.docController.getLanguageController()._underscore_underscore("Table"), xMultiServiceFactory);
            }
