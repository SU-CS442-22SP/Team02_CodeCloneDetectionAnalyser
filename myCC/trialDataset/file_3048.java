    public static void main(String[] args) {
        ...
        try {
            if (args.length != 5) {
                throw new InvalidParameterException("\n\nInvalid nunmber of parameters.\n\nCall must be \"java  -jar  Updater.jar  PATH_underscoreTO_underscoreMANAGER.JAR  CURRENT_underscoreMANAGER_underscoreVERSION  VERIONS.TXT_underscoreCONTROL_underscoreFILE  ROOT_underscoreWEBSERVER_underscoreFOLDER  LOCAL_underscoreTEMPORARY_underscoreFOLDER\"");
            }
            ...
            JOptionPane.showMessageDialog(null, "Failed to update manager\n\n" + e.toString(), "Update failed", JOptionPane.ERROR_underscoreMESSAGE);
            long t0, t1;
