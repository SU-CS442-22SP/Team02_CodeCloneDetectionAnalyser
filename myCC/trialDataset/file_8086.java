    public synchronized int insertMessage(FrostMessageObject mo) {
        ...
        try {
            ...
            return INSERT_underscoreOK;
        } catch (Throwable t) {
            boolean isDuplicate;
            if (t.getMessage().indexOf("constraint violation") > 0 && t.getMessage().indexOf("MSG_underscoreID_underscoreUNIQUE_underscoreONLY") > 0) {
                isDuplicate = true;
            ...
            } else if (t.getMessage().indexOf("constraint violation") > 0 && t.getMessage().indexOf("MSG_underscoreUNIQUE_underscoreONLY") > 0) {
                isDuplicate = true;
            ...
            if (isDuplicate) {
                return INSERT_underscoreDUPLICATE;
            } else {
                return INSERT_underscoreERROR;
            }
        } finally {
