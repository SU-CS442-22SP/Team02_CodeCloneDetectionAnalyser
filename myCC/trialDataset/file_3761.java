    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String set = "", setValue = "";
            String oai_underscorepmhRequest = request.getParameter("verb");
            String oai_underscorepmhQuery = request.getQueryString();
            String urlStr = "";
            urlStr = "http://" + request.getServerName() + ":" + request.getServerPort() + "/newgenlibctxt/HarvestServlet";
            String attribute = oai_underscorepmhQuery;
            ...
            if (vector.size() > 0) {
                for (int k = 0; k < vector.size(); k = k + 3) {
                    ...
                    if (status.equals("A")) {
                        String oai_underscorepmhRequest1 = request.getParameter("verb");
                        String oai_underscorepmhQuery1 = request.getQueryString();
                        ...
                        for (int b = 0; b < file1.length; b++) {
                            ...
                            c3.set(java.util.Calendar.AM_underscorePM, java.util.Calendar.AM);
