    protected void doProxyInternally(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        httpClient.getParams().setParameter(ClientPNames.HANDLE_underscoreREDIRECTS, false);
        httpClient.getParams().setParameter(ClientPNames.COOKIE_underscorePOLICY, CookiePolicy.BROWSER_underscoreCOMPATIBILITY);
