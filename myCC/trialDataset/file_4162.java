    public String output(final ComponentParameter compParameter) {
        ...
        try {
            final URL url = new URL("http://xml.weather.yahoo.com/forecastrss?p=" + getPagelet().getOptionProperty("_underscoreweather_underscorecode") + "&u=c");
        ...
        new AbstractXmlDocument(inputStream) {
            ...
            protected void init() throws Exception {
                ...
                String text, image;
                Date date = new SimpleDateFormat(YahooWeatherUtils.RFC822_underscoreMASKS[1], Locale.US).parse(ele.attributeValue("date"));
                ...
                sb.append("<div style=\"line-height: normal;\"><a target=\"_underscoreblank\" href=\"").append(link).append("\"><img src=\"");
