            ...
            while (i < SCHEMA_underscoreVERSION) {
                ...
                switch(i) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        qry = "CREATE UNIQUE INDEX IF NOT EXISTS recordings_underscorehistory ON recordings(id,type)";
                        stmt.executeUpdate(qry);
                        qry = "CREATE INDEX IF NOT EXISTS files_underscorehistory ON files(id,type)";
                        stmt.executeUpdate(qry);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        qry = "CREATE UNIQUE INDEX IF NOT EXISTS log_underscoreid ON log(id)";
                        stmt.executeUpdate(qry);
                        qry = "CREATE INDEX IF NOT EXISTS log_underscoreparent ON log(parent)";
                        stmt.executeUpdate(qry);
                        qry = "UPDATE settings SET val = '5' WHERE var = 'schema'";
                        stmt.executeUpdate(qry);
                        break;
                    case 5:
                        qry = "CREATE TABLE tmp_underscoresettings (var varchar(32) NOT NULL PRIMARY KEY, val varchar(128) NOT NULL)";
                        stmt.executeUpdate(qry);
                        qry = "INSERT INTO tmp_underscoresettings SELECT var,val FROM settings";
                        stmt.executeUpdate(qry);
                        qry = "DROP TABLE settings";
                        stmt.executeUpdate(qry);
                        qry = "ALTER TABLE tmp_underscoresettings RENAME TO settings";
                        stmt.executeUpdate(qry);
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        qry = "DROP INDEX files_underscorehistory";
                        stmt.executeUpdate(qry);
                        qry = "DROP INDEX recordings_underscorehistory";
                        stmt.executeUpdate(qry);
                        qry = "DROP TABLE files";
                        stmt.executeUpdate(qry);
                        qry = "CREATE TABLE new_underscorerec (id INT NOT NULL, type VARCHAR(32) NOT NULL, start INT NOT NULL DEFAULT 0, finish INT NOT NULL DEFAULT 0, state INT NOT NULL DEFAULT 1, PRIMARY KEY(id, type))";
                        stmt.executeUpdate(qry);
                        qry = "INSERT INTO new_underscorerec SELECT id, type, 0, 0, 1 FROM recordings";
                        stmt.executeUpdate(qry);
                        ...
                        stmt.executeUpdate(qry);
                        qry = "INSERT INTO recordings SELECT * FROM new_underscorerec";
                        stmt.executeUpdate(qry);
                        qry = "DROP TABLE new_underscorerec";
                        stmt.executeUpdate(qry);
                        qry = "CREATE UNIQUE INDEX recordings_underscorehistory on recordings(id,type)";
                        stmt.executeUpdate(qry);
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        qry = "CREATE INDEX logs_underscorefor_underscoretasks ON log(mediaid, taskid)";
                        stmt.executeUpdate(qry);
                    ...
                    case 14:
                        ...
                        stmt.executeUpdate(qry);
                        qry = "CREATE INDEX logs_underscoreby_underscoredate ON log(ts)";
                        stmt.executeUpdate(qry);
                        qry = "CREATE INDEX IF NOT EXISTS logs_underscorefor_underscoretasks ON log(mediaid, taskid)";
                        stmt.executeUpdate(qry);
                    ...
                    case 15:
                        ...
                        break;
                    case 16:
                        qry = "CREATE TEMPORARY TABLE rec_underscoretmp (objtype varchar(64) NOT NULL DEFAULT 'media', id INT NOT NULL, type VARCHAR(32) NOT NULL, start INT NOT NULL DEFAULT 0, finish INT NOT NULL DEFAULT 0, state INT NOT NULL DEFAULT 1, host VARCHAR(255) NOT NULL DEFAULT '', airing VARCHAR(64) NOT NULL DEFAULT '0', PRIMARY KEY (objtype, id, type))";
                        stmt.executeUpdate(qry);
                        qry = "INSERT INTO rec_underscoretmp SELECT 'media', id, type, start, finish, state, host, airing FROM recordings";
                        stmt.executeUpdate(qry);
                        qry = "DROP TABLE recordings";
                        stmt.executeUpdate(qry);
                        ...
                        stmt.executeUpdate(qry);
                        qry = "INSERT INTO recordings SELECT * FROM rec_underscoretmp";
                        stmt.executeUpdate(qry);
                        qry = "DROP TABLE rec_underscoretmp";
                        stmt.executeUpdate(qry);
                        ...
                        break;
                    case 17:
                        qry = "DROP INDEX logs_underscorefor_underscoretasks";
                        stmt.executeUpdate(qry);
                        qry = "CREATE INDEX logs_underscorefor_underscoretasks ON log(mediaid, taskid, objtype)";
                        stmt.executeUpdate(qry);
