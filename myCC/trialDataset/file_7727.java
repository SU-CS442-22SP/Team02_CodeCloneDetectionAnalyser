    public static byte[] clearPassToUserPassword(String clearpass, HashAlg alg, byte[] salt) {
        ...
        try {
            ...
            digester.reset();
            digester.update(clearpass.getBytes(DEFAULT_underscoreENCODING));
            byte[] hash = null;
            ...
            resultInText.append(new String(Base64.encodeBase64(hash), DEFAULT_underscoreENCODING));
            return resultInText.toString().getBytes(DEFAULT_underscoreENCODING);
