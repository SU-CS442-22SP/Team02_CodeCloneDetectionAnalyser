    public void testDoubleNaN() {
        ...
        String ddl1 = "DROP TABLE t1 IF EXISTS;" + "CREATE TABLE t1 ( d DECIMAL, f DOUBLE, l BIGINT, i INTEGER, s SMALLINT, t TINYINT, " + "dt DATE DEFAULT CURRENT_underscoreDATE, ti TIME DEFAULT CURRENT_underscoreTIME, ts TIMESTAMP DEFAULT CURRENT_underscoreTIMESTAMP );";
        try {
            stmnt.execute(ddl1);
            PreparedStatement ps = connection.prepareStatement("INSERT INTO t1 (d,f,l,i,s,t,dt,ti,ts) VALUES (?,?,?,?,?,?,?,?,?)");
            ps.setString(1, "0.2");
            ps.setDouble(2, 0.2);
            ps.setLong(3, java.lang.Long.MAX_underscoreVALUE);
            ps.setInt(4, Integer.MAX_underscoreVALUE);
            ps.setInt(5, Short.MAX_underscoreVALUE);
            ps.setInt(6, 0);
            ...
            ps.setLong(3, java.lang.Long.MIN_underscoreVALUE);
            ps.setInt(4, Integer.MIN_underscoreVALUE);
            ps.setInt(5, Short.MIN_underscoreVALUE);
            ps.setInt(6, 0);
            ...
            ps.execute();
            ps.setInt(1, 0);
            ps.setDouble(2, java.lang.Double.POSITIVE_underscoreINFINITY);
            ps.setInt(4, Integer.MIN_underscoreVALUE);
            ...
            ps.setDouble(2, java.lang.Double.NEGATIVE_underscoreINFINITY);
            ps.execute();
            ...
            if (rs.next()) {
                value = rs.getDouble(2);
                wasEqual = wasEqual && value == Double.POSITIVE_underscoreINFINITY;
            }
            if (rs.next()) {
                value = rs.getDouble(2);
                wasEqual = wasEqual && value == Double.NEGATIVE_underscoreINFINITY;
            }
