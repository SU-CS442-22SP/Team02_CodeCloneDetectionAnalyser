    public void login() throws Exception {
        String s_underscoreurl = bean.getProtocol() + "://" + bean.getUrl() + ":" + bean.getPort() + "/login/login.cgi?" + "userType=1&" + "name=" + bean.getLogin() + "&" + "passwd=" + bean.getPassword() + "&" + "btn_underscoresubmit=enter&" + "login_underscoreaction=login&" + "path=&" + "restart=no&" + "systemfull=no";
        URL url = new URL(s_underscoreurl);
