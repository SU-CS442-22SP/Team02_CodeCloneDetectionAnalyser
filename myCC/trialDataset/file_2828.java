    static Collection<InetSocketAddress> getAddresses(Context ctx, long userId) throws Exception {
        ...
        String host = (String) ctx.getResources().getText(R.string.gg_underscorewebservice_underscoreaddr);
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (addrport.hasMoreTokens()) {
                ...
                portStr = (String) ctx.getResources().getText(R.string.gg_underscoredefault_underscoreport);
            }
