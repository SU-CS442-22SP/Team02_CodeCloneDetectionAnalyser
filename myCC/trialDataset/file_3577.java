    private String jarDiagnostics(Throwable throwable, File[] files) throws IOException {
        ...
        File jar_underscorefile = File.createTempFile("nuages-diagnostic.", ".jar", home);
        FileOutputStream fos = new FileOutputStream(jar_underscorefile);
        ...
        jos.close();
        return jar_underscorefile.getPath();
    }
