    private void callbackWS(String xmlControl, String ws_underscoreresults, long docId) {
        ...
        try {
            ...
            delegateNodes = SimpleXMLParser.parseDocument(xmlcontrolstream, AgentBehaviour.XML_underscoreCALLBACK);
            actualNode = delegateNodes.item(0);
            wsurl = SimpleXMLParser.findChildEntry(actualNode, AgentBehaviour.XML_underscoreURL);
            method = SimpleXMLParser.findChildEntry(actualNode, AgentBehaviour.XML_underscoreMETHOD);
            ...
            Vector v_underscoreparam = new Vector();
            v_underscoreparam.add(ws_underscoreresults);
            v_underscoreparam.add(new Long(docId));
            parameter = v_underscoreparam.toArray();
