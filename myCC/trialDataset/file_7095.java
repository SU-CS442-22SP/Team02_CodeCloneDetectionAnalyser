    public void updateShoppingBean(String userId) {
        ...
        try {
            ...
            String preparedQuery = "INSERT INTO dbComputerShopping.order(name,product_underscoreid,quantity,date,status)VALUES(?,?,?,?,?)";
            ...
            preparedQuery = "UPDATE components SET quantity=quantity-? WHERE comp_underscoreid=?";
