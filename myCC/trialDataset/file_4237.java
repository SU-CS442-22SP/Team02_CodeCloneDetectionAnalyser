    public XmldbURI createFile(String newName, InputStream is, Long length, String contentType) throws IOException, PermissionDeniedException, CollectionDoesNotExistException {
        ...
        if (mime == null) {
            mime = MimeType.BINARY_underscoreTYPE;
        }
        ...
        if (mime.isXMLType() && vtf.length() == 0L) {
            ...
            IOUtils.write("<null_underscoreresource/>", vtf);
            vtf.close();
        }
        ...
        try {
            ...
            collection = broker.openCollection(xmldbUri, Lock.WRITE_underscoreLOCK);
            if (collection == null) {
            ...
            if (collection != null) {
                collection.release(Lock.WRITE_underscoreLOCK);
            }
