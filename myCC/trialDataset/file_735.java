    private void constructDialogContent(Composite parent) {
        ...
        splitter.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        ...
        fragmentsTable.getTable().setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        fragmentsTable.setContentProvider(new ArrayContentProvider());
        fragmentsTable.setLabelProvider(new LabelProvider() {

            public Image getImage(Object element) {
                return JFaceResources.getImage(WsmoImageRegistry.INSTANCE_underscoreICON);
            }
        ...
        previewArea.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        ...
        viewer.getControl().setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        ZoomManager zoomManager = rootEditPart.getZoomManager();
        ArrayList<String> zoomContributions = new ArrayList<String>();
        zoomContributions.add(ZoomManager.FIT_underscoreALL);
        zoomContributions.add(ZoomManager.FIT_underscoreHEIGHT);
        zoomContributions.add(ZoomManager.FIT_underscoreWIDTH);
        ...
        businessGoalPanel.setLayoutData(new GridData(GridData.FILL_underscoreHORIZONTAL));
        businessGoalPanel.setLayout(new GridLayout(4, false));
        Label lab = new Label(businessGoalPanel, SWT.NONE);
        lab.setText("Process goal:");
        bpgIRI = new Text(businessGoalPanel, SWT.BORDER | SWT.READ_underscoreONLY);
        bpgIRI.setLayoutData(new GridData(GridData.FILL_underscoreHORIZONTAL));
