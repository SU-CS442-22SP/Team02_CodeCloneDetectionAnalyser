    public static void testclass(String[] args) throws IOException, CodeCheckException {
        ...
        writer.emptyClass(ClassWriter.ACC_underscorePUBLIC, "TestClass", "java/lang/Object");
        MethodInfo newMethod = writer.addMethod(ClassWriter.ACC_underscorePUBLIC | ClassWriter.ACC_underscoreSTATIC, "main", "([Ljava/lang/String;)V");
        CodeAttribute attribute = newMethod.getCodeAttribute();
        int constantIndex = writer.getStringConstantIndex("It's alive! It's alive!!");
        int fieldRefIndex = writer.getReferenceIndex(ClassWriter.CONSTANT_underscoreFieldref, "java/lang/System", "out", "Ljava/io/PrintStream;");
        int methodRefIndex = writer.getReferenceIndex(ClassWriter.CONSTANT_underscoreMethodref, "java/io/PrintStream", "println", "(Ljava/lang/String;)V");
