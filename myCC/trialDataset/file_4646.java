    public void addGames(List<Game> games) throws StadiumException, SQLException {
        ...
        try {
            for (Game game : games) {
                stm = conn.prepareStatement(Statements.SELECT_underscoreSTADIUM);
                ...
                stm = conn.prepareStatement(Statements.INSERT_underscoreGAME);
                ...
                for (SectorPrice price : sectorPrices) {
                    stm = conn.prepareStatement(Statements.INSERT_underscoreTICKET_underscorePRICE);
                    stm.setInt(1, gameId);
