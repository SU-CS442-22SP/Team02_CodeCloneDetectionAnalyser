    public static void main(String[] args) {
        try {
            ...
            URL url1 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/keren.jpg");
            ...
            URL url2 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/alex.jpg");
            ...
            URL url3 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/julia.jpg");
            ...
            URL url4 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/meir.jpg");
            ...
            URL url5 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/miki.jpg");
            ...
            URL url6 = new URL("http://www.cs.huji.ac.il/~keren_underscoreha/J2EE/tamar.jpg");
            ...
            Recipes rec3 = addRecipe(basicComplexity, description, "Strawberry short cake", alex, 60, 70, 12, dessert, "http://static.open.salon.com/files/coconut_underscorestrawberry_underscorecake1226877577.jpg", Arrays.asList("Sprinkle strawberries with 2/3 cups sugar. Let stand 1 hour ", "Heat over to 425 degrees.", "Mix all ingredients and place in the over", "Slice it and eat up!"));
            ...
            Recipes rec4 = addRecipe(highComplexity, description, "Short Ribs", meir, 70, 500, 6, mainCourse, "http://farm2.static.flickr.com/1310/1237575824_underscore9068241a81.jpg", Arrays.asList("Put the potatoes and carrots in a large slow cooker", "Top with the onion wedges then the beef", "Combine the ketchup, , mustrard and salt", "Put ofver the beef", "Cook on LOW for 8 to 10 hours"));
            ...
            Recipes rec7 = addRecipe(highComplexity, description, "Creme brule", miki, 30, 200, 6, dessert, "http://www.cookingforengineers.com/hello/259/958/640/IMG_underscore3335_underscoresharp.jpg", Arrays.asList("bring the cooking cream to boiling temperature", "insert vanilla stick", "whisk eggs with sugar", "add cream to eggs CAREFULLY", "put in over for 30 minutes, then to the fridge for 4 hours"));
            ...
            Recipes rec9 = addRecipe(mediumComplexity, description, "chicken steak", meir, 15, 20, 2, mainCourse, "http://4.bp.blogspot.com/_underscorejhlSdMizhlU/RdOVtm-0QAI/AAAAAAAAABg/81W-JvXOACI/s400/Chicken_underscoreSteak.jpg", Arrays.asList("Heat a frying pan with some (preferably olive) oil", "when the oil is hot, place the chicken and onions in the middle", "fry on both sides on medium flame until it starts to turn golden", "season with salt and pepper"));
