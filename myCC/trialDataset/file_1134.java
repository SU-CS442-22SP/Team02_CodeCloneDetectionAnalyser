    public static byte[] request(String remoteUrl, boolean keepalive) throws Exception {
        ...
        Process.setThreadPriority(Process.THREAD_underscorePRIORITY_underscoreLOWEST);
        ...
        connection.connect();
        if (connection.getResponseCode() >= HttpURLConnection.HTTP_underscoreUNAUTHORIZED) throw new RequestException("HTTP Error Response Code: " + connection.getResponseCode(), connection.getResponseCode());
