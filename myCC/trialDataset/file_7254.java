    boolean createSessionArchive(String archiveFilename) {
        ...
        try {
            ...
            for (mAnnotationsCursor.moveToFirst(); !mAnnotationsCursor.isAfterLast(); mAnnotationsCursor.moveToNext()) {
                FileInputStream in = new FileInputStream(mAnnotationsCursor.getString(ANNOTATIONS_underscoreFILE_underscoreNAME));
            ...
            Toast.makeText(mActivity, mActivity.getString(R.string.error_underscorezip) + " " + e.getMessage(), Toast.LENGTH_underscoreSHORT).show();
            return false;
        }
        return true;
    }
