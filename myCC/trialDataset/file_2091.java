    private final long test(final boolean applyFilter, final int executionCount) throws NoSuchAlgorithmException, NoSuchPaddingException, FileNotFoundException, IOException, RuleLoadingException {
        ...
        ruleFileLoaderModificationExcludes.setPath(RuleParameter.MODIFICATION_underscoreEXCLUDES_underscoreDEFAULT.getValue());
        ...
        ruleFileLoaderResponseModifications.setPath(RuleParameter.RESPONSE_underscoreMODIFICATIONS_underscoreDEFAULT.getValue());
        ...
        final ResponseWrapper response = new ResponseWrapper(new ResponseMock(), request, attackHandler, helper, false, "_underscore_underscore_underscoreENCRYPTED_underscore_underscore_underscore", cipher, key, "_underscore_underscore_underscoreSEC-KEY_underscore_underscore_underscore", "_underscore_underscore_underscoreSEC-VALUE_underscore_underscore_underscore", "_underscore_underscore_underscorePROT-KEY_underscore_underscore_underscore", false, false, false, false, "123.456.789.000", new HashSet(), prefiltersToExcludeCompleteScript, matchersToExcludeCompleteScript, prefiltersToExcludeCompleteTag, matchersToExcludeCompleteTag, prefiltersToExcludeLinksWithinScripts, matchersToExcludeLinksWithinScripts, prefiltersToExcludeLinksWithinTags, matchersToExcludeLinksWithinTags, prefiltersToCaptureLinksWithinScripts, matchersToCaptureLinksWithinScripts, prefiltersToCaptureLinksWithinTags, matchersToCaptureLinksWithinTags, groupNumbersToCaptureLinksWithinScripts, groupNumbersToCaptureLinksWithinTags, true, false, true, true, true, true, true, true, true, true, true, false, false, true, "", "", (short) 3, true, false, false);
