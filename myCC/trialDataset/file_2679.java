    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String prefixesSpec = sc.getInitParameter(PARAM_underscoreALLOWED_underscorePREFIXES);
        ...
        if (!allowAccess) {
            ...
            response.sendError(HttpServletResponse.SC_underscoreFORBIDDEN);
            return;
        }
        String resPrefix = sc.getInitParameter(PARAM_underscoreRESOURCE_underscorePREFIX);
        ...
        String baseClassName = sc.getInitParameter(PARAM_underscoreBASE_underscoreCLASS);
        ...
        if (null != resUrl) {
            ...
            response.sendError(HttpServletResponse.SC_underscoreNOT_underscoreFOUND, "Resource not found");
        }
    }
