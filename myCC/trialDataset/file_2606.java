    public void readDocument(URL url) {
        ...
        try {
            ...
            if (readAdp != null) {
                XmlDataAdaptor mpsfileData_underscoreAdaptor = readAdp.childAdaptor(dataRootName);
                if (mpsfileData_underscoreAdaptor != null) {
                    setTitle(mpsfileData_underscoreAdaptor.stringValue("title"));
                    java.util.Iterator<XmlDataAdaptor> plotIt = mpsfileData_underscoreAdaptor.childAdaptorIterator("Plot");
                    ...
                    java.util.Iterator<XmlDataAdaptor> timingIt = mpsfileData_underscoreAdaptor.childAdaptorIterator("TimingPV");
                    while (timingIt.hasNext()) {
                        XmlDataAdaptor pvDA = timingIt.next();
                        String name = pvDA.stringValue("name");
                        bModel.setTimingPVName(name);
                    }
                    java.util.Iterator<XmlDataAdaptor> trigIt = mpsfileData_underscoreAdaptor.childAdaptorIterator("Trigger");
                    ...
                    java.util.Iterator<XmlDataAdaptor> blmIt = mpsfileData_underscoreAdaptor.childAdaptorIterator("BLMdevice");
                    while (blmIt.hasNext()) {
