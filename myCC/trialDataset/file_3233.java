    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HttpGet request = new HttpGet(SERVICE_underscoreURI + "/json/getroutes/1");
        ...
        try {
            ...
            Log.i("_underscoreGetClient_underscore", "<jsonobject> \n " + json.toString() + " \n </jsonobject>");
            ...
            for (int i = 0; i < nameArray.length(); i++) {
                ...
                Log.i("_underscoreGetClient_underscore", "<Agent" + i + ">" + tempStringAgent + "</Agent" + i + ">\n");
                Log.i("_underscoreGetClient_underscore", "<Client" + i + ">" + tempStringClient + "</Client" + i + ">\n");
                Log.i("_underscoreGetClient_underscore", "<Route" + i + ">" + tempStringRoute + "</Route" + i + ">\n");
                Log.i("_underscoreGetClient_underscore", "<Zone" + i + ">" + tempStringZone + "</Zone" + i + ">\n");
