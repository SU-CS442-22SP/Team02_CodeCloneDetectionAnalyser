    public int readLines() {
        ...
        try {
            ...
            if ((new String("http")).compareTo(url.getProtocol()) == 0) {
                ...
                if (last_underscorecontentLenght != istream.getContentLength()) {
                    last_underscorecontentLenght = istream.getContentLength();
                    istream = url.openConnection();
                    istream.setRequestProperty("Range", "bytes=" + Integer.toString(bytes_underscoreread) + "-");
                    ...
                    while ((s = reader.readLine()) != null) {
                        bytes_underscoreread = bytes_underscoreread + s.length() + 1;
                ...
                while ((s1 = reader.readLine()) != null) {
                    bytes_underscoreread = bytes_underscoreread + s1.length() + 1;
