    protected void performInsertTest() throws Exception {
        ...
        int rv = st.executeUpdate(sql, dbUtil.supportsGeneratedKeyQuery() ? Statement.RETURN_underscoreGENERATED_underscoreKEYS : Statement.NO_underscoreGENERATED_underscoreKEYS);
        if (rv > 0) {
