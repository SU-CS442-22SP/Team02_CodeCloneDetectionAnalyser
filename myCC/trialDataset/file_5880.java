    public boolean execute_underscorecheck() {
        ...
        try {
            ...
            if (!FTPReply.isPositiveCompletion(reply)) {
                ...
                check_underscorestate = common_underscoreh.STATE_underscoreCRITICAL;
                check_underscoremessage = ftp.getReplyString();
                filename.delete();
                ftp.disconnect();
                return true;
            }
            ...
            if (!ftp.changeWorkingDirectory(directory)) {
                ...
                check_underscorestate = common_underscoreh.STATE_underscoreWARNING;
                check_underscoremessage = ftp.getReplyString();
                ftp.disconnect();
                filename.delete();
                return true;
            ...
            check_underscorestate = common_underscoreh.STATE_underscoreOK;
            check_underscoremessage = ftp.getReplyString();
            is.close();
            os.close();
            channel.close();
            ...
            check_underscorestate = common_underscoreh.STATE_underscoreCRITICAL;
            check_underscoremessage = e.getMessage();
