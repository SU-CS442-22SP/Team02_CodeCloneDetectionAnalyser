    public void generateReport(AllTestsResult atr, AllConvsResult acr, File nwbConvGraph) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                } else if (line.matches(NODE_underscoreLINE)) {
            ...
            this.log.log(LogService.LOG_underscoreERROR, "Unable to generate Graph Report.", e);
            try {
                if (reader != null) reader.close();
            } catch (IOException e2) {
                this.log.log(LogService.LOG_underscoreERROR, "Unable to close graph report stream", e);
            }
        } finally {
            try {
                if (reader != null) {
                ...
                this.log.log(LogService.LOG_underscoreERROR, "Unable to close either graph report reader or " + "writer.", e);
                e.printStackTrace();
            }
        }
    }
