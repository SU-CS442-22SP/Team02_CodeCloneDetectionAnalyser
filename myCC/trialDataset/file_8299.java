    public boolean validatePassword(UserType nameMatch, String password) {
        try {
            ...
            String errorMessage = "Could not use algorithm " + HASH_underscoreALGORITHM;
            logger.fatal(ex.getMessage());
            logger.fatal(errorMessage);
            GlobalUITools.displayFatalExceptionMessage(null, "Could not use algorithm " + HASH_underscoreALGORITHM, ex, true);
