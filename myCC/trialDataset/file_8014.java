    ...
    public void execute(String[] args) throws Exception {
        ...
        try {
            ...
            String srcRepositoryURLString = commandLine.getOptionValue(CMD_underscoreLINE_underscoreSRC_underscoreREPOSITORYURL_underscoreOPTION);
            Plugins libraryPlugins = RepositoryMetadata.getRepositoryPlugins(new URL(srcRepositoryURLString));
            String srcPluginId = commandLine.getOptionValue(CMD_underscoreLINE_underscoreSRC_underscorePLUGIN_underscoreID_underscoreOPTION);
            ...
            String srcPluginVersionString = commandLine.getOptionValue(CMD_underscoreLINE_underscoreSRC_underscorePLUGIN_underscoreVERSION_underscoreOPTION);
            ...
            String destPluginId = commandLine.getOptionValue(CMD_underscoreLINE_underscoreDEST_underscorePLUGIN_underscoreID_underscoreOPTION);
            ...
            try {
                ...
                String destPluginVersion = commandLine.getOptionValue(CMD_underscoreLINE_underscoreDEST_underscorePLUGIN_underscoreVERSION_underscoreOPTION);
                if (destPluginVersion == null) {
                    destPluginVersion = DEFAULT_underscoreDEST_underscoreVERSION;
                }
                ...
                String destDirname = commandLine.getOptionValue(CMD_underscoreLINE_underscoreDEST_underscoreDIR_underscoreOPTION);
