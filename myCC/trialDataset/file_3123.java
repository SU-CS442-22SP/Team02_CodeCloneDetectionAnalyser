    public static void track(String strUserName, String strShortDescription, String strLongDescription, String strPriority, String strComponent) {
        ...
        try {
            ...
            while (buffer != null) {
                if (buffer.contains("_underscore_underscoreFORM_underscoreTOKEN")) {
            ...
            method.setRequestHeader("Cookie", "trac_underscoreform_underscoretoken=" + strFromToken);
            method.addParameter("_underscore_underscoreFORM_underscoreTOKEN", strFromToken);
