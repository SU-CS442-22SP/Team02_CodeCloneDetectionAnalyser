    public static NotaFiscal insert(NotaFiscal objNF) {
        ...
        try {
            ...
            sql = "INSERT INTO nota_underscorefiscal " + "(id_underscorenota_underscorefiscal, id_underscorefornecedor, total, data_underscoreemissao, data_underscorecadastro, numero) " + "VALUES(?, ?, TRUNCATE(?,2), STR_underscoreTO_underscoreDATE(?,'%d/%m/%Y'), now(), ?) ";
            ...
            if (result > 0) {
                ...
                while ((itINF != null) && (itINF.hasNext())) {
                    ...
                    sql = "";
                    sql = "INSERT INTO item_underscorenota_underscorefiscal " + "(id_underscorenota_underscorefiscal, id_underscoreproduto, quantidade, subtotal) " + "VALUES(?, ?, ?, TRUNCATE(?,2))";
                    pst = c.prepareStatement(sql);
                    pst.setInt(1, idNotaFiscal);
