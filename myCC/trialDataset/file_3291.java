    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        sb.append(year).append("/xml/blm_underscoree_underscore").append(round).append("_underscore").append(year.substring(2, 4)).append(".xml");
        ...
        try {
            ...
            for (Object termin : termine) {
                ...
                resp.getWriter().println("Ergebnis:" + terminNode.element("punkte_underscorea").getText() + ":" + terminNode.element("punkte_underscoreb").getText() + "<br/>");
