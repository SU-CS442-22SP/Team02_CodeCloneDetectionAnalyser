    protected void cboTemplateIndexSelectionChanged() {
        ...
        String prefnamePrefix = PreferenceConstants.TEMPLATE_underscorePREFIX + idx;
        String baseUrl = store.getString(prefnamePrefix + PreferenceConstants.BASEURL_underscorePOSTFIX);
        String descfile = store.getString(prefnamePrefix + PreferenceConstants.DESCFILE_underscorePOSTFIX);
        try {
