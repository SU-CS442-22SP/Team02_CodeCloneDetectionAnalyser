    private String readRDF() {
        try {
            FileReader fileStream = new FileReader(GeoModel.PATH_underscoreSTORED_underscoreFILES + "rdfVersion.xml");
            ...
            URL urlRdf;
            try {
                urlRdf = new URL(GeoModel.URL_underscoreSTORED_underscoreFILES + "rdfVersion.xml");
