    public static String CreateHashValue(Connection dbConnection) throws Exception {
        ...
        HashDBState.m_underscoreoLogger.debug("Start creating hash from database object.");
        ...
        try {
            ...
            m_underscoreoLogger.error("Error while committing hash statements: " + e.getMessage(), e);
        }
        ...
        HashDBState.m_underscoreoLogger.debug("Hashvalue of database is: " + sResult);
        return sResult;
    }
