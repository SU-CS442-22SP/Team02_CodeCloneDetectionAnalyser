    private void handleInterfaceUp(long eventID, long nodeID, String ipAddr, String eventTime) {
        ...
        if (eventID == -1 || nodeID == -1 || ipAddr == null) {
            log.warn(EventConstants.INTERFACE_underscoreUP_underscoreEVENT_underscoreUEI + " ignored - info incomplete - eventid/nodeid/ipAddr: " + eventID + "/" + nodeID + "/" + ipAddr);
            return;
        }
        ...
        try {
            ...
            if (openOutageExists(dbConn, nodeID, ipAddr)) {
                ...
                PreparedStatement outageUpdater = dbConn.prepareStatement(OutageConstants.DB_underscoreUPDATE_underscoreOUTAGES_underscoreFOR_underscoreINTERFACE);
                ...
                log.warn("\'" + EventConstants.INTERFACE_underscoreUP_underscoreEVENT_underscoreUEI + "\' for " + nodeID + "/" + ipAddr + " ignored.");
            }
        } catch (SQLException se) {
