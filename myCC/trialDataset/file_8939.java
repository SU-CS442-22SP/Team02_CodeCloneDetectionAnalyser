    public static void main(String[] args) {
        ...
        String preverifyCmd = WTKdir + File.separator + "bin" + File.separator + "preverify -classpath " + WTKdir + File.separator + "lib" + File.separator + CLDC_underscoreJAR + File.pathSeparator + WTKdir + File.separator + "lib" + File.separator + MIDP_underscoreJAR + File.pathSeparator + WTKdir + File.separator + "lib" + File.separator + WMA_underscoreJAR + File.pathSeparator + instrFile;
