    protected void setupService(MessageContext msgContext) throws Exception {
        String realpath = msgContext.getStrProp(Constants.MC_underscoreREALPATH);
        String extension = (String) getOption(OPTION_underscoreJWS_underscoreFILE_underscoreEXTENSION);
        if (extension == null) extension = DEFAULT_underscoreJWS_underscoreFILE_underscoreEXTENSION;
        if ((realpath != null) && (realpath.endsWith(extension))) {
            String jwsFile = realpath;
            String rel = msgContext.getStrProp(Constants.MC_underscoreRELATIVE_underscorePATH);
            ...
            String outdir = msgContext.getStrProp(Constants.MC_underscoreJWS_underscoreCLASSDIR);
            ...
            if (rpc == null) {
                ...
                rpc.setName(clsName);
                rpc.setOption(RPCProvider.OPTION_underscoreCLASSNAME, clsName);
                rpc.setEngine(msgContext.getAxisEngine());
                String allowed = (String) getOption(RPCProvider.OPTION_underscoreALLOWEDMETHODS);
                if (allowed == null) allowed = "*";
                rpc.setOption(RPCProvider.OPTION_underscoreALLOWEDMETHODS, allowed);
                String scope = (String) getOption(RPCProvider.OPTION_underscoreSCOPE);
                if (scope == null) scope = Scope.DEFAULT.getName();
                rpc.setOption(RPCProvider.OPTION_underscoreSCOPE, scope);
