    public void gzipCompress(String file) {
        try {
            ...
            byte[] buf = new byte[READ_underscoreBUFFER_underscoreSIZE];
            while ((bytes_underscoreread = bis.read(buf, 0, BLOCK_underscoreSIZE)) != -1) {
                gzipstream.write(buf, 0, bytes_underscoreread);
            }
            bis.close();
            inputFile.delete();
            gzipstream.finish();
