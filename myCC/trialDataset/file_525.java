    File exportCommunityData(Community community) throws CommunityNotActiveException, FileNotFoundException, IOException, CommunityNotFoundException {
        try {
            ...
            new File(CommunityManagerImpl.EXPORTED_underscoreCOMMUNITIES_underscorePATH).mkdirs();
            ...
            if (community.isPersonalCommunity()) {
                zipOutFilename = new File(CommunityManagerImpl.EXPORTED_underscoreCOMMUNITIES_underscorePATH + communityName + ".zip");
            } else {
                zipOutFilename = new File(CommunityManagerImpl.EXPORTED_underscoreCOMMUNITIES_underscorePATH + MANUAL_underscoreEXPORTED_underscoreCOMMUNITY_underscorePREFIX + communityTitle + ".zip");
            }
            ...
            if (CommunityManager.PERSONAL_underscoreCOMMUNITY_underscoreTYPE.equals(communityType)) {
