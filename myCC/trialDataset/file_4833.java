    private JButton getButtonImagen() {
        if (buttonImagen == null) {
            ...
            buttonImagen.setIcon(new ImageIcon(getClass().getResource("/es/unizar/cps/tecnoDiscap/data/icons/view_underscoresidetree.png")));
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (returnVal == JFileChooser.APPROVE_underscoreOPTION) {
                        ...
                        try {
                            ...
                            buttonImagen.setIcon(new ImageIcon(getClass().getResource("/es/unizar/cps/tecnoDiscap/data/icons/view_underscoresidetreeOK.png")));
