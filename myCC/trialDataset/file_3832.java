    protected ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (isMultipart) {
                ...
                errors.add("general", new ActionMessage(ExceptionCode.ERROR_underscoreMESSAGES_underscorePREFIX + "mail.send", "The form is null"));
            ...
            errors.add("general", new ActionMessage(ExceptionCode.ERROR_underscoreMESSAGES_underscorePREFIX + "general", errorMessage));
        ...
        if (errors.isEmpty()) {
            ...
            return mapping.findForward(Constants.ACTION_underscoreSUCCESS_underscoreFORWARD);
        } else {
            saveErrors(request, errors);
            return mapping.findForward(Constants.ACTION_underscoreFAIL_underscoreFORWARD);
        }
    }
