    ...
    public Template updateTemplate(Template template) {
        ...
        try {
            ...
            if (HttpServletResponse.SC_underscoreOK == response.getStatusLine().getStatusCode()) {
                resourceService.saveTemplateResourcesToBeehive(template);
            } else if (HttpServletResponse.SC_underscoreNOT_underscoreFOUND == response.getStatusLine().getStatusCode()) {
                return null;
            } else {
