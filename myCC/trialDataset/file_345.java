    ...
    public void sendData(String serverUrl, String fileName, String type, InputStream is) throws IOException {
        ...
        try {
            ...
            if (hsConnectReply.getResponseCode() != ResponseCodes.OBEX_underscoreHTTP_underscoreOK) {
            ...
            if (hsDisconnect.getResponseCode() != ResponseCodes.OBEX_underscoreHTTP_underscoreOK) {
