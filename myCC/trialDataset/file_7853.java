    public static void main(String[] args) throws IOException {
        ...
        String dist_underscoremetric = in.readLine();
        File outFile = new File("data.txt");
        FileWriter outw = new FileWriter(outFile);
        outw.write(inputLine);
        outw.close();
        File sample_underscorecoords = new File("sample_underscorecoords.txt");
        sample_underscorecoords.delete();
        File sp_underscorecoords = new File("sp_underscorecoords.txt");
        sp_underscorecoords.delete();
        try {
            System.out.println("Running python script...");
            System.out.println("Command: " + "python l19test.py " + "\"" + dist_underscoremetric + "\"");
            Process pr = Runtime.getRuntime().exec("python l19test.py " + dist_underscoremetric);
        ...
        File myFile = new File("sp_underscorecoords.txt");
        ...
        myFile = new File("sample_underscorecoords.txt");
