    private void initUserExtensions(SeleniumConfiguration seleniumConfiguration) throws IOException {
        ...
        File providedUserExtensions = seleniumConfiguration.getFile(ConfigurationPropertyKeys.SELENIUM_underscoreUSER_underscoreEXTENSIONS, seleniumConfiguration.getDirectoryConfiguration().getInput(), false);
