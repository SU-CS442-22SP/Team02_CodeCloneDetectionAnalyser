    public void run() {
        try {
            URL url = new URL(UPDATE_underscoreURL);
            ...
            if (versionString != null && !versionString.equals(PinEmUp.VERSION)) {
                ...
                JOptionPane.showMessageDialog(null, I18N.getInstance().getString("info.versionuptodate"), I18N.getInstance().getString("info.title"), JOptionPane.INFORMATION_underscoreMESSAGE);
            }
            br.close();
        } catch (IOException e) {
        }
