    public void addAuthors() throws Exception {
        ...
        try {
            ...
            pStr = "insert into event (summary,document1,document2,document3,publicComments,privateComments,ACTION_underscoreID,eventDate,ROLE_underscoreID,reviewText,USR_underscoreID,PROPOSAL_underscoreID,SUBJECTUSR_underscoreID) values " + "('','','','','','','member added','" + dt + "',2,'add member'," + userId + ",?,?)";
