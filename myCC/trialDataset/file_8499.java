    public void login(String username, String key) {
        ...
        RequestProcessor.getDefault().post(new Runnable() {
            ...
            public void run() {
                try {
                    HttpsURLConnection connection = (HttpsURLConnection) urlGenerator(DreamHostCommands.CMD_underscoreDOMAIN_underscoreLIST_underscoreDOMAINS, null).openConnection();
