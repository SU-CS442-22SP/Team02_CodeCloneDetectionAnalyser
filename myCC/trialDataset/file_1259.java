            ...
            while ((entry = in.getNextJarEntry()) != null) {
                ...
                if (entryName.equals("classes.pack")) {
                    ...
                    if (DownloadManager.isWindowsVista()) {
                        ...
                        dest = new File(DownloadManager.JAVA_underscoreHOME, entryName.replace('/', File.separatorChar));
                    }
                    if (entryName.equals(BUNDLE_underscoreJAR_underscoreENTRY_underscoreNAME)) dest = useJarPath;
