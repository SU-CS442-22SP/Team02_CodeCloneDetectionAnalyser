    public void setInput(String input, Component caller, FFMpegProgressReceiver recv) throws IOException {
        ...
        if (input.contains("youtube")) {
            ...
            Downloader dl = new Downloader("http://www.youtube.com/get_underscorevideo?video_underscoreid=" + vid + "&t=" + line, recv, lang);
            dl.start();
            return;
        }
        ...
        try {
            ...
            if (caller != null) JOptionPane.showMessageDialog(caller, lang.inputerror + " Audiocodec? " + (audioCodec != null) + " Videocodec? " + (videoCodec != null), lang.error, JOptionPane.ERROR_underscoreMESSAGE);
