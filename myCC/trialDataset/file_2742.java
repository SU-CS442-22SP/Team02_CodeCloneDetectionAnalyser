    private List<JarFile> webArchives(ServletContext servletContext) throws IOException {
        ...
        Set<Object> paths = servletContext.getResourcePaths(WEB_underscoreLIB_underscorePREFIX);
        for (Object pathObject : paths) {
            ...
            JarEntry signal = jarFile.getJarEntry(FACES_underscoreCONFIG_underscoreIMPLICIT);
            if (signal == null) {
