    protected void configureGraphicalViewer() {
        ...
        menuMgr.add(getActionRegistry().getAction(GEFActionConstants.ZOOM_underscoreIN));
        menuMgr.add(getActionRegistry().getAction(GEFActionConstants.ZOOM_underscoreOUT));
