    public GetMessages(String messageType) {
        String urlString = dms_underscoreurl + "/servlet/com.ufnasoft.dms.server.ServerGetMessages";
        String rvalue = "";
        String filename = dms_underscorehome + FS + "temp" + FS + username + "messages.xml";
        try {
