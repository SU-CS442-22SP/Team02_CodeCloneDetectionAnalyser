    private void handleNodeDown(long eventID, long nodeID, String eventTime) {
        ...
        if (eventID == -1 || nodeID == -1) {
            log.warn(EventConstants.NODE_underscoreDOWN_underscoreEVENT_underscoreUEI + " ignored - info incomplete - eventid/nodeid: " + eventID + "/" + nodeID);
            return;
        }
        ...
        try {
            ...
            PreparedStatement activeSvcsStmt = dbConn.prepareStatement(OutageConstants.DB_underscoreGET_underscoreACTIVE_underscoreSERVICES_underscoreFOR_underscoreNODE);
