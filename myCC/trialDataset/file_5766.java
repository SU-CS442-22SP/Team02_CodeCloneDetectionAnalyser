    public DicomData load(String imgURL) {
        ...
        try {
            ...
            while (din.read(buff2) != -1) {
                ...
                tag = ("(" + group + "," + number + ")");
                if (debug_underscorelevel > 3) System.out.println("currentTag is : " + tag);
                ...
                if (debug_underscorelevel > 3) System.out.println("currentVR is : " + vr);
                if (debug_underscorelevel > 3) System.out.println("currentLength: " + length);
                if (length == -1) {
                    VReqSQ = true;
                    length = 0;
                }
                ...
                if (debug_underscorelevel > 3) System.out.println("currentName is : " + dicomData.getName(tag));
