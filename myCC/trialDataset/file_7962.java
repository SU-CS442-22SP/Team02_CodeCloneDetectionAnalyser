    public HttpResponseMessage execute(HttpMessage request, Map<String, Object> parameters) throws IOException {
        ...
        if (isPost || isPut) {
            ...
            if (body != null) {
                ...
                String length = request.removeHeaders(HttpMessage.CONTENT_underscoreLENGTH);
        ...
        for (Map.Entry<String, Object> p : parameters.entrySet()) {
            ...
            if (FOLLOW_underscoreREDIRECTS.equals(name)) {
                httpMethod.setFollowRedirects(Boolean.parseBoolean(value));
            } else if (READ_underscoreTIMEOUT.equals(name)) {
                httpMethod.getParams().setIntParameter(HttpMethodParams.SO_underscoreTIMEOUT, Integer.parseInt(value));
            }
        }
