    public void prepareOutput(HttpServletRequest req) {
        EaasyStreet.logTrace(METHOD_underscoreIN + className + OUTPUT_underscoreMETHOD);
        super.prepareOutput(req);
        String content = Constants.EMPTY_underscoreSTRING;
        ...
        try {
            ...
            req.setAttribute(Constants.RAK_underscoreSYSTEM_underscoreACTION, Constants.SYSTEM_underscoreACTION_underscoreBACK);
        ...
        EaasyStreet.logTrace(METHOD_underscoreOUT + className + OUTPUT_underscoreMETHOD);
    }
