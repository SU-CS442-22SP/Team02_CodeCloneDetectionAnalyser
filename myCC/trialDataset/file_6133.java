    private void execute(File file) throws IOException {
        ...
        String login = cfg.getProperty(GC_underscoreUSERNAME);
        String password = null;
        if (cfg.containsKey(GC_underscorePASSWORD)) {
            password = cfg.getProperty(GC_underscorePASSWORD);
        } else {
            password = new String(Base64.decode(cfg.getProperty(GC_underscorePASSWORD64)));
        }
