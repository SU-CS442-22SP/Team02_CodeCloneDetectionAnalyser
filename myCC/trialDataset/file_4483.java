    public void save() {
        ...
        if (fc.showSaveDialog(this) != JFileChooser.APPROVE_underscoreOPTION) {
            return;
        }
        ...
        if (targetFile.exists()) {
            if (JOptionPane.showConfirmDialog(this, "Do you want to overwrite the file?") != JOptionPane.YES_underscoreOPTION) {
                return;
            }
        }
        try {
