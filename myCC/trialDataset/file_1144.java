    public int procesar() {
        ...
        ontologia[0] = "http://www.criado.info/owl/vertebrados_underscorees.owl#";
        ...
        ontologiaSource[0] = this.directorioMapeo + "\\" + "mapeo_underscorevertebrados_underscorees.xml";
        ontologiaSource[1] = this.directorioMapeo + "\\" + "mapeo_underscorewine_underscorees.xml";
        ontologiaSource[2] = this.directorioMapeo + "\\" + "mapeo_underscorepizza_underscorees.xml";
        ontologiaSource[3] = this.directorioMapeo + "\\" + "mapeo_underscorefood_underscorees.xml";
        ontologiaSource[4] = this.directorioMapeo + "\\" + "mapeo_underscoreparentesco_underscorees.xml";
                ...
                if (entrada.trim().length() > 10) {
                    ...
                    if (entrada2.isIncluidaSubcadena("<fichero ontologia=")) {
                        ...
                        if (entra.isIncluidaSubcadena(directorioLocal)) {
                            ...
                            ficheroOutOWL = entra3.getToken(1) + "_underscore" + firma.toString() + ".owl";
