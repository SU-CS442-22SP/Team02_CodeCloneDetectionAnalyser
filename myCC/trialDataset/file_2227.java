    public static void uploadAsync(final String username, final String password, final String description, final String tags, final boolean addDateTags, final ArrayList<RecordedGeoPoint> recordedGeoPoints, final String pseudoFileName) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    final String urlDesc = (description == null) ? DEFAULT_underscoreDESCRIPTION : description.replaceAll("\\.;&?,/", "_underscore");
                    final String urlTags = (tagsToUse == null) ? DEFAULT_underscoreTAGS : tagsToUse.replaceAll("\\\\.;&?,/", "_underscore");
                    final URL url = new URL("http://www.openstreetmap.org/api/" + API_underscoreVERSION + "/gpx/create");
                    ...
                    out.writeBytes("--" + BOUNDARY + "--" + LINE_underscoreEND);
                    out.flush();
