            public void run() {
                URL url;
                try {
                    url = new URL(Config.UPDATE_underscoreSITE_underscoreURL);
                    ...
                    if (Double.valueOf(Config.VERSION) < Double.valueOf(currentVersion)) {
                        ...
                        label0.setText(mw.getLangMap().get("Update_underscoreAvalaible"));
                    } else label0.setText(mw.getLangMap().get("Update_underscoreNonAvalaible"));
