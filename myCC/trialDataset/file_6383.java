    public ManageUsers() {
        ...
        try {
            ...
            logger.error(e1);
            JOptionPane.showMessageDialog(Menu.getMainMenu(), e1.getMessage(), "Error", JOptionPane.ERROR_underscoreMESSAGE);
        }
        ...
        if (oldDataFile.exists()) {
            ...
            try {
                ...
                logger.error(e);
                JOptionPane.showMessageDialog(Menu.getMainMenu(), e.getMessage(), "Error", JOptionPane.ERROR_underscoreMESSAGE);
            } catch (IOException e) {
                logger.error(e);
                JOptionPane.showMessageDialog(Menu.getMainMenu(), e.getMessage(), "Error", JOptionPane.ERROR_underscoreMESSAGE);
            } finally {
