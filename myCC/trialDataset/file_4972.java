    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("GRAPHVIZ")) {
            ...
            if (chooser.showOpenDialog(owner) != JFileChooser.APPROVE_underscoreOPTION) {
        ...
        if (cmd.equals(Resurses.OK)) {
            ...
            if (input.isEmpty()) {
                ...
                if (resp != null && resp.toLowerCase().startsWith("finfamily")) {
                    ...
                    JOptionPane.showMessageDialog(this, Resurses.getString("SERVER_underscoreERROR"), Resurses.getString(Resurses.SUKU), JOptionPane.ERROR_underscoreMESSAGE);
                }
            }
            ...
            Suku.kontroller.putPref(owner, "SCALE_underscoreIMAGE", "" + imageScaler);
            ...
            Suku.kontroller.putPref(owner, "USE_underscoreOPEN_underscoreSTREETMAP", "" + openStreetMap);
            String fntSize = dbFontSize.getText();
            Suku.kontroller.putPref(owner, "DB_underscoreVIEW_underscoreFONTSIZE", fntSize);
            String lf = lfNames[lookAndFeel.getSelectedIndex()];
            Suku.kontroller.putPref(owner, "LOOK_underscoreAND_underscoreFEEL", lf);
            int lfIdx = -1;
            ...
            try {
                ...
                logger.log(Level.WARNING, "look_underscoreand_underscorefeel", e1);
            }
            setVisible(false);
            if (askRestart) {
                ...
                JOptionPane.showMessageDialog(this, Resurses.getString("RESTART_underscoreFINFAMILY"), Resurses.getString(Resurses.SUKU), JOptionPane.INFORMATION_underscoreMESSAGE);
            }
        }
    }
