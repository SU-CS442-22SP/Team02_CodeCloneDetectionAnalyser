    private void _underscorePostParser(Document document, AnnotationManager annoMan, Document htmldoc, String baseurl) {
        ...
        Node ncontext_underscoreelement = null;
        if (elemcontl.getLength() > 0) {
            Node old_underscorecontext_underscoreelement = elemcontl.item(0);
            ncontext_underscoreelement = newdoc.importNode(old_underscorecontext_underscoreelement, true);
        }
        ...
        if (ncontext_underscoreelement != null) {
            contextn.appendChild(ncontext_underscoreelement);
        } else {
            ...
            try {
                ...
                Element context_underscoreelem = newdoc.createElementNS(alNS, "al:context-element");
                context_underscoreelem.setAttributeNS(alNS, "al:text", xprange.getContentString());
                context_underscoreelem.appendChild(newdoc.createTextNode(annoMan.generateContextString(xprange)));
                contextn.appendChild(context_underscoreelem);
