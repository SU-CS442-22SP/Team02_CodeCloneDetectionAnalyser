    public static void main(String[] args) {
        if (args.length <= 0) {
            ...
            System.out.println(" If you specify 3nd command line argument - connect_underscorestring -");
            System.out.println("   connect information will be added to output file");
            System.out.println("   in the form 'connect user/password@connect_underscorestring'");
            System.exit(0);
        }
        try {
