    public List<Template> getTemplatesByKeywordsAndPage(String keywords, int page) {
        ...
        if (keywords == null || keywords.trim().length() == 0) {
            newKeywords = TemplateService.NO_underscoreKEYWORDS;
        }
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() != HttpServletResponse.SC_underscoreOK) {
                if (response.getStatusLine().getStatusCode() == HttpServletResponse.SC_underscoreUNAUTHORIZED) {
