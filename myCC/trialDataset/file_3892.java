            ...
            if (stockTypeElement != null) {
                ...
                for (int i = 0; i < trList.getLength(); i++) {
                    ...
                    if (trListChildren.getLength() > 2) {
                        org.w3c.dom.Node node_underscore0 = trListChildren.item(0);
                        org.w3c.dom.Node node_underscore1 = trListChildren.item(1);
                        String content = dengues.system.HTMLWebHelper.getContent(node_underscore0);
                        String convert_underscore0 = dengues.system.HTMLWebHelper.convert(content);
                        content = dengues.system.HTMLWebHelper.getContent(node_underscore1);
                        String convert_underscore1 = dengues.system.HTMLWebHelper.convert(content);
                        if (!"".equals(convert_underscore0)) {
                            System.out.println(convert_underscore0 + " => " + convert_underscore1);
                        }
                    }
                }
            }
