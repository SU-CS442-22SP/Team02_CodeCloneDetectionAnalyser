            ...
            try {
                ...
                if (params != null) {
                    ...
                    if (secretCode != null) {
                        ...
                        String sign = EncryptUtil.signature2(params, secretCode, "md5".equalsIgnoreCase(signMethod), isHMac, PARAMETER_underscoreSIGN);
                        getData[i] = new NameValuePair(PARAMETER_underscoreSIGN, sign);
                    }
                ...
                if (contentType == null) {
                    if (files != null && files.size() > 0) {
                        ...
                        if (secretCode != null) {
                            boolean isHMac = false;
                            if (signMethod != null && signMethod.equalsIgnoreCase("hmac")) isHMac = true;
                            String sign = EncryptUtil.signature(params, secretCode, isHMac, PARAMETER_underscoreSIGN);
                            parts[i] = new StringPart(PARAMETER_underscoreSIGN, sign);
                            i++;
                        }
                        ...
                        if (params != null) {
                            ...
                            if (secretCode != null) {
                                ...
                                if (signMethod != null && signMethod.equalsIgnoreCase("hmac")) isHMac = true;
                                String sign = EncryptUtil.signature(params, secretCode, isHMac, PARAMETER_underscoreSIGN);
                                postData[i] = new NameValuePair(PARAMETER_underscoreSIGN, sign);
                            }
