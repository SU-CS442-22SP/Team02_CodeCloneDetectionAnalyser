    public void writeValue(Value v) throws IOException, SQLException {
        ...
        switch(type) {
            case Value.NULL:
                break;
            case Value.BYTES:
            case Value.JAVA_underscoreOBJECT:
            ...
            case Value.SHORT:
                ...
                break;
            case Value.STRING:
            case Value.STRING_underscoreIGNORECASE:
            case Value.STRING_underscoreFIXED:
                writeString(v.getString());
                break;
            case Value.BLOB:
                {
            ...
            case Value.RESULT_underscoreSET:
                {
