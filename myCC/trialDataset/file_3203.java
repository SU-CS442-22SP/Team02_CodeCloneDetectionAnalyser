    public String[][] getProjectTreeData() {
        ...
        String filename = dms_underscorehome + FS + "temp" + FS + username + "projects.xml";
        String urlString = dms_underscoreurl + "/servlet/com.ufnasoft.dms.server.ServerGetProjects";
        try {
