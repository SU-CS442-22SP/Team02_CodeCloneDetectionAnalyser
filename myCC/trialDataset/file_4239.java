        public HttpResponseExchange execute() throws Exception {
            ...
            while (null != lastContentRange) {
                ...
                forwardRequest.setHeader(HttpHeaders.Names.CONTENT_underscoreRANGE, lastContentRange);
                forwardRequest.setHeader(HttpHeaders.Names.CONTENT_underscoreLENGTH, String.valueOf(sendSize));
