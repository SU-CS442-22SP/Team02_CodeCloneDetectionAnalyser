    public SOCTradeOffer makeOffer(SOCPossiblePiece targetPiece) {
        ...
        switch(targetPiece.getType()) {
            case SOCPossiblePiece.CARD:
                targetResources = SOCGame.CARD_underscoreSET;
                break;
            case SOCPossiblePiece.ROAD:
                targetResources = SOCGame.ROAD_underscoreSET;
                break;
            case SOCPossiblePiece.SETTLEMENT:
                targetResources = SOCGame.SETTLEMENT_underscoreSET;
                break;
            case SOCPossiblePiece.CITY:
                targetResources = SOCGame.CITY_underscoreSET;
                break;
        }
