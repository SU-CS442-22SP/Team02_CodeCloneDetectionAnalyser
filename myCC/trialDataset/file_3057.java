    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            if (errors.length() > 0) {
                JOptionPane.showMessageDialog(this, "<html><b>Error</b><br/>" + errors.toString() + "</html>", "Error", JOptionPane.ERROR_underscoreMESSAGE);
            } else {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "<html><b>Error</b><br/>Ha ocurrido un error enviando tu mensaje.<br/>" + "Por favor, int�ntalo m�s tarde o ponte en contacto conmigo a trav�s de www.cronopista.com</html>", "Error", JOptionPane.ERROR_underscoreMESSAGE);
                }
            }
        }
    }
