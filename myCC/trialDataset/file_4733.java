    public UpdaterView(SingleFrameApplication app, String[] args) {
        ...
        initComponents();
        try {
            URL url = new URL(BASE_underscoreURL + "version.txt");
            ...
            if (latestVersionNum == currentVersion) {
                if (schemaUpdatesNeeded) {
                    javax.swing.JOptionPane.showMessageDialog(super.getComponent(), "Updates are available but they require database changes.  Please contact your system administrator to perform the upgrade.", "Myopa Updater", javax.swing.JOptionPane.INFORMATION_underscoreMESSAGE);
                } else {
                    javax.swing.JOptionPane.showMessageDialog(super.getComponent(), "No Updates are available - your software is up to date!", "Myopa Updater", javax.swing.JOptionPane.INFORMATION_underscoreMESSAGE);
                }
                System.exit(0);
            } else {
