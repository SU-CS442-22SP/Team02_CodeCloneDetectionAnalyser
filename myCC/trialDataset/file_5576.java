            ...
            protected String doInBackground(Location... params) {
                ...
                if (!TextUtils.isEmpty(cachedAddress)) {
                    ...
                    try {
                        ...
                        if (statusCode == 200) {
                            ...
                            if (GoogleMapStatusCodes.OK.equals(status)) {
                                ...
                                if (addresses.length() > 0) {
                                    address = addresses.getJSONObject(0).getString(GoogleMapStatusSchema.formatted_underscoreaddress);
                        ...
                        e.printStackTrace();
                        Toast.makeText(mContext, "Failed to get location.", Toast.LENGTH_underscoreSHORT).show();
                    } catch (IOException e) {
                        Toast.makeText(mContext, "Failed to get location.", Toast.LENGTH_underscoreSHORT).show();
