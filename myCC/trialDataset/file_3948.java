    private synchronized Frame addFrame(INSERT_underscoreTYPE type, File source) throws IOException {
        ...
        File newLocation = new File(Settings.getPropertyString(ConstantKeys.project_underscoredir), formatFileName(frames_underscore.size()));
