    public static String encrypt(String unencryptedString) {
        ...
        String encryptionAlgorithm = Environment.getValue(Environment.PROP_underscoreENCRYPTION_underscoreALGORITHM);
        try {
        ...
        if (md == null) {
            ...
            Environment.setValue(Environment.PROP_underscoreENCRYPTION_underscoreALGORITHM, "SHA-1");
            try {
