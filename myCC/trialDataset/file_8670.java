    public static InputStream retrievePricesHTML(String username, String password) throws IOException, SAXException {
        ...
        URL url = new URL("http://motormouth.com.au/default_underscorefl.aspx");
        HttpURLConnection loginConnection = (HttpURLConnection) url.openConnection();
        String viewStateValue = HTMLParser.parseHTMLInputTagValue(new InputStreamReader(loginConnection.getInputStream()), "_underscore_underscoreVIEWSTATE");
        ...
        postCredsWriter.append("_underscore_underscoreVIEWSTATE=").append(URLEncoder.encode(viewStateValue, "UTF-8")).append('&');
        postCredsWriter.append("Login_underscoreModule1%3Ausername=").append(URLEncoder.encode(username, "UTF-8")).append('&');
        postCredsWriter.append("Login_underscoreModule1%3Apassword=").append(URLEncoder.encode(password, "UTF-8")).append('&');
        postCredsWriter.append("Login_underscoreModule1%3AButtonLogin.x=0").append('&');
        postCredsWriter.append("Login_underscoreModule1%3AButtonLogin.y=0");
