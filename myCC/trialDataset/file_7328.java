    public void update() {
        if (!updatable) {
            Main.fenetre().erreur(Fenetre.OLD_underscoreVERSION);
            return;
        }
        try {
            Main.fenetre().update();
            ...
            if (offline) {
                ...
                Main.fenetre().erreur(Fenetre.UPDATE_underscoreTERMINE_underscoreRESTART);
            } else {
            ...
            Main.fenetre().erreur(Fenetre.ERREUR_underscoreUPDATE, e);
        }
    }
