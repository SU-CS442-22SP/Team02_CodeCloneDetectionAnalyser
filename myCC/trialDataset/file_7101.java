        ...
        while (in.ready() && (line = in.readLine()) != null) {
            ...
            if (!readingBoundary && line.contains(": ")) {
                ...
                if (headerVars.getProperty("Content-Transfer-Encoding").contains("binary")) {
                    File uploadFilePath = new File(VOctopusConfigurationManager.WebServerProperties.HTTPD_underscoreCONF.getPropertyValue("TempDirectory"));
                    ...
                    File tempFile = new File(VOctopusConfigurationManager.WebServerProperties.HTTPD_underscoreCONF.getPropertyValue("TempDirectory") + "/" + headerVars.get("filename"));
