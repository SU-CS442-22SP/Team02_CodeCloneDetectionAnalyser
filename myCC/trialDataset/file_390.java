    public static void main(String[] args) {
        try {
            ...
            }
            {
                ...
                java.io.FileOutputStream fos = new java.io.FileOutputStream("test.gif_underscoreout");
                fos.write(bytes);
                fos.close();
                fis = new java.io.FileInputStream("test.gif_underscoreout");
                ...
                jframe.setTitle("Read from test.gif_underscoreout");
                jframe.getContentPane().add(jsp);
                jframe.pack();
                jframe.setVisible(true);
                fos = new java.io.FileOutputStream("test.gif.b64_underscoreout");
                fos.write(ebytes);
                fis = new java.io.FileInputStream("test.gif.b64_underscoreout");
                ...
                jlabel = new javax.swing.JLabel("Read from test.gif.b64_underscoreout", iicon, 0);
                jframe = new javax.swing.JFrame();
                jframe.getContentPane().add(jlabel);
                jframe.pack();
                jframe.setVisible(true);
            ...
            {
                java.io.FileInputStream fis = new java.io.FileInputStream("test.gif_underscoreout");
                ...
                fis.close();
                java.io.FileOutputStream fos = new java.io.FileOutputStream("test.gif.b64_underscoreout2");
                Base64.OutputStream b64os = new Base64.OutputStream(fos, ENCODE);
                b64os.write(rbytes);
                b64os.close();
                fis = new java.io.FileInputStream("test.gif.b64_underscoreout2");
                ...
                javax.swing.JScrollPane jsp = new javax.swing.JScrollPane(jta);
                javax.swing.JFrame jframe = new javax.swing.JFrame();
                jframe.setTitle("Read from test.gif.b64_underscoreout2");
                jframe.getContentPane().add(jsp);
                jframe.pack();
                jframe.setVisible(true);
                fos = new java.io.FileOutputStream("test.gif_underscoreout2");
                b64os = new Base64.OutputStream(fos, DECODE);
                b64os.write(rebytes);
                b64os.close();
                javax.swing.ImageIcon iicon = new javax.swing.ImageIcon("test.gif_underscoreout2");
                javax.swing.JLabel jlabel = new javax.swing.JLabel("Read from test.gif_underscoreout2", iicon, 0);
                jframe = new javax.swing.JFrame();
                jframe.getContentPane().add(jlabel);
                jframe.pack();
                jframe.setVisible(true);
