    public void invoke(WorkflowContext arg0, ProgressMonitor arg1, Issues arg2) {
        ...
        if (!getFileExtension(getInputFile()).equalsIgnoreCase(getFileExtension(getOutputFile())) || !getFileExtension(getInputFile()).equalsIgnoreCase(OO_underscoreCALC_underscoreEXTENSION)) {
