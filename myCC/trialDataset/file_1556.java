    public void sendMessageToServer(String msg, Map<String, String> args, StringCallback cb, URLConstructor ctor) {
        try {
            ...
            newArgs.put("_underscoref", String.valueOf(System.currentTimeMillis()));
            ...
            HttpProtocolParams.setVersion(client.getParams(), HttpVersion.HTTP_underscore1_underscore1);
