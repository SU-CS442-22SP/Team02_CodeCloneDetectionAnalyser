    public void createResource(String resourceUri, boolean publish, User user) throws IOException {
        ...
        boolean hasPermission = perAPI.doesUserHavePermission(folder, PERMISSION_underscoreWRITE, user, false);
        if (hasPermission) {
            ...
            if (host.getInode() != 0 && folder.getInode() != 0) {
                ...
                try {
                    ...
                    if (!isResource(resourceUri)) {
                        ...
                        vc.remove(ResourceManager.RESOURCE_underscoreTEMPLATE + workingIOFile.getPath());
                        if (file != null && file.getInode() > 0) {
                            ...
                            vc.remove(ResourceManager.RESOURCE_underscoreTEMPLATE + newVersionFile.getPath());
