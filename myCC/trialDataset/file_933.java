    protected void assignListeners() {
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (outcome == JFileChooser.APPROVE_underscoreOPTION) {
                ...
                } else if (outcome == JFileChooser.CANCEL_underscoreOPTION) {
                }
            }
        });
        ...
        newButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent event) {
                String newGroupName = JOptionPane.showInputDialog(null, "Enter a name", "Name of the new group", JOptionPane.QUESTION_underscoreMESSAGE);
