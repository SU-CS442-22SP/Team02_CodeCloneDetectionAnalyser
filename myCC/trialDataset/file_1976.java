    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (key == null || !key.equals(Keys.APPREGKEY)) {
            resp.setStatus(HttpServletResponse.SC_underscoreUNAUTHORIZED);
        ...
        if (appname == null || appname.equals("")) {
            resp.setStatus(HttpServletResponse.SC_underscoreBAD_underscoreREQUEST);
        ...
        try {
            ...
            resp.setStatus(HttpServletResponse.SC_underscoreINTERNAL_underscoreSERVER_underscoreERROR);
        ...
        resp.setStatus(HttpServletResponse.SC_underscoreCREATED);
