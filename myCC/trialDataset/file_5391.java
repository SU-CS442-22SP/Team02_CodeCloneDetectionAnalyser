    public StringBuffer render(RenderEngine c) {
        ...
        if (isRooted && (useFilename.indexOf("/") == -1 || useFilename.startsWith("./"))) {
            if (c.getWorkerContext() != null && useFilename.startsWith("./")) {
                useFilename = c.getWorkerContext().getClientContext().getPostVariable("current_underscorepath") + useFilename.substring(2);
                ...
                useFilename = c.getWorkerContext().getClientContext().getPostVariable("current_underscorepath") + useFilename;
        ...
        if (action.equalsIgnoreCase("read")) {
            ...
            if (filenameDataString.equals("")) {
                filenameDataString = c.getClientContext().getPostVariable("current_underscorepath");
            }
            ...
            if (c.getVendContext() != null && c.getVendContext().getFileAccess() != null && c.getVendContext().getFileAccess().getVFSType(filenameData.toString(), c.getClientContext().getMatchedHost()) == FileAccess.TYPE_underscoreJAR) {
            ...
            } else if (c.getVendContext() != null && c.getVendContext().getFileAccess() != null && c.getVendContext().getFileAccess().getVFSType(filenameData.toString(), c.getClientContext().getMatchedHost()) == FileAccess.TYPE_underscoreFS) {
                Vector listFiles = c.getVendContext().getFileAccess().listFiles(filenameData.toString(), c.getClientContext().getMatchedHost());
                Object[] list = listFiles.toArray();
