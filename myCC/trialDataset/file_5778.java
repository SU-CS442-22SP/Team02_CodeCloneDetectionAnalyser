    public void run() {
        try {
            ...
            if (login) {
                ...
                postURL = megauploadlink + "upload_underscoredone.php?UPLOAD_underscoreIDENTIFIER=" + uploadID + "&" + usercookie + "&s=" + filelength;
            } else {
                postURL = megauploadlink + "upload_underscoredone.php?UPLOAD_underscoreIDENTIFIER=" + uploadID + "&user=undefined&s=" + filelength;
            }
