    private static void readData() {
        ...
        sTok = null;
        top_underscorevowels = new HashSet();
        top_underscorevowels.add(i_underscoreVOWEL);
        top_underscorevowels.add(e_underscoreVOWEL);
        top_underscorevowels.add(o_underscoreVOWEL);
        top_underscorevowels.add(ai_underscoreVOWEL);
        top_underscorevowels.add(au_underscoreVOWEL);
        top_underscorevowels.add(reverse_underscorei_underscoreVOWEL);
        try {
                    ...
                    while (st.hasMoreTokens()) {
                        ...
                        if (val.equals(DELIMITER) && escapedToken.length() == 0) {
                            ...
                            switch(k) {
                                ...
                                case 2:
                                    if (!ignore) {
                                        duffCodes[REDUCED_underscoreC] = new DuffCode(val, true);
                                    }
                                    break;
                                case 3:
                                ...
                                case 11:
                                    if (!ignore) {
                                        duffCodes[HALF_underscoreC] = new DuffCode(val, true);
                                    }
                                    break;
                                case 12:
                                    if (!ignore) {
