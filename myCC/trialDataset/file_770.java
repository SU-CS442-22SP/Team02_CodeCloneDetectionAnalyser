    protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (fileParameter == null || fileParameter.equals("")) {
                ...
                fileParameter = pi.substring(lastSlashIndex, pi.indexOf("_underscore", pi.lastIndexOf("/")));
            }
            if (fileParameter == null || fileParameter.equals("")) {
            ...
            if (disposition == null || disposition.equals("")) {
                ...
                int underscoreIndex = filename.indexOf("_underscore") + 1;
                disposition = filename.substring(underscoreIndex, filename.indexOf("_underscore", underscoreIndex));
            }
            ...
            if (!SecurityHelper.doesUserHavePermission(session, authUser, file, Permission.PERM.READ)) {
                response.sendError(HttpServletResponse.SC_underscoreFORBIDDEN, "Forbidden");
            ...
            if (possibleDataFile.exists()) {
                ...
                if (fileDataList.size() == 0) {
                    response.sendError(HttpServletResponse.SC_underscoreNOT_underscoreFOUND);
