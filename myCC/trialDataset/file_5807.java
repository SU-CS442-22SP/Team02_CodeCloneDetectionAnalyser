    private void performDownload() {
        ...
        if (ok != JFileChooser.APPROVE_underscoreOPTION) {
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "File downloaded to " + chooser.getSelectedFile(), "Download finished", JOptionPane.INFORMATION_underscoreMESSAGE);
        } catch (IOException iOException) {
            JOptionPane.showMessageDialog(this, "Error: " + iOException, "Error", JOptionPane.ERROR_underscoreMESSAGE);
        } finally {
            if (in != null) {
                try {
                    in.close();
