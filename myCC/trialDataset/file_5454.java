    protected Control createDialogArea(Composite parent) {
        ...
        content.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        final int ncol = 1;
        ...
        try {
            ...
            browser.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        } catch (Throwable t) {
            text = new Text(content, SWT.MULTI | SWT.WRAP | SWT.VERTICAL);
            text.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        }
