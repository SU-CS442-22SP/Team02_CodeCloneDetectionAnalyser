    public void createControl(Composite parent) {
        ...
        top.setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        ...
        modelViewer = new TreeViewer(top, SWT.MULTI | SWT.H_underscoreSCROLL | SWT.V_underscoreSCROLL | SWT.BORDER);
        modelViewer.getTree().setLayoutData(new GridData(GridData.FILL_underscoreBOTH));
        ...
        modelViewer.addDragSupport(DND.DROP_underscoreCOPY, new Transfer[] { LocalTransfer.getInstance() }, new TreeDragListener());
