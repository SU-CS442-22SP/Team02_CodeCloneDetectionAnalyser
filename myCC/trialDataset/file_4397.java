    public static boolean insereMidia(final Connection con, Midia mid, Autor aut, Descricao desc) {
        try {
            ...
            smt.executeUpdate("INSERT INTO mid_underscoreaut VALUES(" + mid.getCodigo() + "," + aut.getCodAutor() + ")");
            con.commit();
            return (true);
        } catch (SQLException e) {
            try {
                JOptionPane.showMessageDialog(null, "Rolling back transaction", "MIDIA: Database error", JOptionPane.ERROR_underscoreMESSAGE);
