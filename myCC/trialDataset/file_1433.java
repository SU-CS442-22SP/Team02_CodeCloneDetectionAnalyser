    public boolean consolidateCrossrefGet(BiblioItem bib, ArrayList<BiblioItem> bib2) throws Exception {
        ...
        if (doi != null) {
            ...
            if (cCon != null) {
                ...
                try {
                    pstmt = cCon.prepareStatement(QUERY_underscoreCROSSREF_underscoreSQL3);
            ...
            if (xml == null) {
                String subpath = String.format(DOI_underscoreBASE_underscoreQUERY, crossref_underscoreid, crossref_underscorepw, doi);
                URL url = new URL("http://" + crossref_underscorehost + "/" + subpath);
                ...
                if (urlConn != null) {
                    ...
                    if (cCon != null) {
                        ...
                        try {
                            pstmt2 = cCon.prepareStatement(INSERT_underscoreCROSSREF_underscoreSQL3);
            ...
            if (cCon != null) {
                PreparedStatement pstmt = null;
                try {
                    pstmt = cCon.prepareStatement(QUERY_underscoreCROSSREF_underscoreSQL);
            ...
            if (xml == null) {
                String subpath = String.format(TITLE_underscoreBASE_underscoreQUERY, crossref_underscoreid, crossref_underscorepw, URLEncoder.encode(title), URLEncoder.encode(aut));
                URL url = new URL("http://" + crossref_underscorehost + "/" + subpath);
                System.out.println("Sending: " + url.toString());
                HttpURLConnection urlConn = null;
                try {
                ...
                if (urlConn != null) {
                    ...
                    if (cCon != null) {
                        PreparedStatement pstmt2 = null;
                        try {
                            pstmt2 = cCon.prepareStatement(INSERT_underscoreCROSSREF_underscoreSQL);
            ...
            String subpath = String.format(JOURNAL_underscoreBASE_underscoreQUERY, crossref_underscoreid, crossref_underscorepw, URLEncoder.encode(bib.getJournal()), URLEncoder.encode(bib.getVolume()), firstPage);
            URL url = new URL("http://" + crossref_underscorehost + "/" + subpath);
            ...
            if (cCon != null) {
                PreparedStatement pstmt = null;
                try {
                    pstmt = cCon.prepareStatement(QUERY_underscoreCROSSREF_underscoreSQL2);
            ...
            if (xml == null) {
                ...
                if (urlConn != null) {
                    ...
                    if (cCon != null) {
                        PreparedStatement pstmt2 = null;
                        try {
                            pstmt2 = cCon.prepareStatement(INSERT_underscoreCROSSREF_underscoreSQL2);
