                public void run() {
                    ...
                    String message = null;
                    int messageStyle = SWT.ICON_underscoreWARNING;
                    try {
                        URL url = new URL(Version.LATEST_underscoreVERSION_underscoreURL);
                        ...
                        if (!Version.getVersion().equals(latestVersion)) {
                            ...
                            messageStyle = SWT.ICON_underscoreQUESTION | SWT.YES | SWT.NO;
                        } else {
                            message = Labels.getLabel("text.version.latest");
                            messageStyle = SWT.ICON_underscoreINFORMATION;
                        }
                    } catch (Exception e) {
                        ...
                        Display.getDefault().asyncExec(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (messageBox.open() == SWT.YES) {
                                    BrowserLauncher.openURL(Version.DOWNLOAD_underscoreURL);
                                }
                            }
                        });
                    }
