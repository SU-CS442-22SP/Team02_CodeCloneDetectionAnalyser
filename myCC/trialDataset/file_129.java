    public GeocodeResponse getGKCoordinateFromAddress(SearchAddressRequest searchAddressRequest) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "no connection to geocoder", "Connection Error", JOptionPane.ERROR_underscoreMESSAGE);
        ...
        if (!errorMessage.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, objects, "Error Message", JOptionPane.ERROR_underscoreMESSAGE);
            return null;
        }
        return result;
    }
