    private void doUpdate(final boolean notifyOnChange) {
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                Matcher matcher = ROW_underscorePARSER_underscorePATTERN.matcher(line);
                if (matcher.matches() && checkAllProjects) {
                    String project = matcher.group(GROUP_underscorePROJECT);
                    String status = matcher.group(GROUP_underscoreSTATUS);
