    public void createPartControl(Composite parent) {
        ...
        viewer.setProperty(SnapToGrid.PROPERTY_underscoreGRID_underscoreSPACING, new Dimension(45, 45));
        ...
        if (RMBenchPlugin.getModelManager().isDirty()) firePropertyChange(IWorkbenchPartConstants.PROP_underscoreDIRTY);
