    ...
    public void start() {
        ...
        if (srenderType.equals("fill_underscoreto_underscorezero")) {
        ...
        dom.getController().getPlot().getXaxis().addPropertyChangeListener(Axis.PROP_underscoreRANGE, new PropertyChangeListener() {
