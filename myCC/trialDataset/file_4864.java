    public static void convert(URL url, PrintWriter writer, String server) {
        try {
            XPathFactory xpf = XPathFactory.newInstance(NamespaceConstant.OBJECT_underscoreMODEL_underscoreSAXON);
            ...
            xpe.setNamespaceContext(new NamespaceContext() {
                ...
                public String getNamespaceURI(String s) {
                    ...
                    } else if (s.equals(XMLConstants.DEFAULT_underscoreNS_underscorePREFIX)) {
