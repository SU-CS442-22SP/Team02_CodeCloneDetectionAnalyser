    public void actionPerformed(ActionEvent e) {
        if (path.compareTo("") != 0) {
            ...
            if (myImagesBehaviour.equals(TLanguage.getString("TIGManageGalleryDialog.REPLACE_underscoreIMAGE"))) {
            ...
            if (myImagesBehaviour.equals(TLanguage.getString("TIGManageGalleryDialog.ADD_underscoreIMAGE"))) {
                int i = 1;
                while (newFile.exists()) {
                    imagePath = "." + File.separator + "images" + File.separator + imageName.substring(0, 1).toUpperCase() + File.separator + imageName.substring(0, imageName.lastIndexOf('.')) + "_underscore" + i + imageName.substring(imageName.lastIndexOf('.'), imageName.length());
                    name = name + "_underscore" + i;
