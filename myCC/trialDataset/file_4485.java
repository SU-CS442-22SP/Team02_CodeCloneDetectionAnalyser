    private void insertService(String table, int type) {
        ...
        try {
            ...
            StringBuffer aSql = new StringBuffer("insert into DO_underscoreService(objuid,l10n,name,bouid,mainSql) values(").append("'").append(serviceUid).append("','").append(l10n).append("','").append(name).append("','").append(this.getDOBOUid(table)).append("','").append(mainSql).append("')");
