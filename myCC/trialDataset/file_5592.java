    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        float x = values[0] / SensorManager.GRAVITY_underscoreEARTH;
        float y = values[1] / SensorManager.GRAVITY_underscoreEARTH;
        float z = values[2] / SensorManager.GRAVITY_underscoreEARTH;
