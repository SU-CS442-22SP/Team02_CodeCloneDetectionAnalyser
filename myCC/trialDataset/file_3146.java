    private void folderFileChooserActionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getActionCommand().equals(JFileChooser.APPROVE_underscoreSELECTION)) {
            ...
            for (File selectedFile : folderTextFiles) {
                ...
                try {
                    ...
                    userOption = JOptionPane.showConfirmDialog(this, "A file insertion has failed. If you want it to ignore this" + "file, press YES, else press NO to repeat the insertion", "FileInsertionFailure", JOptionPane.YES_underscoreNO_underscoreOPTION, JOptionPane.WARNING_underscoreMESSAGE);
                    if (userOption == JOptionPane.NO_underscoreOPTION) {
            ...
            processWindowEvent(new WindowEvent(this, WindowEvent.WINDOW_underscoreCLOSING));
        } else if (evt.getActionCommand().equalsIgnoreCase(JFileChooser.CANCEL_underscoreSELECTION)) processWindowEvent(new WindowEvent(this, WindowEvent.WINDOW_underscoreCLOSING));
    }
