    private int[] get51JobId(String address, String category, int pageNum) {
        ...
        try {
            URL url = new URL(ConfigJob51.STR_underscore51JOB_underscoreADVANCE);
            ...
            out.write("jobarea=" + address + "&funtype=" + category + "&curr_underscorepage=" + pageNum + "");
            out.flush();
            out.close();
        ...
        Pattern p = Pattern.compile(JOB51_underscoreSEARCHLIST_underscoreURL_underscorePATTERN, Pattern.CASE_underscoreINSENSITIVE);
