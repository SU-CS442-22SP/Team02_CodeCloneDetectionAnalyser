    ...
    public String resolveItem(String oldJpgFsPath) throws DatabaseException {
        ...
        String ret = null;
        try {
            statement = getConnection().prepareStatement(SELECT_underscoreITEM_underscoreSTATEMENT);
            ...
            if (id != -1 && new File(ret).exists()) {
                statement = getConnection().prepareStatement(UPDATE_underscoreITEM_underscoreSTATEMENT);
