    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("Running gdal_underscoretranslate");
            File geotiffFile = new File(geotiffDir, layerName + ".tif");
            Process procGdalTranslate = Runtime.getRuntime().exec(new String[] { "gdal_underscoretranslate", "-of", "GTiff", bilFile.getAbsolutePath(), geotiffFile.getAbsolutePath() });
            ...
            if (gdalTranslateReturnVal != 0) {
                ...
                throw new RuntimeException("gdal_underscoretranslate failed: " + gdalTranslateErrorOutput);
            }
            ...
            String displayPath = MessageFormat.format(GEOSERVER_underscoreQUERY_underscoreTEMPLATE, layerName);
            ...
            createStylePost.setEntity(new StringEntity(String.format("<style><name>%s_underscorestyle</name><filename>%s.sld</filename></style>", layerName, layerName)));
            ...
            HttpPut uploadSldPut = new HttpPut(String.format("http://localhost:8082/geoserver/rest/styles/%s_underscorestyle", layerName));
            ...
            setDefaultStylePut.setEntity(new StringEntity(String.format("<layer><enabled>true</enabled><defaultStyle><name>%s_underscorestyle</name></defaultStyle></layer>", layerName)));
