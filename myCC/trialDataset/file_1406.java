    public String getWeather(String cityName, String fileAddr) {
        try {
            URL url = new URL("http://www.google.com/ig/api?hl=zh_underscorecn&weather=" + cityName);
        ...
        try {
            ...
            NodeList nodelist1 = (NodeList) doc.getElementsByTagName("forecast_underscoreconditions");
