            ...
            public void onClick(View v) {
                Log.d(Config.SS_underscoreTAG, "Sending POST request to server...");
                DefaultHttpClient httpClient = new DefaultHttpClient();
                HttpPost httpPost = new HttpPost(Config.RPC_underscoreSERVLET_underscoreURL);
                ...
                try {
                    ...
                    if (200 <= responseStatusCode && responseStatusCode < 300) {
                        Log.d(Config.SS_underscoreTAG, "Successful ping - status code: " + responseStatusCode);
                        ...
                        Log.d(Config.SS_underscoreTAG, "Response message: " + returnValue);
                    } else {
                        Log.e(Config.SS_underscoreTAG, "Unsuccessful ping...");
                    }
                } catch (Exception e) {
                    Log.e(Config.SS_underscoreTAG, "Error while trying to ping rpc servlet");
                    e.printStackTrace();
                }
            }
