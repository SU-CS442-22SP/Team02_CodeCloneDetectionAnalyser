    private void parseXMLFile() {
        ...
        try {
            ...
            if (prt.doc == null) {
                System.err.println(FILE_underscoreNOT_underscoreFOUND_underscoreMSG + u);
                return;
            }
            ...
            System.err.println(MALFORMED_underscoreURL_underscoreMSG + u);
            System.err.println(e.getMessage());
            e.printStackTrace();
        } catch (IOException e) {
        } catch (NumberFormatException e) {
            System.err.println(FILE_underscoreCORRUPT_underscoreMSG + u);
            ...
            if (in != null) {
                try {
                    ...
                    System.err.println(COULD_underscoreNOT_underscoreCLOSE_underscoreFILE_underscoreMSG + u);
                    e.printStackTrace();
                }
            }
        }
