    private void createJCoPluginProject(IProgressMonitor monitor, String sourceFileName, String pluginName) throws CoreException, IOException {
        monitor.subTask(MessageFormat.format(Messages.ProjectGenerator_underscoreCreatePluginTaskDescription, pluginName));
        ...
        description.setNatureIds(new String[] { JavaCore.NATURE_underscoreID, PLUGIN_underscoreNATURE_underscoreID });
