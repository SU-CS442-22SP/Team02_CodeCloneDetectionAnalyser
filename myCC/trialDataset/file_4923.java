    ...
    public void download() throws IOException {
        ...
        final int result = JOptionPane.showConfirmDialog(frame, message, "Download parameters", JOptionPane.OK_underscoreCANCEL_underscoreOPTION, JOptionPane.QUESTION_underscoreMESSAGE);
        if (result != JOptionPane.OK_underscoreOPTION) {
            return;
        }
