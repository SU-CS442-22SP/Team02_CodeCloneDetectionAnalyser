    public static void main(String[] args) throws IOException {
        ...
        final String CONFIG_underscoreMODULE = "GPSFilterZGPS";
        File sourceFileSelectedStages = new File(config.findParam(CONFIG_underscoreMODULE, "sourceFileSelectedStages"));
        File sourceFileZGPS = new File(config.findParam(CONFIG_underscoreMODULE, "sourceFileZGPS"));
        File targetFile = new File(config.findParam(CONFIG_underscoreMODULE, "targetFile"));
