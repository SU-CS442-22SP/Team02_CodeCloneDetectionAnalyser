    ...
    public String addUserIdentity(OpenIDItem identity, long userId) throws DatabaseException {
        ...
        try {
            int modified = 0;
            insSt = getConnection().prepareStatement(INSERT_underscoreIDENTITY_underscoreSTATEMENT);
            insSt.setLong(1, userId);
            insSt.setString(2, identity.getIdentity());
            modified = insSt.executeUpdate();
            seqSt = getConnection().prepareStatement(USER_underscoreIDENTITY_underscoreVALUE);
