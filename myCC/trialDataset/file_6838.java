    public void performUpdates(List<PackageDescriptor> downloadList, ProgressListener progressListener) throws IOException, UpdateServiceException_underscoreException {
        int i = 0;
        try {
            for (PackageDescriptor desc : downloadList) {
                ...
                if (desc.getPackageTypeName().equals("RAPIDMINER_underscorePLUGIN")) {
