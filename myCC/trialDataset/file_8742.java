    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            data += "&" + URLEncoder.encode("id_underscorestile", "UTF-8") + "=" + URLEncoder.encode(node.getIdStile(), "UTF-8");
            data += "&" + URLEncoder.encode("nome_underscorericetta", "UTF-8") + "=" + URLEncoder.encode(this.nomeRicetta, "UTF-8");
            data += "&" + URLEncoder.encode("xml_underscorericetta", "UTF-8") + "=" + URLEncoder.encode(this.xml, "UTF-8");
            URL url = new URL("http://" + Main.config.getRemoteServer() + "/upload_underscorericetta.asp?" + data);
