    private Concept fetchDataNeeded(String conceptUri) {
        if (cache.size() > MAX_underscoreCACHE) cache.clear();
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_underscoreOK && connection.getContentType().contains("application/rdf+xml")) {
