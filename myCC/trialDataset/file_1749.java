            ...
            public void run() {
                ...
                FacebookJsonRestClient client = new FacebookJsonRestClient(API_underscoreKEY, SECRET);
                client.setIsDesktop(true);
                HttpURLConnection connection;
                List<String> cookies;
                try {
                    String token = client.auth_underscorecreateToken();
                    String post_underscoreurl = "http://www.facebook.com/login.php";
                    String get_underscoreurl = "http://www.facebook.com/login.php" + "?api_underscorekey=" + API_underscoreKEY + "&v=1.0" + "&auth_underscoretoken=" + token;
                    HttpURLConnection.setFollowRedirects(true);
                    connection = (HttpURLConnection) new URL(get_underscoreurl).openConnection();
                    ...
                    connection = (HttpURLConnection) new URL(post_underscoreurl).openConnection();
                    ...
                    String params = "api_underscorekey=" + API_underscoreKEY + "&auth_underscoretoken=" + token + "&email=" + URLEncoder.encode(email, "UTF-8") + "&pass=" + URLEncoder.encode(pass, "UTF-8") + "&v=1.0";
                    ...
                    if (cookies == null) {
                        ...
                        sessionKey = client.auth_underscoregetSession(token);
