    public static void copyFiles(String strPath, String trgPath) {
        ...
        if (src.isDirectory()) {
            ...
            for (int i = 0; i < list.length; i++) {
                String strPath_underscore1 = src.getAbsolutePath() + SEPARATOR + list[i];
                String trgPath_underscore1 = trg.getAbsolutePath() + SEPARATOR + list[i];
                copyFiles(strPath_underscore1, trgPath_underscore1);
            }
        } else {
            try {
