    private void loadProperties() throws IOException {
        ...
        String importList = newProperties.getProperty(KEY_underscoreIMPORT);
        if (importList != null) {
        ...
        if (devDebug) {
            ...
            printDebugIfEnabled("_underscore_underscore_underscore_underscore_underscore Properties List START _underscore_underscore_underscore_underscore_underscore");
            for (Iterator iterator = properties.iterator(); iterator.hasNext(); ) {
                Map.Entry entry = (Map.Entry) iterator.next();
                printDebugIfEnabled((String) entry.getKey(), entry.getValue());
            }
            printDebugIfEnabled("_underscore_underscore_underscore_underscore_underscore_underscore Properties List END _underscore_underscore_underscore_underscore_underscore_underscore");
        }
        properties.clear();
