    public static void importDB(String input, String output) {
        try {
            ...
            if (!fileXML.exists()) {
                JOptionPane.showMessageDialog(null, "No se encuentra el fichero XML", "Error", JOptionPane.ERROR_underscoreMESSAGE);
            } else {
                ...
                while (j.hasNext()) {
                    ...
                    if (exists(list, id)) {
                        ...
                        while (testFile.exists()) {
                            idTmp = id.substring(0, id.lastIndexOf('.')) + '_underscore' + cont + id.substring(id.lastIndexOf('.'), id.length());
