    public static String doPostEntity(String URL, List<NameValuePair> params) {
        try {
            ...
            postMethod.setEntity(new UrlEncodedFormEntity(params, HTTP.UTF_underscore8));
            ...
            if (httpResponse.getStatusLine().getStatusCode() == 200) {
                ...
                try {
                    ...
                    token = obj.getString("access_underscoretoken");
                } catch (Exception e) {
                    token = strResult.substring(strResult.indexOf("access_underscoretoken=") + 13);
                }
                return token;
            }
        } catch (Exception e) {
