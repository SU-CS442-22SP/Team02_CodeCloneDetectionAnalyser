    protected Object openDialogBox(Control cellEditorWindow) {
        ...
        try {
            ...
            UserErrorException error = new UserErrorException(PropertyHandler.getInstance().getProperty("_underscoreinvalid_underscoreimage_underscoretitle"), PropertyHandler.getInstance().getProperty("_underscoreinvalid_underscoreimage_underscoretext"));
