    public static void invokeMvnArtifact(final IProject project, final IModuleExtension moduleExtension, final String location) throws CoreException, InterruptedException, IOException {
        ...
        try {
            ...
            if (!offline) {
                ...
                final String repositories = ps.getString(Maven2PreferenceConstants.P_underscoreM2_underscoreREPOSITORIES);
                final String[] repos = repositories.split(org.maven.ide.eclipse.ext.Maven2Plugin.REPO_underscoreSEPARATOR);
            ...
            project.refreshLocal(IResource.DEPTH_underscoreINFINITE, null);
        } finally {
