                ...
                if (nn[i].getTag().equals("NAME")) {
                    ...
                    if (thisName.equals(prevName) && !prevName.equals("")) {
                        if (nn[i].isToBeDeleted() == false) {
                            String e = Resurses.getString("IDENTICAL_underscoreNAMES_underscoreERROR") + " [" + req.persLong.getPid() + "] idx [" + i + "] = " + thisName;
                            logger.warning(e);
                    ...
                    if (thisOccu.equals(prevOccu) && !prevOccu.equals("")) {
                        if (nn[i].isToBeDeleted() == false) {
                            String e = Resurses.getString("IDENTICAL_underscoreOCCU_underscoreERROR") + " [" + req.persLong.getPid() + "] idx [" + i + "] = '" + thisOccu + "'";
                            logger.warning(e);
                            if (req.persLong.getPid() > 0) {
                                res.resu = e;
                                return res;
            ...
            if (req.persLong.getPid() > 0) {
                ...
                if (req.persLong.isMainModified()) {
                    ...
                    if (lukuri != 1) {
                        ...
                        throw new SQLException("TRANSACTION_underscoreERROR_underscore1");
                    }
                    String apara = null;
                    String bpara = null;
                    String cpara = null;
                ...
                for (int i = 0; i < nn.length; i++) {
                    ...
                    if (n.isToBeDeleted()) {
                        ...
                        if (delcnt != 1) {
                            ...
                            throw new SQLException("TRANSACTION_underscoreERROR_underscore2");
                        }
                        ...
                        if (n.getPnid() > 0) {
                            ...
                            if (luku != 1) {
                                ...
                                throw new SQLException("TRANSACTION_underscoreERROR_underscore3");
                            }
                        ...
                        if (n.getMediaData() == null) {
                            ...
                            String UPDATE_underscoreIMAGE_underscoreDATA = "update UnitNotice set MediaData = ?," + "mediaWidth = ?,mediaheight = ? where PNID = ? ";
                            PreparedStatement ps = this.con.prepareStatement(UPDATE_underscoreIMAGE_underscoreDATA);
