    ...
    public Image getGoogleMapImage(final BigDecimal latitude, final BigDecimal longitude, final Integer zoomLevel) {
        ...
        try {
            ...
            img = new BufferedImage(GoogleMapsUtils.defaultWidth, 100, BufferedImage.TYPE_underscoreINT_underscoreRGB);
            final Graphics2D graphics = img.createGraphics();
            final Map<Object, Object> renderingHints = CollectionUtils.getHashMap();
            renderingHints.put(RenderingHints.KEY_underscoreTEXT_underscoreANTIALIASING, RenderingHints.VALUE_underscoreTEXT_underscoreANTIALIAS_underscoreON);
