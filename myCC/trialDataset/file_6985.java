    public static synchronized Map<String, Object> getURLContentMap(String wwwurl) throws IOException, URISyntaxException {
        ...
        try {
            ...
            conn.setRequestProperty("User-Agent", "Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.2.17) Gecko/20110421 Red Hat/3.6-1.el5_underscore6 Firefox/3.6.17");
            ...
            synchronized (instream) {
                ...
                while ((readSize = instream.read(buffer)) > 0) {
                    ...
                    totalSize += readSize;
                    if (totalSize >= MAX_underscoreCONTENT_underscoreSIZE) {
                        contentByte = ("[FAILD] content size is larger than " + MAX_underscoreCONTENT_underscoreSIZE + " byte.").getBytes();
                    }
                }
                if (contentByte == null) {
