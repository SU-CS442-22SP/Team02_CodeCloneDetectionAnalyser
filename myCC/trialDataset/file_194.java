    public static void main(String[] args) {
        ...
        final Chooser repositoryChooser = new Chooser(gui.formPanel, JFileChooser.DIRECTORIES_underscoreONLY);
        final Chooser artifactChooser = new Chooser(gui.formPanel, JFileChooser.FILES_underscoreONLY);
        final Chooser pomChooser = new Chooser(gui.formPanel, JFileChooser.FILES_underscoreONLY, new POMFilter());
        ...
        frame.setDefaultCloseOperation(JFrame.EXIT_underscoreON_underscoreCLOSE);
