    private JButton getButtonSonido() {
        if (buttonSonido == null) {
            ...
            buttonSonido.setIcon(new ImageIcon(getClass().getResource("/es/unizar/cps/tecnoDiscap/data/icons/view_underscoresidetree.png")));
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (returnVal == JFileChooser.APPROVE_underscoreOPTION) {
                        ...
                        try {
                            ...
                            buttonSonido.setIcon(new ImageIcon(getClass().getResource("/es/unizar/cps/tecnoDiscap/data/icons/view_underscoresidetreeOK.png")));
