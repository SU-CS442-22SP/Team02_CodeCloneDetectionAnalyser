    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (selectedPage == null) {
            try {
                ...
                response.sendError(response.SC_underscoreNOT_underscoreFOUND);
                return;
            }
        }
        ...
        try {
            ...
            if (page.isVisibleTo(portalRequest.getCurrentUser())) {
                ...
                if (!processed) {
                    ...
                    request.setAttribute(ELConstants.IPOINT_underscoreUSER, portalRequest.getCurrentUser());
                    request.setAttribute(ELConstants.IPOINT_underscorePAGE, page);
                    request.setAttribute(ELConstants.IPOINT_underscoreTEMPLATE, page.getTemplate());
                    request.setAttribute(ELConstants.IPOINT_underscorePORTAL_underscorePROPERTIES, Property.getPropertiesMap());
                    request.setAttribute(ELConstants.IPOINT_underscoreUSER_underscorePROPERTIES, portalRequest.getCurrentUser().getProperties());
                    renderer.preProcess();
                ...
                response.sendError(response.SC_underscoreFORBIDDEN);
            }
        } catch (PersistentModelException e) {
