    public void lock(String oid, String key) throws PersisterException {
        ...
        try {
            ...
            ps = conn.prepareStatement("update " + _underscoretable_underscorename + " set " + _underscorekey_underscorecol + " = ?, " + _underscorets_underscorecol + " = ? where " + _underscoreoid_underscorecol + " = ?");
            ps.setString(1, key);
