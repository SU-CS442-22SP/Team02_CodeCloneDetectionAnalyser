    protected int sendData(String submitName, String submitValue) throws HttpException, IOException, SAXException {
        ...
        try {
            ...
            postMethod.getParams().setCookiePolicy(org.apache.commons.httpclient.cookie.CookiePolicy.IGNORE_underscoreCOOKIES);
            postMethod.addRequestHeader("Cookie", getWikiPrefix() + "_underscoresession=" + getSession() + "; " + getWikiPrefix() + "UserID=" + getUserId() + "; " + getWikiPrefix() + "UserName=" + getUserName() + "; ");
