    public void actionPerformed(java.awt.event.ActionEvent e) {
        try {
            ...
            if (e.getSource() == pwd) {
                initStatus(0, DigestSignTask.SIGN_underscoreMAXIMUM);
                if (detectCardAndCriptoki()) {
                    dsTask = new DigestSignTask(getCryptokiLib(), getSignerLabel(), log);
                    timer = new Timer(ONE_underscoreSECOND, new java.awt.event.ActionListener() {
                        ...
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                            ...
                            if (dsTask.done()) {
                                ...
                                if (dsTask.getCurrent() == DigestSignTask.SIGN_underscoreDONE) {
