    public DialogueSymbole(final JFrame jframe, final Element el, final String srcAttr) {
        ...
        try {
            ...
            if (!dossierSymboles.exists()) {
                JOptionPane.showMessageDialog(jframe, JaxeResourceBundle.getRB().getString("erreur.SymbolesNonTrouve"), JaxeResourceBundle.getRB().getString("erreur.Erreur"), JOptionPane.ERROR_underscoreMESSAGE);
                return;
            }
