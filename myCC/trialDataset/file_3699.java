        ...
        try {
            ...
            if (this.delimiter.equals("\\t")) {
                ...
                if (this.delimiter.length() > 0) {
                    ...
                    tokenizer.wordChars(Character.MIN_underscoreVALUE, Character.MAX_underscoreVALUE);
                    tokenizer.eolIsSignificant(true);
            ...
            while (true) {
                ...
                switch(tokenizer.ttype) {
                    ...
                    case StreamTokenizer.TT_underscoreEOL:
                        {
                            if (readingHeaders) {
                                readingHeaders = false;
                                readingInitialValues = true;
                    ...
                    case StreamTokenizer.TT_underscoreEOF:
                        {
                            if (readingHeaders) {
                ...
                if (tokenizer.ttype == StreamTokenizer.TT_underscoreEOF) {
                    advanceField = false;
                    break;
                }
                if (advanceField) {
