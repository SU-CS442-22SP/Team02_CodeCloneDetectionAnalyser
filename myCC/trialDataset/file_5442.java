    private synchronized Map load() {
        ...
        try {
            ...
            while (iOrigin.hasNext()) {
                ...
                if (origin.startsWith(LOCAL_underscoreCLASSPATH) || JarRestrictionManager.getInstance().isJarAllowed(origin)) {
                    LOG.debug("Adding " + CONFIGURATION_underscoreFILE_underscoreNAME + " from " + origin + ".");
        ...
        if (this.defaultTimestampPolicy == null) this.defaultTimestampPolicy = Group.TIMESTAMP_underscoreLOCAL;
