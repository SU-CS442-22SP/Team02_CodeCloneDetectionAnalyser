                ...
                return new FilterOutputStream(urlConnection.getOutputStream()) {
                    ...
                    public void close() throws IOException {
                        ...
                        switch(responseCode) {
                            ...
                            case HttpURLConnection.HTTP_underscoreCREATED:
                    ...
                    result = new FilterOutputStream(result) {
                        ...
                        public void close() throws IOException {
                            try {
                                ...
                                response.put(URIConverter.RESPONSE_underscoreTIME_underscoreSTAMP_underscorePROPERTY, urlConnection.getLastModified());
                            }
                        }
                    };
                }
