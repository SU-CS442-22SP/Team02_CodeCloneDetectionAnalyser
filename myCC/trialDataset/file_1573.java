    private void run(String[] args) throws Throwable {
        ...
        args = parser.matchAllArgs(args, 0, ArgParserOption.EXIT_underscoreON_underscoreERROR, ArgParserOption.STOP_underscoreFIRST_underscoreUNMATCHED);
        if (log4jFile != null) {
        ...
        final Enumeration<URL> e = About.class.getClassLoader().getResources(EXPERIMENT_underscorePACKAGES);
        ...
        if (args.length == 0 || args[0].equals("list")) {
            ...
            return;
        } else if (args[0].equals(SEARCH_underscoreCOMMAND)) {
            final class Options {
            ...
            ArgParser ap = new ArgParser(SEARCH_underscoreCOMMAND);
