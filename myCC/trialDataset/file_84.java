        ...
        if (l2baseFont == null) {
            ...
            try {
                ...
                if (fontPath != null) {
                    ...
                    fontName = Constants.L2TEXT_underscoreFONT_underscoreNAME;
                    fontEncoding = BaseFont.IDENTITY_underscoreH;
                    tmpIs = FontUtils.class.getResourceAsStream(Constants.L2TEXT_underscoreFONT_underscorePATH);
                }
