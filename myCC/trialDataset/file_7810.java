    public void testRegister() throws IOException {
        ...
        User regUser = null;
        try {
            regUser = (User) getJdbcTemplate().queryForObject("select id, login, password, email, hash, REGISTRATION_underscoreDATE, university, FORUM_underscoreID from USER where login = ?", new Object[] { newUser.getUsername() }, new UserMapper());
        ...
        getJdbcTemplate().execute("DELETE FROM USER_underscoreAUTHORITIES WHERE USER_underscoreID =" + id);
