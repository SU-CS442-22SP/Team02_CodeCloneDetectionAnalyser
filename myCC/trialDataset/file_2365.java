    private void createProject(IProgressMonitor monitor, boolean launchNewTestWizard) {
        try {
            ...
            buildCommand.setBuilderName(JavaCore.BUILDER_underscoreID);
            ...
            classpath = new IClasspathEntry[] { JavaCore.newSourceEntry(srcFolder.getFullPath()), JavaCore.newContainerEntry(new Path("org.eclipse.jdt.launching.JRE_underscoreCONTAINER")), JavaCore.newLibraryEntry(libFolder.getFile("CubicTestElementAPI.jar").getFullPath(), null, null), JavaCore.newLibraryEntry(libFolder.getFile("CubicUnit.jar").getFullPath(), null, null) };
