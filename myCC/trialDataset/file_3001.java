    public static String post(String actionUrl, Map<String, String> params, FormFile[] files) {
        try {
            ...
            String MULTIPART_underscoreFORM_underscoreDATA = "multipart/form-data";
            ...
            conn.setRequestProperty("Content-Type", MULTIPART_underscoreFORM_underscoreDATA + "; boundary=" + BOUNDARY);
            ...
            byte[] end_underscoredata = ("--" + BOUNDARY + "--\r\n").getBytes();
            outStream.write(end_underscoredata);
            outStream.flush();
