        ...
        if (!resolvedBundles.containsKey(bundle)) {
            ...
            while (enumeration != null && enumeration.hasMoreElements()) {
                try {
                    ...
                    bundleSymbolicName = bundleSymbolicName + "_underscore" + i;
                    serviceGroup.setServiceGroupName(bundleSymbolicName);
                    HashMap wsdlServicesMap = new HashMap();
                    if (DeploymentConstants.TAG_underscoreSERVICE.equals(elementName)) {
                    ...
                    } else if (DeploymentConstants.TAG_underscoreSERVICE_underscoreGROUP.equals(elementName)) {
                    ...
                    serviceGroup.addParameter(OSGi_underscoreBUNDLE_underscoreID, bundle.getBundleId());
                    ...
                    if (e instanceof DeploymentException) {
                        ...
                        if (message != null && message.length() != 0) {
                            if (message.indexOf(MODULE_underscoreNOT_underscoreFOUND_underscoreERROR) > -1) {
                                if (!unreslovedBundles.contains(bundle)) {
