    public static HttpData postRequest(HttpPost postMethod, String xml) throws ClientProtocolException, SocketException, IOException, SocketTimeoutException {
        ...
        try {
            ...
            StringEntity se = new StringEntity(xml, HTTP.UTF_underscore8);
            postMethod.setEntity(se);
            printPostRequestHeader(postMethod);
            HttpParams httpParams = new BasicHttpParams();
            HttpConnectionParams.setConnectionTimeout(httpParams, HTTP_underscoreTIMEOUT);
            HttpClient client = new DefaultHttpClient(httpParams);
            client.getParams().setIntParameter(HttpConnectionParams.CONNECTION_underscoreTIMEOUT, DEFAULT_underscorePOST_underscoreREQUEST_underscoreTIMEOUT);
            client.getParams().setIntParameter(HttpConnectionParams.SO_underscoreTIMEOUT, DEFAULT_underscorePOST_underscoreREQUEST_underscoreTIMEOUT);
