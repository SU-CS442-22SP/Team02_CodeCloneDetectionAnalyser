    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        ...
        HttpMethod method = new GetMethod(DOWNLOAD_underscoreURI);
        int statusCode = HttpStatus.SC_underscoreSERVICE_underscoreUNAVAILABLE;
        try {
        ...
        monitor.beginTask("Downloading FFMpeg, " + DOWNLOAD_underscoreURI, (int) contentLength);
