    public void updateUserInfo(AuthSession authSession, AuthUserExtendedInfo infoAuth) {
        ...
        try {
            ...
            String sql = "update WM_underscoreAUTH_underscoreUSER " + "set " + "ID_underscoreFIRM=?, IS_underscoreUSE_underscoreCURRENT_underscoreFIRM=?, " + "ID_underscoreHOLDING=?, IS_underscoreHOLDING=? " + "WHERE  ID_underscoreAUTH_underscoreUSER=? ";
