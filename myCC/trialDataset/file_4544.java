    public void process(String src, String dest) {
        try {
            ...
            if (mecab.isActive()) {
                ...
                String line;
                bw.write("// // // \r\n$title=\r\n$singer=\r\n$id=\r\n\r\n + _underscore_underscore_underscore_underscore_underscore_underscore_underscore // 0 0 0 0 0 0 0\r\n\r\n");
                while ((line = br.readLine()) != null) {
                    ...
                    if (segment.length > 0) japanese = segment[0].trim().replaceAll(" ", "_underscore");
                    boolean first = true;
                    if (japanese != null) {
