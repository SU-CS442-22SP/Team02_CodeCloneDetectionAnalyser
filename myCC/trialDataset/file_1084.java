    public void execute(File tsvFile, File xmlFile) {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(new FileInputStream(tsvFile), INPUT_underscoreENCODING));
            writer = new OutputStreamWriter(new FileOutputStream(xmlFile), OUTPUT_underscoreENCODING);
