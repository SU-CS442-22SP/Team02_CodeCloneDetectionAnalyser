    public static void saveFileData(File file, File destination, java.io.File newDataFile) throws Exception {
        ...
        vc.remove(ResourceManager.RESOURCE_underscoreTEMPLATE + workingFile.getPath());
        ...
        if (newDataFile != null) {
            ...
            for (java.io.File iofile : files) {
                try {
                    ...
                    Logger.error(FileFactory.class, "EditFileAction._underscoresaveWorkingFileData(): " + iofile.getName() + " cannot be erased. Please check the file permissions.");
                } catch (Exception e) {
                    Logger.error(FileFactory.class, "EditFileAction._underscoresaveWorkingFileData(): " + e.getMessage());
                }
            }
        }
    }
