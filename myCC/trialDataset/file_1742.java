            ...
            Runnable run = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (exampleRange != null && curr.equals(DEFAULT_underscoreTIMERANGE)) {
                        ...
                        if (exampleRange == null) {
                            exampleRange = (Node) xpath.evaluate("/stream/properties/@x_underscorerange", document, XPathConstants.NODE);
                            if (exampleRange != null && curr.equals(DEFAULT_underscoreTIMERANGE)) {
                                Das2ServerDataSourceEditorPanel.this.timeRangeTextField.setText(exampleRange.getNodeValue());
                            }
                        }
