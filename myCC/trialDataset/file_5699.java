    private boolean importTablesData(Connection conn) {
        try {
            ...
            List statements = ParseDBDumpFile.parse(SystemGlobals.getValue(ConfigKeys.CONFIG_underscoreDIR) + "/database/" + dbType + "/" + dbType + "_underscoredata_underscoredump.sql");
