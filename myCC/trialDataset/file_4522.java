    private static List runITQLQuery(String itqlQuery) throws Exception {
        ...
        String url = "http://" + Config.getProperty("FEDORA_underscoreSOAP_underscoreHOST") + ":" + Config.getProperty("FEDORA_underscoreSOAP_underscoreACCESS_underscorePORT") + "/fedora/risearch?type=tuples" + "&lang=iTQL" + "&format=CSV" + "&distinct=on" + "&stream=on" + "&query=" + escapedItqlQuery;
