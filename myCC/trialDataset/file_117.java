    public static synchronized String getURLContent(URL url) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error(Translator.getString(XDocletMessages.class, XDocletUtilMessages.EXCEPTION_underscoreREADING_underscoreMERGE_underscoreFILE, new String[] { e.toString() }));
            return null;
        }
    }
