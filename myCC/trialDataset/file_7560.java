    private String readScriptFromURL(URL context, String s) {
        ...
        try {
            ...
            Class jar_underscoreclass;
            try {
                jar_underscoreclass = Class.forName("java.net.JarURLConnection");
            } catch (Exception e2) {
                return null;
            }
            Object jar;
            ...
            try {
                Method m = jar_underscoreclass.getMethod("openConnection", ((java.lang.Class[]) null));
