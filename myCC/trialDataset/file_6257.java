    public void display(WebPage page, HttpServletRequest req, HttpServletResponse resp) throws DisplayException {
        ...
        StreamProvider is = (StreamProvider) req.getAttribute(INPUTSTREAM_underscoreKEY);
        if (is == null) {
            throw new IllegalStateException("No OutputStreamDisplayHandlerXML.InputStream found in request attribute" + " OutputStreamDisplayHandlerXML.INPUTSTREAM_underscoreKEY");
        }
