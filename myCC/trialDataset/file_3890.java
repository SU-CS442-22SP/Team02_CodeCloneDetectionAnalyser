        public void perform(Context context) {
            ...
            try {
                ...
                if (var.get("wsurl") == null || var.get("method") == null) {
                    ...
                    log_underscore.error("Need the url of the webservice and the method!");
                    return;
                }
                ...
                try {
                    ...
                    log_underscore.error("Could not connect to the webservice!");
                    return;
                }
                if (var.get("param0") == null || var.get("param1") == null) {
                    System.out.println("----- Need parameters! -----");
                    log_underscore.error("Need parameters!");
                    return;
                }
                ...
                try {
                    ...
                    context.set(CTX_underscoreANSW, "=> notifyIhk invoked - Result: " + ret);
                    System.out.println("----- notifyIhk invoked! -----");
                    log_underscore.info("notifyIhk invoked!");
                } catch (RemoteException ex) {
                    System.out.println("----- Could not invoke the method! -----");
                    log_underscore.error("Could not invoke the method!");
                }
            } catch (Exception ex) {
