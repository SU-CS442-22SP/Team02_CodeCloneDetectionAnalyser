    public void zipDocsetFiles(SaxHandler theXmlHandler, int theEventId, Attributes theAtts) throws BpsProcessException {
        ...
        try {
            ...
            throw (new BpsProcessException(BpsProcessException.ERR_underscoreOPEN_underscoreFILE, "FileNotFoundException while building zip dest file"));
        } catch (IOException e) {
            throw (new BpsProcessException(BpsProcessException.ERR_underscoreOPEN_underscoreFILE, "IOException while building zip dest file"));
        }
    }
