    private static void fileUpload() throws Exception {
        ...
        HttpPost httppost = new HttpPost("http://flameupload.com/cgi/ubr_underscoreupload.pl?upload_underscoreid=" + uploadid);
        MultipartEntity mpEntity = new MultipartEntity(HttpMultipartMode.BROWSER_underscoreCOMPATIBLE);
        ContentBody cbFile = new FileBody(file);
        mpEntity.addPart("upfile_underscore0", cbFile);
        ...
        mpEntity.addPart("_underscore2shared", new StringBody("on"));
