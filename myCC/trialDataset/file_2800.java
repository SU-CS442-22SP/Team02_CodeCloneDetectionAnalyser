    public void test_underscoreopenStream() throws Exception {
        ...
        Support_underscoreResources.copyFile(resources, null, "hyts_underscorehtmltest.html");
        u = new URL("file", "", resources.getAbsolutePath() + "/hyts_underscorehtmltest.html");
        ...
        int port = Support_underscoreJetty.startHttpServerWithDocRoot("resources/org/apache/harmony/luni/tests/java/net/");
