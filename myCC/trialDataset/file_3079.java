        private void downloadFile(final String downloadUrl, final String destinationFile) throws IOException {
            ...
            try {
                if (entity != null) {
                    ...
                    CopyStreamStatusCallback callback = new CopyStreamStatusCallback() {
                        ...
                        public long getSkipBetweenUpdates() {
                            return entity.getContentLength() * 2 / PERCENTAGE_underscoreBASE;
                        }

                        @Override
                        public void onUpdate(final long copiedLength) {
                            int percentage = (int) (copiedLength * PERCENTAGE_underscoreBASE / entity.getContentLength());
                            handleUpdate(STATUS_underscoreDOWNLOADING, percentage);
                        }
                    };
                ...
                try {
                    ...
                    Log.v(DictionaryForMIDs.LOG_underscoreTAG, "Exception while closing stream: " + e);
                }
            }
        }
