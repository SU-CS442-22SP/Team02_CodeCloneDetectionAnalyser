        public synchronized void run() {
            ...
            try {
                ...
                url = new URL(updateSiteS + "?jmathlib_underscoreversion=" + localVersionS + "&command=check");
            } catch (Exception e) {
            ...
            if (updateActionS.equals("INCREMENTAL_underscoreDOWNLOAD")) {
                if (!silentB) {
            ...
            String checkedDate = Integer.toString(cal.get(Calendar.YEAR)) + "/" + Integer.toString(cal.get(Calendar.MONTH) + 1) + "/" + Integer.toString(cal.get(Calendar.DAY_underscoreOF_underscoreMONTH));
