    public void run() {
        ...
        String pathTemp = Settings.get("vo_underscorestore.databaseMetaCollection");
        ...
        while (true) {
            ...
            for (int i = 0; i < Math.min(fileList.length, 500); i++) {
                ...
                try {
                    ...
                    if (!found) {
                        newFile.renameTo(new File(newFile.getAbsolutePath() + ".not_underscorefound"));
                    } else {
                        ...
                        discussionFields.put("OBJECT_underscoreID", objId);
                        discussionFields.put("AUTHOR_underscoreID", "auto");
                        discussionFields.put("AUTHOR_underscoreNAME", "auto");
                        discussionFields.put("OBJECT_underscoreSECTION", sectionName);
                        discussionFields.put("OBJECT_underscorePATH", pathTemp);
                        discussionFields.put("FILE_underscorePATH", "");
                        ...
                        discussionFields.put("PERIOD_underscoreSTART", datefrom);
                        discussionFields.put("PERIOD_underscoreEND", dateto);
                        discussionFields.put("PREVIEW_underscoreIMG", previewimg);
                        ...
                        XMLResource document = (XMLResource) col.createResource(objId + ".xml", XMLResource.RESOURCE_underscoreTYPE);
