    public void insertProfile() throws ClassNotFoundException, SQLException {
        ...
        try {
            ...
            String query2 = "INSERT INTO customer_underscoreroles(name,role_underscorename) VALUES(?,?)";
            ps2 = connection.prepareStatement(query2);
            ps2.setString(1, this.name);
            ps2.setString(2, "user");
            String query3 = "INSERT INTO customers_underscoreprofile(name,first_underscorename,middle_underscorename,last_underscorename,address1,address2,city,post_underscorebox,email,country)" + "VALUES(?,?,?,?,?,?,?,?,?,?)";
