    ...
    public KeySelectorResult select(KeyInfo keyInfo, Purpose purpose, AlgorithmMethod method, XMLCryptoContext context) throws KeySelectorException {
        ...
        String signatureRelationshipResourceName = signatureSegment + "/_underscorerels/" + signatureBase + ".rels";
        ...
        for (CTRelationship signatureRelationship : signatureRelationshipList) {
            if (DIGITAL_underscoreSIGNATURE_underscoreCERTIFICATE_underscoreREL_underscoreTYPE.equals(signatureRelationship.getType())) {
