    public void runTask(HashMap pjobParms) throws Exception {
        ...
        try {
            ...
            if (getFTPDefinition() != null) {
                ...
                throw new Exception("Work unit [ " + SHORT_underscoreNAME + " ] is missing an FTP Definition.  Please check" + " your JBJF Batch Definition file an make sure" + " this work unit has a <resource> element added" + " within the <task> element.");
            }
