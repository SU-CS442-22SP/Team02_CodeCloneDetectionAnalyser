    public static SearchItem loadRecord(String id, boolean isContact) {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost(isContact ? URL_underscoreRECORD_underscoreCONTACT : URL_underscoreRECORD_underscoreCOMPANY);
            ...
            String Name_underscore_underscoreLast_underscore_underscoreFirst_underscore = XMLfunctions.getValue(e, isContact ? "Name_underscore_underscoreLast_underscore_underscoreFirst_underscore" : "Name");
            String phone = "";
            if (!isContact) phone = XMLfunctions.getValue(e, "Phone");
            String Email1 = XMLfunctions.getValue(e, isContact ? "Personal_underscoreEmail" : "Email");
            String Home_underscoreFax = XMLfunctions.getValue(e, isContact ? "Home_underscoreFax" : "Fax1");
            ...
            item.set(1, Name_underscore_underscoreLast_underscore_underscoreFirst_underscore);
            item.set(2, phone);
            item.set(3, phone);
            item.set(4, Email1);
            item.set(5, Home_underscoreFax);
            item.set(6, Address1);
            item.set(7, Address2);
            item.set(8, City);
            item.set(9, State);
