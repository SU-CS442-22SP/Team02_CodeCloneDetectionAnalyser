    public CandleSeries fetchSeries(final String symbol) throws Exception {
        ...
        String beginDay = String.valueOf(cal.get(Calendar.DAY_underscoreOF_underscoreMONTH));
        if (end == null) {
        ...
        cal.setTime(end);
        String day = String.valueOf(cal.get(Calendar.DAY_underscoreOF_underscoreMONTH));
        String month = String.valueOf(cal.get(Calendar.MONTH));
        String year = String.valueOf(cal.get(Calendar.YEAR));
        String resolution = "d";
        String urlStr = MessageFormat.format(YAHOO_underscoreURL, symbol, beginMonth, beginDay, beginYear, month, day, year, resolution);
