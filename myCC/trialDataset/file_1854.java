    static void populateResources() throws BasicException {
        ...
        String[][] images = new String[][] { { "default.user", "yast_underscoresysadmin.png" }, { "default.product", "colorize.png" }, { "Window.Logo", "windowlogo.png" }, { "Image.Backarrow", "3backarrow.png" } };
