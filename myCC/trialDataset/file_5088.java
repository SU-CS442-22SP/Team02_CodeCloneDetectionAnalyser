    private LinkedList<Datum> processDatum(Datum dataset) {
        ...
        String ftestHeader = "Trait\tMarker\tLocus\tLocus_underscorepos\tChr\tChr_underscorepos\tmarker_underscoreF\tmarker_underscorep\tperm_underscorep\tmarkerR2\tmarkerDF\tmarkerMS\terrorDF\terrorMS\tmodelDF\tmodelMS";
        String BLUEHeader = "Trait\tMarker\tObs\tLocus\tLocus_underscorepos\tChr\tChr_underscorepos\tAllele\tEstimate";
        if (writeOutputToFile) {
            ...
            String datasetNameNoSpace = dataset.getName().trim().replaceAll("\\ ", "_underscore");
            ftestFile = new File(outputbase + "_underscore" + datasetNameNoSpace + "_underscoreftest.txt");
            int count = 0;
            while (ftestFile.exists()) {
                count++;
                ftestFile = new File(outputbase + "_underscore" + datasetNameNoSpace + "_underscoreftest" + count + ".txt");
            }
            blueFile = new File(outputbase + "_underscore" + datasetNameNoSpace + "_underscoreBLUEs.txt");
            count = 0;
            while (blueFile.exists()) {
                count++;
                blueFile = new File(outputbase + "_underscore" + datasetNameNoSpace + "_underscoreBLUEs" + count + ".txt");
            }
            tempFile = new File(outputbase + "_underscore" + datasetNameNoSpace + "_underscoreftest.tmp");
            try {
                if (permute) {
        ...
        String[] columnLabels = new String[] { "Trait", "Marker", "Locus", "Locus_underscorepos", "Chr", "Chr_underscorepos", "marker_underscoreF", "marker_underscorep", "perm_underscorep", "markerR2", "markerDF", "markerMS", "errorDF", "errorMS", "modelDF", "modelMS" };
        ...
        StringBuilder tableName = new StringBuilder("GLM_underscoremarker_underscoretest_underscore");
        ...
        int[] outputIndex;
        columnLabels = new String[] { "Trait", "Marker", "Obs", "Locus", "Locus_underscorepos", "Chr", "Chr_underscorepos", "Allele", "Estimate" };
        if (hasAlleleNames) {
