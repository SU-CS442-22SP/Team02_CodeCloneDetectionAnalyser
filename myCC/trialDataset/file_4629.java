    public static boolean start(RootDoc root) {
        ...
        try {
            ...
            int breakPoint = s.indexOf(XSD_underscoreTEXT_underscoreTO_underscoreREPLACED_underscoreWITH_underscoreGENERATED_underscoreXML_underscoreSIGNATURES);
            if (breakPoint < 0) {
                throw new Exception("Signature not found in XSD: " + XSD_underscoreTEXT_underscoreTO_underscoreREPLACED_underscoreWITH_underscoreGENERATED_underscoreXML_underscoreSIGNATURES);
            }
