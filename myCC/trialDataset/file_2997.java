            ...
            if (aURL.Path.compareTo("svnUpdate") == 0) {
                try {
                    ...
                    if (settings.getCheckoutDoc() == null || !settings.getCheckoutDoc().equals(anyOdt.getName())) {
                        ...
                        XDispatchProvider xDispatchProvider = (XDispatchProvider) UnoRuntime.queryInterface(XDispatchProvider.class, m_underscorexFrame);
                        ...
                        Object objDispatchHelper = m_underscorexServiceManager.createInstanceWithContext("com.sun.star.frame.DispatchHelper", m_underscorexContext);
