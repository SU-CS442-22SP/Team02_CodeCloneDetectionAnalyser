    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String session_underscoreid = session.getId();
        File session_underscorefileDir = new File(destinationDir + java.io.File.separator + session_underscoreid);
        session_underscorefileDir.mkdir();
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    pathToFile = getServletContext().getRealPath("/") + "files" + java.io.File.separator + session_underscoreid;
            ...
            try {
                ...
                String reportURLString = AWSServices.storeReportS3(reportFile, session_underscoreid).toString();
