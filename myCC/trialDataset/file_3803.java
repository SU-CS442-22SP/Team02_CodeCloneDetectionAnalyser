    public boolean updateLOB(String sql, int displayType, Object value, String trxName, SecurityToken token) {
        ...
        m_underscoreupdateLOBCount++;
        boolean success = true;
        Connection con = trx != null ? trx.getConnection() : DB.createConnection(false, Connection.TRANSACTION_underscoreREAD_underscoreCOMMITTED);
