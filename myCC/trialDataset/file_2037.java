    private Image retrievePdsImage(double lat, double lon) {
        ...
        try {
            ...
            urlBuff.append("DATA_underscoreSET_underscoreNAME=" + dataSet);
            urlBuff.append("&VERSION=" + version);
            urlBuff.append("&PIXEL_underscoreTYPE=" + pixelType);
            urlBuff.append("&PROJECTION=" + projection);
            urlBuff.append("&STRETCH=" + stretch);
            urlBuff.append("&GRIDLINE_underscoreFREQUENCY=" + gridlineFrequency);
            ...
            urlBuff.append("&BANDS_underscoreSELECTED=" + bandsSelected);
