    ...
    public CheckAvailabilityResult execute(final CheckAvailabilityAction action, final ExecutionContext context) throws ActionException {
        if (LOGGER.isDebugEnabled()) {
            ...
            if (action.getServerId() == CheckAvailability.FEDORA_underscoreID) {
                serverName = "fedora";
            } else if (action.getServerId() == CheckAvailability.KRAMERIUS_underscoreID) {
        ...
        if (action.getServerId() == CheckAvailability.FEDORA_underscoreID) {
            ...
            url = configuration.getKrameriusHost() + SOME_underscoreSTATIC_underscoreKRAMERIUS_underscorePAGE;
        } else {
