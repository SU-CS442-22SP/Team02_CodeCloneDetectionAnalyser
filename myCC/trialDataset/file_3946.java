    public static InputStream getData(DataTransferDescriptor desc, GlobusCredential creds) throws Exception {
        ...
        if (url.getProtocol().equals("http")) {
            ...
            if (creds != null) {
                GlobusGSSCredentialImpl cred = new GlobusGSSCredentialImpl(creds, GSSCredential.INITIATE_underscoreAND_underscoreACCEPT);
                GSIHttpURLConnection connection = new GSIHttpURLConnection(url);
                connection.setGSSMode(GSIConstants.MODE_underscoreSSL);
