    public void objectParserAssesmentItem(int file, int currentquestion, Resource resTemp) {
        ...
        try {
            if (file == 1) {
                ...
                nl = doc_underscore[currentquestion].getElementsByTagName("object");
            }
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (file == 1) {
                    ...
                    sXml_underscore[currentquestion] = sXml_underscore[currentquestion].replace(nsrc.getTextContent(), sFilename);
                }
