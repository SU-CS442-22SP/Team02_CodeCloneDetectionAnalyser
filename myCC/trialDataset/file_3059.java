    private void redownloadResource(SchemaResource resource) {
        if (_underscoreredownloadSet != null) {
            if (_underscoreredownloadSet.contains(resource)) return;
            _underscoreredownloadSet.add(resource);
        }
        ...
        try {
            ...
            conn.addRequestProperty("User-Agent", USER_underscoreAGENT);
