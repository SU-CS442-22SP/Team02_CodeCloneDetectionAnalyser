            ...
            try {
                ...
                if (!outDir.exists()) {
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            JOptionPane.showMessageDialog(UnpackWizard.this, "The chosen directory does not exist!", "Directory Not Found Error", JOptionPane.ERROR_underscoreMESSAGE);
                        }
                    });
                    return;
                }
                if (!outDir.isDirectory()) {
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            JOptionPane.showMessageDialog(UnpackWizard.this, "The chosen file is not a directory!", "Not a Directory Error", JOptionPane.ERROR_underscoreMESSAGE);
                        }
                    });
                    return;
                }
                if (!outDir.canWrite()) {
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            JOptionPane.showMessageDialog(UnpackWizard.this, "Cannot write to the chosen directory!", "Directory Not Writeable Error", JOptionPane.ERROR_underscoreMESSAGE);
                        }
                    });
                    return;
                }
                ...
                try {
                        ...
                        if (aFile.exists()) {
                            if (aFile.isFile()) {
                                ...
                                SwingUtilities.invokeLater(new Runnable() {
                                    ...
                                    public void run() {
                                        JOptionPane.showMessageDialog(UnpackWizard.this, "File \"" + wrongFile.getAbsolutePath() + "\" is not a standard file!", "Non Standard File Error", JOptionPane.ERROR_underscoreMESSAGE);
                                    }
                                });
                                return;
                            }
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                ...
                                public void run() {
                                    JOptionPane.showMessageDialog(UnpackWizard.this, "File \"" + wrongFile.getAbsolutePath() + "\" does not exist!", "File Not Found Error", JOptionPane.ERROR_underscoreMESSAGE);
                                }
                            });
                            return;
                        }
                    ...
                    if (mfis.getCRC() == expectedCrc) {
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                JOptionPane.showMessageDialog(UnpackWizard.this, "Extraction completed successfully!", "Done!", JOptionPane.INFORMATION_underscoreMESSAGE);
                            }
                        });
                        return;
                    } else {
                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run() {
                                progressBar.setValue(0);
                                JOptionPane.showMessageDialog(UnpackWizard.this, "CRC Error: the data extracted does not have the expected CRC!\n" + "You should probably delete the extracted files, as they are " + "likely to be invalid.", "CRC Error", JOptionPane.ERROR_underscoreMESSAGE);
                            }
                        });
                        return;
                    }
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            progressBar.setValue(0);
                            JOptionPane.showMessageDialog(UnpackWizard.this, "Input/Output Error: " + e.getLocalizedMessage(), "Input/Output Error", JOptionPane.ERROR_underscoreMESSAGE);
                        }
                    });
                    return;
                }
