    ...
    protected void save(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        UPLOAD_underscoreDIRECTORY = uploadDiretory();
        File diretorioUsuario = new File(UPLOAD_underscoreDIRECTORY);
        ...
        try {
            ...
            fos = new FileOutputStream(new File(UPLOAD_underscoreDIRECTORY + filename));
            IOUtils.copy(is, fos);
