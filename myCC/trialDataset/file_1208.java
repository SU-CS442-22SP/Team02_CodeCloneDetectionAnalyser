                ...
                try {
                    ...
                    if (nReviewsOnPage > 0) {
                        ...
                        txtinfo.post(new Runnable() {
                            ...
                            public void run() {
                                txtinfo.setText(title + getString(R.string.no_underscorereviews_underscorefor_underscorethis_underscorealbum));
                            }
                        });
                    }
                } catch (Exception e) {
                    ...
                    txtinfo.post(new Runnable() {
                        ...
                        public void run() {
                            txtinfo.setText(R.string.search_underscorefailed);
                        }
                    });
                }
                dialog.dismiss();
