    ...
    public void initialize() {
        ...
        if (auSummaryList == null || auSummaryList.isEmpty()) {
            auSummaryList = auOverviewTableFacade.getNewerVerifiedAus(N_underscoreAUS_underscoreFOR_underscoreCHART);
            if (auSummaryList == null) {
                ...
                maodao.createTable();
                if (auOverviewTableFacade.isTableExistent("au_underscoreoverview_underscoretable")) {
                    auSummaryList = auOverviewTableFacade.getNewerVerifiedAus(N_underscoreAUS_underscoreFOR_underscoreCHART);
                }
            }
        }
        ...
        URL url = DashboardManagedBean.class.getResource("us_underscoremap_underscoretemplate.svg");
        try {
