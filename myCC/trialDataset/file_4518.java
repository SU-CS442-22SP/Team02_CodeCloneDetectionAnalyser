    ...
    public void run(ProcedureRunner runner) throws Exception {
        ...
        try {
            ...
            if (HttpURLConnection.HTTP_underscoreOK == httpUrlConnection.getResponseCode()) {
                ...
                if (raiseExceptionOnError) {
                    throw new ConfigurationFileException(WS_underscoreINVOKER_underscoreERROR_underscoreCODE, new Object[] { url, soapResponse }, this);
                }
            }
