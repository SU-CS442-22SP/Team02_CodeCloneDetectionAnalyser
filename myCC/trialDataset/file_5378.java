    protected void saveResponse(final WebResponse response, final WebRequest request) throws IOException {
        ...
        LOG.info("Created file " + f.getAbsolutePath() + " for response " + counter_underscore + ": " + url);
        ...
        if (request.getHttpMethod() == HttpMethod.POST && request.getEncodingType() == FormEncodingType.URL_underscoreENCODED) {
