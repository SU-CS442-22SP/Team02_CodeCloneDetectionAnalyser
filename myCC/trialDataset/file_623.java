    ...
    public ArrayList<GmailContact> getAllContacts() throws GmailException {
        String query = properties.getString("export_underscorepage");
        query = query.replace("[RANDOM_underscoreINT]", "" + random.nextInt());
        int statusCode = -1;
        ...
        String query_underscorepost = properties.getString("outlook_underscoreexport_underscorepage");
        PostMethod post = new PostMethod(query_underscorepost);
        post.addRequestHeader("Accept-Encoding", "gzip,deflate");
        post.addRequestHeader("Accept-Charset", "ISO-8859-1,utf-8;q=0.7,*;q=0.8");
        NameValuePair[] data = { new NameValuePair("at", getCookie("GMAIL_underscoreAT")), new NameValuePair("ecf", "o"), new NameValuePair("ac", "Export Contacts") };
        ...
        try {
            ...
            GMAIL_underscoreOUTPUT_underscoreCHARSET = post.getResponseCharSet();
