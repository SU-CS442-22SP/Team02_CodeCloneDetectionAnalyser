    private void handleXInclude(final String localName, final Attributes atts) {
        if ("include".equals(localName)) {
            ...
            String accept_underscorelanguage = atts.getValue("accept-language");
            if ((accept_underscorelanguage == null) || "".equals(accept_underscorelanguage.trim())) {
                accept_underscorelanguage = null;
            }
            if (href != null) {
                if (href.indexOf(":/") == -1) {
                    if (href.startsWith("/")) {
                ...
                try {
                    ...
                    if (accept_underscorelanguage != null) {
                        connection.addRequestProperty("Accept-Language", accept_underscorelanguage);
                    }
