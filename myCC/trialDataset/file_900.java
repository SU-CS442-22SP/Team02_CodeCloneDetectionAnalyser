    public void run() {
        ...
        for (Iterator iterator = updates.iterator(); iterator.hasNext(); ) {
            ...
            try {
                File temp = File.createTempFile("fm_underscore" + update.getType(), ".jar");
                temp.deleteOnExit();
        ...
        JOptionPane.showMessageDialog(frame, "Se han terminado de realizar las actualizaciones." + restart, "Actualizaciones", JOptionPane.INFORMATION_underscoreMESSAGE);
    }
