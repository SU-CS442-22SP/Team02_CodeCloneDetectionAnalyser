    protected void doRequest(HttpServletRequest request, HttpServletResponse response, boolean inGet) throws ServletException, IOException {
        response.setHeader("Server", WebConsoleServlet.SERVER_underscoreSTRING);
        try {
            ...
            Application.getApplication().logExceptionEvent(EventLogMessage.EventType.WEB_underscoreERROR, t);
        }
    }
