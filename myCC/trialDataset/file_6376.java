    public VeecheckResult performRequest(VeecheckVersion version, String uri) throws ClientProtocolException, IOException, IllegalStateException, SAXException {
        ...
        HttpConnectionParams.setConnectionTimeout(params, CONNECTION_underscoreTIMEOUT);
        HttpConnectionParams.setSoTimeout(params, SO_underscoreTIMEOUT);
        ...
        try {
            ...
            Header header = response.getFirstHeader(HTTP.CONTENT_underscoreTYPE);
