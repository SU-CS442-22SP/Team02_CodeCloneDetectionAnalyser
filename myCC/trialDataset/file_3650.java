    private String doSearch(String query) {
        ...
        queryBuilder.append("http://boss.yahooapis.com/ysearch/web/v1/").append(query).append("?appid=wGsFV_underscoreDV34EwXnC.2Bt_underscoreQl8Kcir_underscoreHmrxMzWUF2fv64CA8ha7e4zgudqXFA8K_underscoreJ4-&format=xml&filter=-porn");
        try {
