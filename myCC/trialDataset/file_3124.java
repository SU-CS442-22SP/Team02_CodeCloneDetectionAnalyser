        ...
        try {
            ...
            while (buffer != null) {
                if (buffer.contains("<select id=\"component\" name=\"component\">")) {
                    ...
                    m_underscorestrComponents = new String[erg.size()];
                    erg.toArray(m_underscorestrComponents);
                }
                if (buffer.contains("<select id=\"priority\" name=\"priority\">")) {
                    ...
                    m_underscorestrPriorities = new String[erg.size()];
                    erg.toArray(m_underscorestrPriorities);
                }
